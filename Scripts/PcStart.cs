...
namespace Scripts
{
    public class PcStart : IStartingEquipmentHook
    {
        private static readonly Dictionary<FeatId, int> proto_table = new Dictionary<FeatId, int>
        {
            ...
            {FeatId.EXOTIC_WEAPON_PROFICIENCY_KUKRI, 4624},
            ...
            {FeatId.EXOTIC_WEAPON_PROFICIENCY_HAND_CROSSBOW, 4497},
            {FeatId.EXOTIC_WEAPON_PROFICIENCY_REPEATING_CROSSBOW, 4494},
            ...
            {FeatId.IMPROVED_CRITICAL_SPIKED_GAUNTLET, 4705},
            {FeatId.IMPROVED_CRITICAL_LIGHT_FLAIL, 4408},
            {FeatId.IMPROVED_CRITICAL_TRIDENT, 4413},
            {FeatId.IMPROVED_CRITICAL_HALBERD, 4412},
            ...
            {FeatId.MARTIAL_WEAPON_PROFICIENCY_LIGHT_FLAIL, 4408},
            {FeatId.MARTIAL_WEAPON_PROFICIENCY_TRIDENT, 4413},
            {FeatId.MARTIAL_WEAPON_PROFICIENCY_HALBERD, 4412},
            ...
            {FeatId.WEAPON_FOCUS_KUKRI, 4624},
            ...
            {FeatId.WEAPON_FOCUS_SPIKED_GAUNTLET, 4705},
            {FeatId.WEAPON_FOCUS_LIGHT_FLAIL, 4408},
            {FeatId.WEAPON_FOCUS_TRIDENT, 4413},
            ...
            foreach (var (f, p) in proto_table)
            {
                if (pc.FindItemByProto(p) == null)
                {
                    if (pc.HasFeat(f))
                    {
                        ...
                        else if (((proto == 4096) || (proto == 4097) || (proto == 4494) || (proto == 4497)))
                        {
