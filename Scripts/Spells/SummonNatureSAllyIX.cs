...
{
    [SpellScript(484)]
    public class SummonNatureSAllyIX : BaseSpellScript
    {
        public override void OnBeginSpellCast(SpellPacketBody spell)
        {
            Logger.Info("Summon Nature's IX OnBeginSpellCast");
        ...
        {
            Logger.Info("Summon Nature's IX OnSpellEffect");
            var teststr = "; summon nature's ally 9\n"; // change this to the header line for the spell in spells_radial_menu_options.mes
        ...
        {
            Logger.Info("Summon Nature's IX OnBeginRound");
        }
        public override void OnEndSpellCast(SpellPacketBody spell)
        {
            Logger.Info("Summon Nature's IX OnEndSpellCast");
        }
