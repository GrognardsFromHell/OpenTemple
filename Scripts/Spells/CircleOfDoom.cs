...
namespace Scripts.Spells
{
    ...
    public class CircleOfDoom : BaseSpellScript
    {
        ...
        {
            Logger.Info("Mass Inflict Light Wounds OnBeginSpellCast");
        ...
        {
            Logger.Info("Mass Inflict Light Wounds OnBeginRound");
        }
        public override void OnEndSpellCast(SpellPacketBody spell)
        {
            Logger.Info("Mass Inflict Light Wounds OnEndSpellCast");
        }
