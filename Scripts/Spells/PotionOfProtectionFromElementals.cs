...
{
    [SpellScript(715)]
    public class PotionOfProtectionFromElementals : BaseSpellScript
    {
        ...
        {
            Logger.Info("Protection From Elementals OnSpellEffect");
            spell.duration = 10 * spell.casterLevel;
            var target_item = spell.Targets[0];
            if (target_item.Object.IsFriendly(spell.caster))
            {
                target_item.Object.AddCondition("sp-Protection From Monster", spell.spellId, spell.duration, 2);
                target_item.ParticleSystem = AttachParticles("sp-Protection From Elementals", target_item.Object);
            }
