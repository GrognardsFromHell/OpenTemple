...
{
    [SpellScript(474)]
    public class SummonMonsterVIII : BaseSpellScript
    {
        public override void OnBeginSpellCast(SpellPacketBody spell)
        {
            Logger.Info("Summon Monster VIII OnBeginSpellCast");
        ...
        {
            Logger.Info("Summon Monster VIII OnBeginRound");
        }
        public override void OnEndSpellCast(SpellPacketBody spell)
        {
            Logger.Info("Summon Monster VIII OnEndSpellCast");
        }
