...
{
    [SpellScript(722)]
    public class SummonAirElemental : BaseSpellScript
    {
        public override void OnBeginSpellCast(SpellPacketBody spell)
        {
            Logger.Info("Summon Air Elemental OnBeginSpellCast");
        ...
        {
            Logger.Info("Summon Air Elemental OnSpellEffect");
            spell.duration = 10;
            // get the proto_id for this monster
            var monster_proto_id = 14292;
            // create monster
