    ...
    public class AcidSplash : BaseSpellScript
    {
        ...
        public override void OnEndProjectile(SpellPacketBody spell, GameObjectBody projectile, int index_of_target)
        {
            ...
            if ((return_val & D20CAF.HIT) != D20CAF.NONE)
            {
                ...
                // hit
                target_item.Object.DealSpellDamage(spell.caster, DamageType.Acid, damage_dice, D20AttackPower.UNSPECIFIED, 100, D20ActionType.CAST_SPELL, spell.spellId, return_val, index_of_target);
            }
            else
            {
                // missed
