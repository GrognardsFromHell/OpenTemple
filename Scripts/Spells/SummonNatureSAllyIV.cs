...
{
    [SpellScript(479)]
    public class SummonNatureSAllyIV : BaseSpellScript
    {
        public override void OnBeginSpellCast(SpellPacketBody spell)
        {
            Logger.Info("Summon Nature's IV OnBeginSpellCast");
        ...
        {
            Logger.Info("Summon Nature's IV OnSpellEffect");
            var teststr = "; summon nature's ally 4\n"; // change this to the header line for the spell in spells_radial_menu_options.mes
            ...
            AttachParticles("sp-Summon Natures Ally IV", target_item.Object);
        ...
        {
            Logger.Info("Summon Nature's IV OnBeginRound");
        }
        public override void OnEndSpellCast(SpellPacketBody spell)
        {
            Logger.Info("Summon Nature's IV OnEndSpellCast");
        }
