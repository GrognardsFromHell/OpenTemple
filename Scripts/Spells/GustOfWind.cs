...
{
    [SpellScript(214)]
    public class GustOfWind : BaseSpellScript
    {
        public override void OnBeginSpellCast(SpellPacketBody spell)
        {
            Logger.Info("Gust of Wind OnBeginSpellCast");
        ...
        {
            Logger.Info("Gust of Wind OnBeginRound");
        }
        public override void OnEndSpellCast(SpellPacketBody spell)
        {
            Logger.Info("Gust of Wind OnEndSpellCast");
        }
