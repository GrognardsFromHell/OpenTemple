...
{
    [SpellScript(480)]
    public class SummonNatureSAllyV : BaseSpellScript
    {
        public override void OnBeginSpellCast(SpellPacketBody spell)
        {
            Logger.Info("Summon Nature's V OnBeginSpellCast");
        ...
        {
            Logger.Info("Summon Nature's V OnBeginRound");
        }
        public override void OnEndSpellCast(SpellPacketBody spell)
        {
            Logger.Info("Summon Nature's V OnEndSpellCast");
        }
