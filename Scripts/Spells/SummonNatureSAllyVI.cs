...
{
    [SpellScript(481)]
    public class SummonNatureSAllyVI : BaseSpellScript
    {
        public override void OnBeginSpellCast(SpellPacketBody spell)
        {
            Logger.Info("Summon Nature's VI OnBeginSpellCast");
        ...
        {
            Logger.Info("Summon Nature's VI OnSpellEffect");
            var teststr = "; summon nature's ally 6\n"; // change this to the header line for the spell in spells_radial_menu_options.mes
        ...
        {
            Logger.Info("Summon Nature's VI OnBeginRound");
        }
        public override void OnEndSpellCast(SpellPacketBody spell)
        {
            Logger.Info("Summon Nature's VI OnEndSpellCast");
        }
