...
{
    [SpellScript(473)]
    public class SummonMonsterVII : BaseSpellScript
    {
        public override void OnBeginSpellCast(SpellPacketBody spell)
        {
            Logger.Info("Summon Monster VII OnBeginSpellCast");
        ...
        {
            Logger.Info("Summon Monster VII OnBeginRound");
        }
        public override void OnEndSpellCast(SpellPacketBody spell)
        {
            Logger.Info("Summon Monster VII OnEndSpellCast");
        }
