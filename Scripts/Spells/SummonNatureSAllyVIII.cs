...
{
    [SpellScript(483)]
    public class SummonNatureSAllyVIII : BaseSpellScript
    {
        public override void OnBeginSpellCast(SpellPacketBody spell)
        {
            Logger.Info("Summon Nature's VIII OnBeginSpellCast");
        ...
        {
            Logger.Info("Summon Nature's VIII OnSpellEffect");
            var teststr = "; summon nature's ally 8\n"; // change this to the header line for the spell in spells_radial_menu_options.mes
            ...
            AttachParticles("sp-Summon Natures Ally V", target_item.Object);
        ...
        {
            Logger.Info("Summon Nature's VIII OnBeginRound");
        }
        public override void OnEndSpellCast(SpellPacketBody spell)
        {
            Logger.Info("Summon Nature's VIII OnEndSpellCast");
        }
