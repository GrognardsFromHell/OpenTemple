...
namespace Scripts.Spells
{
    ...
    public class SummonNatureSAllyIII : BaseSpellScript
    {
        ...
        {
            Logger.Info("Summon Nature's III OnBeginSpellCast");
        ...
        {
            Logger.Info("Summon Nature's III OnSpellEffect");
            var teststr = "; summon nature's ally 3\n"; // change this to the header line for the spell in spells_radial_menu_options.mes
            ...
            AttachParticles("sp-Summon Natures Ally III", target_item.Object);
        ...
        {
            Logger.Info("Summon Nature's III OnBeginRound");
        }
        public override void OnEndSpellCast(SpellPacketBody spell)
        {
            Logger.Info("Summon Nature's III OnEndSpellCast");
        }
