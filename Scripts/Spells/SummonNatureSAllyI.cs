...
namespace Scripts.Spells
{
    ...
    public class SummonNatureSAllyI : BaseSpellScript
    {
        ...
        {
            Logger.Info("Summon Nature's I OnBeginSpellCast");
        ...
        public override void OnSpellEffect(SpellPacketBody spell)
        {
            ...
            AttachParticles("sp-Summon Natures Ally I", target_item.Object);
        ...
        {
            Logger.Info("Summon Nature's I OnBeginRound");
        }
        public override void OnEndSpellCast(SpellPacketBody spell)
        {
            Logger.Info("Summon Nature's I OnEndSpellCast");
        }
