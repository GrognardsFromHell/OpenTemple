...
{
    [SpellScript(482)]
    public class SummonNatureSAllyVII : BaseSpellScript
    {
        public override void OnBeginSpellCast(SpellPacketBody spell)
        {
            Logger.Info("Summon Nature's VII OnBeginSpellCast");
        ...
        {
            Logger.Info("Summon Nature's VII OnSpellEffect");
            var teststr = "; summon nature's ally 7\n"; // change this to the header line for the spell in spells_radial_menu_options.mes
        ...
        {
            Logger.Info("Summon Nature's VII OnBeginRound");
        }
        public override void OnEndSpellCast(SpellPacketBody spell)
        {
            Logger.Info("Summon Nature's VII OnEndSpellCast");
        }
