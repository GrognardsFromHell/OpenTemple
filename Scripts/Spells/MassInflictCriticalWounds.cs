...
{
    [SpellScript(583)]
    public class MassInflictCriticalWounds : BaseSpellScript
    {
        public override void OnBeginSpellCast(SpellPacketBody spell)
        {
            Logger.Info("Mass Inflict Critical Wounds OnBeginSpellCast");
        ...
        {
            Logger.Info("Mass Inflict Critical Wounds OnBeginRound");
        }
        public override void OnEndSpellCast(SpellPacketBody spell)
        {
            Logger.Info("Mass Inflict Critical Wounds OnEndSpellCast");
        }
