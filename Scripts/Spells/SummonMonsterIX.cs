...
{
    [SpellScript(475)]
    public class SummonMonsterIX : BaseSpellScript
    {
        public override void OnBeginSpellCast(SpellPacketBody spell)
        {
            Logger.Info("Summon Monster IX OnBeginSpellCast");
        ...
        {
            Logger.Info("Summon Monster IX OnBeginRound");
        }
        public override void OnEndSpellCast(SpellPacketBody spell)
        {
            Logger.Info("Summon Monster IX OnEndSpellCast");
        }
