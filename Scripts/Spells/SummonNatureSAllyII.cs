...
{
    [SpellScript(477)]
    public class SummonNatureSAllyII : BaseSpellScript
    {
        public override void OnBeginSpellCast(SpellPacketBody spell)
        {
            Logger.Info("Summon Nature's II OnBeginSpellCast");
        ...
        {
            Logger.Info("Summon Nature's II OnSpellEffect");
            var teststr = "; summon nature's ally 2\n"; // change this to the header line for the spell in spells_radial_menu_options.mes
            ...
            AttachParticles("sp-Summon Natures Ally II", target_item.Object);
        ...
        {
            Logger.Info("Summon Nature's II OnBeginRound");
        }
        public override void OnEndSpellCast(SpellPacketBody spell)
        {
            Logger.Info("Summon Nature's II OnEndSpellCast");
        }
