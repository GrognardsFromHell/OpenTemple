...
namespace Scripts
{
    ...
    public class MoathouseAmbushCourtyard : BaseObjectScript
    {
        ...
        public override bool OnHeartbeat(GameObjectBody attachee, GameObjectBody triggerer)
        {
            ...
            else if (((attachee.GetMap() == 5002) && (GetGlobalVar(765) == 0) && (PartyAlignment != Alignment.LAWFUL_EVIL) && (GetGlobalFlag(977)) && (GetGlobalVar(710) == 2)) && ((GetGlobalVar(450) & Math.Pow(2, 0)) == 0) && ((GetGlobalVar(450) & Math.Pow(2, 11)) == 0))
            {
