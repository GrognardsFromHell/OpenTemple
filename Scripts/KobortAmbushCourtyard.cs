...
namespace Scripts
{
    ...
    public class KobortAmbushCourtyard : BaseObjectScript
    {
        public override bool OnHeartbeat(GameObjectBody attachee, GameObjectBody triggerer)
        {
            ...
            else if (((attachee.GetMap() == 5002) && (GetGlobalVar(765) == 0) && (PartyAlignment != Alignment.LAWFUL_EVIL) && (GetGlobalFlag(977)) && (GetGlobalVar(710) == 2)) && !Co8Settings.DisableNewPlots && ((GetGlobalVar(450) & Math.Pow(2, 11)) == 0))
            {
