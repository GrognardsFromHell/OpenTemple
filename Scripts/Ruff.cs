...
{
    [ObjectScript(594)]
    public class Ruff : BaseObjectScript
    {
        ...
        public override bool OnFirstHeartbeat(GameObjectBody attachee, GameObjectBody triggerer)
        {
            ...
            {
                if ((GetGlobalVar(984) == 1 && GetGlobalVar(986) == 3 && !GetGlobalFlag(566)))
                {
            ...
            {
                if ((GetGlobalVar(984) == 2 && !GetGlobalFlag(566)))
                {
        ...
        public static bool ruff_exit(GameObjectBody attachee, GameObjectBody triggerer)
        {
            ...
            StartTimer(8000, () => ruff_off(attachee, triggerer));
            StartTimer(2000, () => kos_all(attachee, triggerer));
            return RunDefault;
        }
        public static bool ruff_off(GameObjectBody attachee, GameObjectBody triggerer)
        {
            attachee.SetObjectFlag(ObjectFlag.OFF);
            ScriptDaemon.npc_set(attachee, 3);
            return RunDefault;
        }
        public static bool kos_all(GameObjectBody attachee, GameObjectBody triggerer)
        {
