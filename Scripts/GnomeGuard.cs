...
namespace Scripts
{
    ...
    public class GnomeGuard : BaseObjectScript
    {
        ...
        {
            var guard_1 = GameSystems.MapObject.CreateObject(14700, attachee.GetLocation() - 4);
            guard_1.TurnTowards(PartyLeader);
            var guard_2 = GameSystems.MapObject.CreateObject(14700, attachee.GetLocation() - 4);
            guard_2.TurnTowards(PartyLeader);
            var guard_3 = GameSystems.MapObject.CreateObject(14700, attachee.GetLocation() - 4);
