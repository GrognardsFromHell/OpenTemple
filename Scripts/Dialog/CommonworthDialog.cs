...
{
    [DialogScript(354)]
    public class CommonworthDialog : Commonworth, IDialogScript
    {
        public bool CheckPrecondition(GameObjectBody npc, GameObjectBody pc, int lineNumber, string originalScript)
        {
            ...
            {
                case 2:
                    Trace.Assert(originalScript == "not anyone( pc.group_list(), \"has_follower\", 8716 ) and not anyone( pc.group_list(), \"has_follower\", 8718 )");
                    return !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8716)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8718));
                case 3:
                    Trace.Assert(originalScript == "anyone( pc.group_list(), \"has_follower\", 8716 ) and not anyone( pc.group_list(), \"has_follower\", 8718 )");
                    return pc.GetPartyMembers().Any(o => o.HasFollowerByName(8716)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8718));
                case 4:
                    Trace.Assert(originalScript == "anyone( pc.group_list(), \"has_follower\", 8718 ) and not anyone( pc.group_list(), \"has_follower\", 8716 )");
                    return pc.GetPartyMembers().Any(o => o.HasFollowerByName(8718)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8716));
                case 5:
                    Trace.Assert(originalScript == "anyone( pc.group_list(), \"has_follower\", 8716 ) and anyone( pc.group_list(), \"has_follower\", 8718 )");
                    return pc.GetPartyMembers().Any(o => o.HasFollowerByName(8716)) && pc.GetPartyMembers().Any(o => o.HasFollowerByName(8718));
                case 52:
                case 62:
                case 72:
        ...
        public void ApplySideEffect(GameObjectBody npc, GameObjectBody pc, int lineNumber, string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 2000:
                case 3000:
                    Trace.Assert(originalScript == "pc.follower_remove( npc ); game.quests[80].state = qs_botched");
                    pc.RemoveFollower(npc);
                    SetQuestState(80, QuestState.Botched);
                    ;
                    break;
                default:
                    Trace.Assert(originalScript == null);
