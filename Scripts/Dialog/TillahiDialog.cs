    ...
    public class TillahiDialog : Tillahi, IDialogScript
    {
        public bool CheckPrecondition(GameObjectBody npc, GameObjectBody pc, int lineNumber, string originalScript)
        {
            switch (lineNumber)
            {
                case 2:
                case 3:
                    Trace.Assert(originalScript == "game.party_alignment == LAWFUL_NEUTRAL or game.party_alignment == LAWFUL_EVIL or game.party_alignment == LAWFUL_GOOD or pc.stat_level_get(stat_race) == race_elf or game.party_alignment == TRUE_NEUTRAL");
                ...
                case 4:
                case 5:
                    Trace.Assert(originalScript == "game.party_alignment == CHAOTIC_GOOD or game.party_alignment == NEUTRAL_GOOD or game.party_alignment == LAWFUL_GOOD");
                ...
                case 25:
                case 26:
                    Trace.Assert(originalScript == "game.quests[3].state == qs_completed or game.quests[4].state == qs_completed");
                ...
                case 171:
                    ...
                    return PartyAlignment != Alignment.CHAOTIC_GOOD;
                case 81:
                    Trace.Assert(originalScript == "game.party_alignment != LAWFUL_GOOD and game.global_flags[287] == 0");
                ...
                case 123:
                case 124:
                    Trace.Assert(originalScript == "game.global_flags[287] == 1");
                ...
                case 86:
                    ...
                    return PartyAlignment == Alignment.LAWFUL_GOOD && !GetGlobalFlag(287);
                case 92:
                    Trace.Assert(originalScript == "game.global_flags[20] == 0");
                    return !GetGlobalFlag(20);
                case 93:
                case 94:
                    Trace.Assert(originalScript == "game.party_alignment == CHAOTIC_GOOD and game.global_flags[20] == 1");
        ...
        public void ApplySideEffect(GameObjectBody npc, GameObjectBody pc, int lineNumber, string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 131:
                case 132:
                    Trace.Assert(originalScript == "game.global_flags[127] = 1; get_rep( npc, pc )");
                ...
                case 125:
                case 126:
                    Trace.Assert(originalScript == "game.global_flags[20] = 1");
                    SetGlobalFlag(20, true);
                    break;
                case 91:
                case 171:
                    Trace.Assert(originalScript == "set_reward( npc, pc )");
                    set_reward(npc, pc);
                    break;
                case 92:
                    Trace.Assert(originalScript == "run_off( npc, pc ); game.quests[24].state = qs_botched");
                    run_off(npc, pc);
                ...
                case 172:
                case 173:
                    Trace.Assert(originalScript == "game.quests[24].state = qs_completed; set_reward( npc, pc )");
