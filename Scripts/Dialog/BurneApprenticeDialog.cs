    ...
    public class BurneApprenticeDialog : BurneApprentice, IDialogScript
    {
        public bool CheckPrecondition(GameObjectBody npc, GameObjectBody pc, int lineNumber, string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 34:
                case 35:
                    Trace.Assert(originalScript == "pc.reputation_has( 27 ) == 0 and game.global_vars[501] != 2");
                ...
                case 151:
                    Trace.Assert(originalScript == "pc.skill_level_get(npc,skill_diplomacy) >= 12 and game.party[0].reputation_has( 15 )");
                ...
                case 257:
                case 258:
                    Trace.Assert(originalScript == "game.global_flags[358] == 1 and game.global_flags[359] == 0");
                ...
                case 331:
                case 341:
                    Trace.Assert(originalScript == "game.global_vars[526] <= 7");
                    return GetGlobalVar(526) <= 7;
                case 332:
                case 342:
                    Trace.Assert(originalScript == "game.global_vars[526] >= 8");
        ...
        public void ApplySideEffect(GameObjectBody npc, GameObjectBody pc, int lineNumber, string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 331:
                case 341:
                    Trace.Assert(originalScript == "game.global_vars[526] = game.global_vars[526] + 1");
                ...
                case 623:
                case 624:
                    Trace.Assert(originalScript == "pishella_destroy_skull_while_party_npc(pc,npc)");
                    pishella_destroy_skull_while_party_npc(pc, npc);
                    break;
                case 22000:
                    Trace.Assert(originalScript == "game.global_vars[911] = 32");
                    SetGlobalVar(911, 32);
                    break;
                default:
                    Trace.Assert(originalScript == null);
