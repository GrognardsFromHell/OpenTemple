    ...
    public class AgentOfEvilDialog : AgentOfEvil, IDialogScript
    {
        public bool CheckPrecondition(GameObjectBody npc, GameObjectBody pc, int lineNumber, out string originalScript)
        {
            switch (lineNumber)
            {
                case 3:
                case 8:
                    originalScript = "game.global_flags[241] == 0";
                    return !GetGlobalFlag(241);
                case 4:
                case 5:
                    originalScript = "game.quests[15].state == qs_accepted and game.global_flags[241] == 0 and game.global_flags[31] == 0";
                    return GetQuestState(15) == QuestState.Accepted && !GetGlobalFlag(241) && !GetGlobalFlag(31);
                case 6:
                case 7:
                    originalScript = "game.quests[15].state == qs_accepted and game.global_flags[241] == 1 and game.global_flags[31] == 0";
                    return GetQuestState(15) == QuestState.Accepted && GetGlobalFlag(241) && !GetGlobalFlag(31);
                case 13:
                case 14:
                ...
                case 402:
                    originalScript = "game.global_flags[241] == 1";
                    return GetGlobalFlag(241);
                default:
                    originalScript = null;
                    return true;
        ...
        public void ApplySideEffect(GameObjectBody npc, GameObjectBody pc, int lineNumber, out string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 392:
                case 395:
                    originalScript = "run_off(npc,pc); game.global_flags[528] = 1";
                    run_off(npc, pc);
