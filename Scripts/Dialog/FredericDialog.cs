    ...
    public class FredericDialog : Frederic, IDialogScript
    {
        public bool CheckPrecondition(GameObjectBody npc, GameObjectBody pc, int lineNumber, string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 205:
                case 206:
                    Trace.Assert(originalScript == "game.quests[36].state <= qs_mentioned and pc.stat_level_get( stat_gender ) == gender_female");
        ...
        public void ApplySideEffect(GameObjectBody npc, GameObjectBody pc, int lineNumber, string originalScript)
        {
            ...
            {
                case 1:
                    Trace.Assert(originalScript == "game.global_flags[323] = 1; game.global_vars[123] = 1");
