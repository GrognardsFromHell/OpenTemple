    ...
    public class FurnokDialog : Furnok, IDialogScript
    {
        public bool CheckPrecondition(GameObjectBody npc, GameObjectBody pc, int lineNumber, string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 363:
                case 364:
                    Trace.Assert(originalScript == "npc.item_find(8003) != OBJ_HANDLE_NULL and pc.skill_level_get(npc,skill_diplomacy) >= 6");
                    return npc.FindItemByName(8003) != null && pc.GetSkillLevel(npc, SkillId.diplomacy) >= 6;
                case 64:
                case 68:
                    Trace.Assert(originalScript == "npc.item_find(8003) == OBJ_HANDLE_NULL");
        ...
        public void ApplySideEffect(GameObjectBody npc, GameObjectBody pc, int lineNumber, string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 371:
                case 373:
                    Trace.Assert(originalScript == "npc.item_transfer_to(pc,8003)");
                ...
                case 183:
                case 184:
                    Trace.Assert(originalScript == "create_item_in_inventory( 7001, NPC ); create_item_in_inventory( 7001, NPC ); game.global_vars[8] = game.global_vars[8] + 1");
