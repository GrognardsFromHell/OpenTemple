        ...
        public void ApplySideEffect(GameObjectBody npc, GameObjectBody pc, int lineNumber, string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 331:
                    ...
                    break;
                case 231:
                    Trace.Assert(originalScript == "create_item_in_inventory(6136,pc); game.global_vars[17] = 1");
                    Utilities.create_item_in_inventory(6136, pc);
                    SetGlobalVar(17, 1);
                    ;
                    break;
                case 251:
                    Trace.Assert(originalScript == "create_item_in_inventory(6136,pc); game.global_vars[17] = game.global_vars[17] + 1");
                    Utilities.create_item_in_inventory(6136, pc);
