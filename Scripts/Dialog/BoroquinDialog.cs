    ...
    public class BoroquinDialog : Boroquin, IDialogScript
    {
        public bool CheckPrecondition(GameObjectBody npc, GameObjectBody pc, int lineNumber, string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 211:
                    Trace.Assert(originalScript == "game.global_vars[560] == 0 and game.global_flags[542] == 0");
                    return GetGlobalVar(560) == 0 && !GetGlobalFlag(542);
                case 212:
                    Trace.Assert(originalScript == "game.global_vars[560] == 1 and game.global_flags[542] == 0");
                    return GetGlobalVar(560) == 1 && !GetGlobalFlag(542);
                case 213:
                    Trace.Assert(originalScript == "game.global_vars[560] == 2 and game.global_flags[542] == 0");
                    return GetGlobalVar(560) == 2 && !GetGlobalFlag(542);
                case 214:
                    Trace.Assert(originalScript == "game.global_vars[560] == 0 and game.global_flags[542] == 1");
                    return GetGlobalVar(560) == 0 && GetGlobalFlag(542);
                case 222:
                case 231:
                case 321:
                ...
                case 392:
                case 422:
                    Trace.Assert(originalScript == "not anyone( pc.group_list(), \"has_follower\", 8767 ) and game.global_vars[544] == 3 and pc.follower_atmax() == 0");
                ...
                case 402:
                    Trace.Assert(originalScript == "npc_get(npc,11)");
                    return ScriptDaemon.npc_get(npc, 11);
                case 431:
        ...
        public void ApplySideEffect(GameObjectBody npc, GameObjectBody pc, int lineNumber, string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 125:
                    ...
                    break;
                case 311:
                    Trace.Assert(originalScript == "game.global_flags[542] = 1");
                    SetGlobalFlag(542, true);
                    break;
                case 312:
                    Trace.Assert(originalScript == "game.global_vars[560] = 2");
                    SetGlobalVar(560, 2);
                    break;
                case 313:
                    Trace.Assert(originalScript == "game.global_vars[560] = 1");
                    SetGlobalVar(560, 1);
                    break;
                case 320:
                    Trace.Assert(originalScript == "increment_var_544(npc,pc); check_evidence_rep_bor(npc,pc)");
                ...
                case 401:
                    ...
                    break;
                case 410:
                    Trace.Assert(originalScript == "game.global_flags[535] = 1");
                ...
                case 433:
                    ...
                    break;
                case 440:
                    Trace.Assert(originalScript == "game.global_vars[558] = 1");
                    SetGlobalVar(558, 1);
                    break;
                default:
                    Trace.Assert(originalScript == null);
