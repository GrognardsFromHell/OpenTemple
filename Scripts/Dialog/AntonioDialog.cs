    ...
    public class AntonioDialog : Antonio, IDialogScript
    {
        public bool CheckPrecondition(GameObject npc, GameObject pc, int lineNumber, out string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 29:
                case 30:
                    originalScript = "game.global_flags[141] == 1 or pc.skill_level_get(npc, skill_bluff) >= 16";
                    return GetGlobalFlag(141) || pc.GetSkillLevel(npc, SkillId.bluff) >= 16;
                case 31:
                case 32:
                    originalScript = "pc.money_get() >= 100000 and game.quests[57].state == qs_accepted and game.global_flags[142] == 1";
