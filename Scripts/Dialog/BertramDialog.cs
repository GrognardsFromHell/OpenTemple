    ...
    public class BertramDialog : Bertram, IDialogScript
    {
        public bool CheckPrecondition(GameObject npc, GameObject pc, int lineNumber, out string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 205:
                case 206:
                    originalScript = "game.quests[36].state <= qs_mentioned and pc.stat_level_get( stat_gender ) == gender_male";
        ...
        public void ApplySideEffect(GameObject npc, GameObject pc, int lineNumber, out string originalScript)
        {
            ...
            {
                case 1:
                    originalScript = "game.global_flags[324] = 1; game.global_vars[122] = 1";
