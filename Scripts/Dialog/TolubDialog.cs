    ...
    public class TolubDialog : Tolub, IDialogScript
    {
        public bool CheckPrecondition(GameObjectBody npc, GameObjectBody pc, int lineNumber, out string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 501:
                case 503:
                    originalScript = "game.global_flags[101] == 0 and game.quests[36].state == qs_accepted";
                    return !GetGlobalFlag(101) && GetQuestState(36) == QuestState.Accepted;
                case 502:
                case 504:
                    originalScript = "game.global_flags[101] == 1 and game.quests[36].state == qs_accepted";
                    return GetGlobalFlag(101) && GetQuestState(36) == QuestState.Accepted;
                default:
                    originalScript = null;
                    return true;
        ...
        public void ApplySideEffect(GameObjectBody npc, GameObjectBody pc, int lineNumber, out string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 350:
                    ...
                    break;
                case 400:
                    originalScript = "game.global_vars[10] = 4";
                    SetGlobalVar(10, 4);
                    break;
                case 431:
                    originalScript = "game.quests[40].state = qs_botched; npc.attack(pc)";
                    SetQuestState(40, QuestState.Botched);
                    npc.Attack(pc);
                    ;
                    break;
