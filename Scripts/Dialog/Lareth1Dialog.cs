    ...
    public class Lareth1Dialog : Lareth1, IDialogScript
    {
        ...
        public void ApplySideEffect(GameObjectBody npc, GameObjectBody pc, int lineNumber, out string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 10:
                case 20:
                    originalScript = "game.global_flags[834] = 1; game.global_flags[62] = 1; game.global_vars[116] = 1";
                ...
                case 107:
                case 6177:
                    originalScript = "game.global_flags[198] = 1; argue_ron(npc,pc,550)";
                ...
                case 330:
                case 6120:
                    originalScript = "game.global_flags[834] = 1; game.global_flags[62] = 1";
                    SetGlobalFlag(834, true);
                    SetGlobalFlag(62, true);
                    ;
                    break;
                case 160:
                case 8000:
                    originalScript = "game.global_flags[834] = 1";
                    SetGlobalFlag(834, true);
                    break;
                case 181:
                case 182:
                case 6721:
                case 6722:
                    originalScript = "pc.follower_add( npc ); pc.reputation_add( 18 ); record_time_stamp(425)";
                    pc.AddFollower(npc);
                    pc.AddReputation(18);
                ...
                case 187:
                case 6727:
                    originalScript = "argue_ron(npc,pc,370)";
                ...
                case 6781:
                case 6782:
                    originalScript = "npc.item_transfer_to_by_proto(pc,6100); pc.follower_add( npc ); pc.reputation_add( 18 ); record_time_stamp(425)";
                    npc.TransferItemByProtoTo(pc, 6100);
                    pc.AddFollower(npc);
                    pc.AddReputation(18);
                    ScriptDaemon.record_time_stamp(425);
                ...
                case 219:
                case 6789:
                    originalScript = "npc.item_transfer_to_by_proto(pc,6100); argue_ron(npc,pc,270)";
                    npc.TransferItemByProtoTo(pc, 6100);
                ...
                case 220:
                case 6800:
                    originalScript = "record_time_stamp(425)";
                    ScriptDaemon.record_time_stamp(425);
                    break;
                case 223:
                case 224:
                ...
                case 6803:
                case 6804:
                    originalScript = "game.fade_and_teleport( 14400, 0, 0, 5111, 481, 501 )";
                ...
                case 604:
                case 6821:
                    originalScript = "game.global_flags[37] = 0; game.story_state = 2; pc.follower_remove( npc ); run_off( npc, pc )";
                ...
                case 270:
                    ...
                    break;
                case 301:
                    originalScript = "game.global_flags[37] = 0; pc.follower_remove( npc ); run_off( npc, pc )";
                    SetGlobalFlag(37, false);
                    pc.RemoveFollower(npc);
                    run_off(npc, pc);
                    ;
                ...
                case 381:
                    ...
                    break;
                case 631:
                    originalScript = "game.global_flags[37] = 0; game.story_state = 2; pc.follower_remove( npc ); run_off( npc, pc ); argue_ron(npc,pc,25)";
                    SetGlobalFlag(37, false);
                    StoryState = 2;
                    pc.RemoveFollower(npc);
                    run_off(npc, pc);
                    ...
                    break;
                case 700:
                    originalScript = "game.particles( 'sp-Curse Water', npc ); create_spiders(npc, pc)";
                ...
                case 1300:
                case 1400:
                    originalScript = "game.global_flags[806] = 1; pc.follower_remove( npc ); party_transfer_to( npc, 11003 ); pc.follower_add( npc ); game.global_flags[806] = 0";
                ...
                case 1503:
                    ...
                    break;
                case 1500:
                    originalScript = "game.global_flags[806] = 1; pc.follower_remove( npc ); party_transfer_to( npc, 11003 ); game.global_flags[806] = 0";
                    SetGlobalFlag(806, true);
                    pc.RemoveFollower(npc);
                    Utilities.party_transfer_to(npc, 11003);
                    SetGlobalFlag(806, false);
                    ...
                    break;
                case 6100:
                    originalScript = "game.global_flags[834] = 1; game.sound(4200, 1)";
                    SetGlobalFlag(834, true);
                    Sound(4200, 1);
                    ;
                    break;
