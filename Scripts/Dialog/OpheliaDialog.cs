    ...
    public class OpheliaDialog : Ophelia, IDialogScript
    {
        public bool CheckPrecondition(GameObjectBody npc, GameObjectBody pc, int lineNumber, string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 717:
                case 801:
                    Trace.Assert(originalScript == "game.global_vars[924] == 1 and anyone( pc.group_list(), \"has_item\", 11010 )");
                ...
                case 95:
                case 96:
                    Trace.Assert(originalScript == "pc.skill_level_get(npc, skill_diplomacy) >= 8 and pc.money_get() >= 10000");
                ...
                case 531:
                case 532:
                    Trace.Assert(originalScript == "game.global_flags[859] == 0");
                    return !GetGlobalFlag(859);
                case 309:
                case 536:
                    Trace.Assert(originalScript == "game.global_flags[859] == 1");
                    return GetGlobalFlag(859);
                case 321:
                case 322:
                ...
                case 361:
                    Trace.Assert(originalScript == "pc.skill_level_get(npc, skill_diplomacy) >= 6 and pc.money_get() >= 3000 and game.global_flags[87] == 0");
                ...
                case 641:
                case 642:
                    Trace.Assert(originalScript == "game.global_flags[860] == 1");
                    return GetGlobalFlag(860);
                case 643:
                case 644:
                    Trace.Assert(originalScript == "game.global_flags[860] == 0");
                    return !GetGlobalFlag(860);
                case 663:
                case 664:
                ...
                case 799:
                case 800:
                    Trace.Assert(originalScript == "game.quests[33].state >= qs_mentioned and game.global_flags[693] == 1");
        ...
        public void ApplySideEffect(GameObjectBody npc, GameObjectBody pc, int lineNumber, string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 220:
                case 490:
                    Trace.Assert(originalScript == "game.quests[33].state = qs_mentioned; game.global_flags[693] = 1");
                ...
                case 172:
                    ...
                    break;
                case 240:
                    Trace.Assert(originalScript == "game.quests[33].state = qs_accepted; game.global_flags[76] = 1; game.global_flags[693] = 1");
                    ...
                    break;
                case 250:
                    Trace.Assert(originalScript == "game.quests[33].state = qs_accepted; game.global_flags[77] = 1; game.global_flags[693] = 1");
                    SetQuestState(33, QuestState.Accepted);
                ...
                case 611:
                case 612:
                    Trace.Assert(originalScript == "pc.money_adj(-2000); game.global_flags[82] = 1");
                    pc.AdjustMoney(-2000);
                ...
                case 843:
                case 844:
                    Trace.Assert(originalScript == "game.global_vars[924] = 2; party_transfer_to( npc, 11010 )");
                    SetGlobalVar(924, 2);
