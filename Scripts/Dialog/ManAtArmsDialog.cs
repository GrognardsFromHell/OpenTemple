    ...
    public class ManAtArmsDialog : ManAtArms, IDialogScript
    {
        public bool CheckPrecondition(GameObjectBody npc, GameObjectBody pc, int lineNumber, string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 501:
                case 502:
                    Trace.Assert(originalScript == "game.global_flags[868] == 0");
                    return !GetGlobalFlag(868);
                case 561:
                    Trace.Assert(originalScript == "pc.money_get() >= 11000");
                    return pc.GetMoney() >= 11000;
                case 562:
                case 563:
                    Trace.Assert(originalScript == "pc.money_get() <= 10999");
                    return pc.GetMoney() <= 10999;
                case 723:
                case 732:
                    Trace.Assert(originalScript == "game.party_alignment != LAWFUL_NEUTRAL and game.party_alignment != LAWFUL_GOOD");
        ...
        public void ApplySideEffect(GameObjectBody npc, GameObjectBody pc, int lineNumber, string originalScript)
        {
            switch (lineNumber)
            {
                case 1:
                    ...
                    break;
                case 8:
                    Trace.Assert(originalScript == "respawn(npc)");
                ...
                case 550:
                    ...
                    break;
                case 561:
                    Trace.Assert(originalScript == "game.global_flags[868] = 1; pc.money_adj(-11000); equip_transfer( npc, pc )");
