        ...
        public bool CheckPrecondition(GameObjectBody npc, GameObjectBody pc, int lineNumber, string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 4:
                    ...
                    return npc.HasMet(pc);
                case 12:
                    Trace.Assert(originalScript == "(game.party_alignment == LAWFUL_GOOD or game.party_alignment == NEUTRAL_GOOD or game.party_alignment == CHAOTIC_GOOD) and pc.stat_level_get(stat_level_paladin) == 0");
                ...
                case 75:
                    Trace.Assert(originalScript == "(npc_get(npc,1) or npc_get(npc,4)) and not npc_get(npc,8)");
