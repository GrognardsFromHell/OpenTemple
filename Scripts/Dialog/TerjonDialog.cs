    ...
    public class TerjonDialog : Terjon, IDialogScript
    {
        public bool CheckPrecondition(GameObjectBody npc, GameObjectBody pc, int lineNumber, string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 121:
                case 122:
                    Trace.Assert(originalScript == "game.story_state >= 2 and game.global_vars[562] == 3");
                ...
                case 169:
                case 170:
                    Trace.Assert(originalScript == "pc.skill_level_get(npc,skill_diplomacy) >= 9 and game.global_flags[27] == 1");
                ...
                case 1251:
                case 1252:
                    Trace.Assert(originalScript == "pc.skill_level_get(npc,skill_diplomacy) >= 6 or pc.skill_level_get(npc,skill_bluff) >= 4");
                    return pc.GetSkillLevel(npc, SkillId.diplomacy) >= 6 || pc.GetSkillLevel(npc, SkillId.bluff) >= 4;
                case 1321:
                case 1322:
                    Trace.Assert(originalScript == "pc.money_get() >= 1100000");
                    return pc.GetMoney() >= 1100000;
                case 1331:
                case 1332:
                    Trace.Assert(originalScript == "pc.money_get() >= 1200000");
                    return pc.GetMoney() >= 1200000;
                case 1341:
                case 1342:
                    Trace.Assert(originalScript == "pc.money_get() >= 1300000");
                    return pc.GetMoney() >= 1300000;
                case 1351:
                case 1352:
                    Trace.Assert(originalScript == "pc.money_get() >= 1400000");
                ...
                case 1371:
                case 1372:
                    Trace.Assert(originalScript == "pc.money_get() >= 1600000");
                    return pc.GetMoney() >= 1600000;
                case 1381:
                case 1382:
                    Trace.Assert(originalScript == "pc.money_get() >= 1700000");
                    return pc.GetMoney() >= 1700000;
                case 1391:
                case 1392:
                    Trace.Assert(originalScript == "pc.money_get() >= 1800000");
                    return pc.GetMoney() >= 1800000;
                case 1401:
                case 1402:
                    Trace.Assert(originalScript == "pc.money_get() >= 1900000");
                ...
                case 1511:
                    Trace.Assert(originalScript == "game.global_vars[527] <= 1");
                    return GetGlobalVar(527) <= 1;
                case 1512:
                    Trace.Assert(originalScript == "game.global_vars[527] >= 2");
                    return GetGlobalVar(527) >= 2;
                case 1513:
                    Trace.Assert(originalScript == "game.global_vars[528] <= 3");
                    return GetGlobalVar(528) <= 3;
                case 1514:
                    Trace.Assert(originalScript == "game.global_vars[528] >= 4");
                ...
                case 1595:
                case 1598:
                    Trace.Assert(originalScript == "game.areas[3] == 0 and game.story_state >= 2 and game.global_vars[562] != 3");
                ...
                case 1597:
                case 1600:
                    Trace.Assert(originalScript == "game.areas[3] == 1 and game.story_state >= 2 and game.global_vars[562] == 3");
                    return IsAreaKnown(3) && StoryState >= 2 && GetGlobalVar(562) == 3;
                case 1601:
                case 1602:
        ...
        public void ApplySideEffect(GameObjectBody npc, GameObjectBody pc, int lineNumber, string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 1163:
                case 1164:
                    Trace.Assert(originalScript == "game.quests[72].state = qs_accepted; game.global_vars[562] = 3");
                ...
                case 1293:
                case 1294:
                    Trace.Assert(originalScript == "game.quests[72].state = qs_accepted; game.global_vars[562] = 3; game.worldmap_travel_by_dialog(2)");
                    SetQuestState(72, QuestState.Accepted);
                    SetGlobalVar(562, 3);
                ...
                case 292:
                    ...
                    break;
                case 290:
                    Trace.Assert(originalScript == "game.areas[2] = 1; game.story_state = 1; game.quests[72].state = qs_accepted; game.global_vars[562] = 3");
                    MakeAreaKnown(2);
                    StoryState = 1;
                    SetQuestState(72, QuestState.Accepted);
                    SetGlobalVar(562, 3);
                ...
                case 561:
                case 563:
                    Trace.Assert(originalScript == "pc.money_adj(-24000); npc.cast_spell( spell_neutralize_poison, picker_obj )");
                ...
                case 621:
                case 623:
                    Trace.Assert(originalScript == "pc.money_adj(-27000); npc.cast_spell( spell_neutralize_poison, picker_obj )");
                ...
                case 681:
                case 683:
                    Trace.Assert(originalScript == "pc.money_adj(-30000); npc.cast_spell( spell_neutralize_poison, picker_obj )");
                ...
                case 741:
                case 743:
                    Trace.Assert(originalScript == "pc.money_adj(-36000); npc.cast_spell( spell_neutralize_poison, picker_obj )");
                ...
                case 801:
                case 803:
                    Trace.Assert(originalScript == "pc.money_adj(-40000); npc.cast_spell( spell_neutralize_poison, picker_obj )");
                ...
                case 861:
                case 863:
                    Trace.Assert(originalScript == "pc.money_adj(-45000); npc.cast_spell( spell_neutralize_poison, picker_obj )");
                ...
                case 921:
                case 923:
                    Trace.Assert(originalScript == "pc.money_adj(-50000); npc.cast_spell( spell_neutralize_poison, picker_obj )");
                ...
                case 1412:
                    ...
                    break;
                case 1520:
                    Trace.Assert(originalScript == "game.picker( npc, spell_raise_dead, should_resurrect_on, [ 1530, 1510, 1540 ] )");
                    // FIXME: picker;
                    break;
                case 1540:
                    Trace.Assert(originalScript == "game.global_vars[527] = game.global_vars[527] + 1");
                    SetGlobalVar(527, GetGlobalVar(527) + 1);
                    break;
                case 1541:
                    Trace.Assert(originalScript == "npc.cast_spell( spell_raise_dead, picker_obj )");
                    npc.CastSpell(WellKnownSpells.RaiseDead, PickedObject);
                    break;
                case 1560:
                    Trace.Assert(originalScript == "game.picker( npc, spell_cure_serious_wounds, should_heal_hp_on, [ 1530, 1510, 1570 ] )");
                    // FIXME: picker;
                    break;
                case 1570:
                    Trace.Assert(originalScript == "game.global_vars[528] = game.global_vars[528] + 1");
                    SetGlobalVar(528, GetGlobalVar(528) + 1);
                    break;
                case 1571:
                    Trace.Assert(originalScript == "npc.cast_spell( spell_cure_serious_wounds, picker_obj )");
                    npc.CastSpell(WellKnownSpells.CureSeriousWounds, PickedObject);
                    break;
                case 2000:
                    Trace.Assert(originalScript == "create_calmert(npc, pc)");
                    create_calmert(npc, pc);
                    break;
                case 2001:
                    Trace.Assert(originalScript == "switch_to_calmert(npc, pc)");
