        ...
        public bool CheckPrecondition(GameObjectBody npc, GameObjectBody pc, int lineNumber, out string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 484:
                    ...
                    return !pc.GetPartyMembers().Any(o => o.FindItemByName(3010) != null);
                case 561:
                    originalScript = "pc.skill_level_get(npc,skill_listen) <= 7";
                    throw new NotSupportedException("Conversion failed.");
                case 562:
                    originalScript = "pc.skill_level_get(npc,skill_listen) >= 8";
                    throw new NotSupportedException("Conversion failed.");
                case 611:
                case 624:
                case 625:
                    originalScript = "game.global_flags[104] == 1 and game.global_flags[106] == 0 and game.global_flags[107] == 0";
                    return GetGlobalFlag(104) && !GetGlobalFlag(106) && !GetGlobalFlag(107);
                case 612:
                case 633:
                case 635:
                    originalScript = "game.global_flags[104] == 0 and game.global_flags[106] == 1 and game.global_flags[107] == 0";
                    return !GetGlobalFlag(104) && GetGlobalFlag(106) && !GetGlobalFlag(107);
                case 613:
                case 641:
                case 645:
                    originalScript = "game.global_flags[104] == 0 and game.global_flags[106] == 0 and game.global_flags[107] == 1";
                    return !GetGlobalFlag(104) && !GetGlobalFlag(106) && GetGlobalFlag(107);
                case 614:
                case 634:
                case 636:
                    originalScript = "game.global_flags[104] == 1 and game.global_flags[106] == 1 and game.global_flags[107] == 0";
                    return GetGlobalFlag(104) && GetGlobalFlag(106) && !GetGlobalFlag(107);
                case 615:
                case 642:
                case 646:
                    originalScript = "game.global_flags[104] == 1 and game.global_flags[106] == 0 and game.global_flags[107] == 1";
                    return GetGlobalFlag(104) && !GetGlobalFlag(106) && GetGlobalFlag(107);
                case 616:
                case 631:
                case 643:
                case 647:
                    originalScript = "game.global_flags[104] == 0 and game.global_flags[106] == 1 and game.global_flags[107] == 1";
                    return !GetGlobalFlag(104) && GetGlobalFlag(106) && GetGlobalFlag(107);
                case 617:
                case 632:
                case 644:
                case 648:
                    originalScript = "game.global_flags[104] == 1 and game.global_flags[106] == 1 and game.global_flags[107] == 1";
                    return GetGlobalFlag(104) && GetGlobalFlag(106) && GetGlobalFlag(107);
                case 621:
                    originalScript = "game.global_flags[106] == 1 and game.global_flags[107] == 0";
                    return GetGlobalFlag(106) && !GetGlobalFlag(107);
                case 622:
                    originalScript = "game.global_flags[106] == 0 and game.global_flags[107] == 1";
                    return !GetGlobalFlag(106) && GetGlobalFlag(107);
                case 623:
                    originalScript = "game.global_flags[106] == 1 and game.global_flags[107] == 1";
                    return GetGlobalFlag(106) && GetGlobalFlag(107);
                default:
                    originalScript = null;
                    return true;
        ...
        public void ApplySideEffect(GameObjectBody npc, GameObjectBody pc, int lineNumber, out string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 200:
                    ...
                    break;
                case 100:
                    originalScript = "game.quests[47].state = qs_accepted; npc.item_transfer_to(pc,3602); game.global_flags[345] = 1; record_time_stamp(475)";
                ...
                case 180:
                    ...
                    break;
                case 160:
                    originalScript = "game.quests[48].state = qs_accepted; create_item_in_inventory(6110,pc); game.global_flags[345] = 1; record_time_stamp(477)";
                    ...
                    break;
                case 300:
                    originalScript = "game.quests[46].state = qs_accepted; game.global_flags[345] = 1; record_time_stamp(473)";
                ...
                case 540:
                    ...
                    RevealTownMapMarker(5067, 2);
                    break;
                case 550:
                    originalScript = "game.map_flags( 5105, 3, 1 )";
                    RevealTownMapMarker(5105, 3);
                    break;
                case 560:
                    originalScript = "game.map_flags( 5105, 4, 1 )";
                    RevealTownMapMarker(5105, 4);
                    break;
                case 562:
