    ...
    public class TubalDialog : Tubal, IDialogScript
    {
        public bool CheckPrecondition(GameObjectBody npc, GameObjectBody pc, int lineNumber, out string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 181:
                case 182:
                    originalScript = "game.global_flags[141] == 0 and game.global_flags[115] == 0 and pc.skill_level_get(npc, skill_sense_motive) >= 12";
                ...
                case 185:
                case 186:
                    originalScript = "game.global_flags[115] == 1 and pc.skill_level_get(npc, skill_diplomacy) >= 13 and game.global_flags[107] == 0";
