    ...
    public class CaptainAbiramDialog : CaptainAbiram, IDialogScript
    {
        public bool CheckPrecondition(GameObjectBody npc, GameObjectBody pc, int lineNumber, out string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 11:
                    originalScript = "not is_daytime() == 0";
                ...
                case 62:
                case 72:
                    originalScript = "game.global_flags[980] == 0";
                    return !GetGlobalFlag(980);
                case 73:
                    originalScript = "game.global_flags[980] == 1";
                    return GetGlobalFlag(980);
                case 74:
                case 94:
                case 104:
                ...
                case 81:
                case 127:
                    originalScript = "game.global_vars[535] == 3 and (anyone( pc.group_list(), \"has_follower\", 8791 ) or anyone( pc.group_list(), \"has_follower\", 8792 ) or anyone( pc.group_list(), \"has_follower\", 8793 ) or anyone( pc.group_list(), \"has_follower\", 8794 ) or anyone( pc.group_list(), \"has_follower\", 8795 ) or anyone( pc.group_list(), \"has_follower\", 8796 ) or anyone( pc.group_list(), \"has_follower\", 8797 ) or anyone( pc.group_list(), \"has_follower\", 8798 ))";
                    return GetGlobalVar(535) == 3 && (pc.GetPartyMembers().Any(o => o.HasFollowerByName(8791)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8792)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8793)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8794)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8795)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8796)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8797)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8798)));
                case 82:
                case 128:
                    originalScript = "not npc_get(npc,29) and game.quests[109].state == qs_mentioned and game.global_vars[535] == 2 and (game.global_vars[543] >= 3 or game.global_vars[544] >= 3 or game.global_vars[545] >= 3)";
                ...
                case 83:
                case 129:
                    originalScript = "not npc_get(npc,29) and game.quests[109].state == qs_accepted and game.global_vars[535] == 3 and (game.global_vars[543] >= 3 or game.global_vars[544] >= 3 or game.global_vars[545] >= 3)";
                ...
                case 84:
                case 130:
                    originalScript = "game.global_vars[535] == 3 and (game.global_vars[543] <= 2 and game.global_vars[544] <= 2 and game.global_vars[545] <= 2)";
                    return GetGlobalVar(535) == 3 && (GetGlobalVar(543) <= 2 && GetGlobalVar(544) <= 2 && GetGlobalVar(545) <= 2);
                case 85:
                case 131:
                    originalScript = "game.quests[109].state == qs_accepted";
                ...
                case 133:
                    originalScript = "game.quests[62].state == qs_accepted and (game.global_flags[560] == 0 or game.global_flags[561] == 0 or game.global_flags[562] == 0) and not npc_get(npc,30)";
                ...
                case 795:
                case 1135:
                    originalScript = "game.global_flags[530] == 0 and not npc_get(npc,24)";
                ...
                case 797:
                case 1137:
                    originalScript = "not npc_get(npc,26)";
                ...
                case 798:
                case 1138:
                    originalScript = "game.global_vars[550] == 0 and not npc_get(npc,27)";
                ...
                case 799:
                case 1139:
                    originalScript = "not npc_get(npc,28)";
                    return !ScriptDaemon.npc_get(npc, 28);
                case 801:
                case 811:
                case 1061:
                    originalScript = "game.global_vars[542] == 2 and game.global_vars[543] >= 3";
                    return GetGlobalVar(542) == 2 && GetGlobalVar(543) >= 3;
                case 802:
                case 1062:
                    originalScript = "(game.global_vars[542] == 1 and game.global_vars[544] >=3) or (game.global_vars[542] == 3 and game.global_vars[545] >=3)";
                    return (GetGlobalVar(542) == 1 && GetGlobalVar(544) >= 3) || (GetGlobalVar(542) == 3 && GetGlobalVar(545) >= 3);
                case 803:
                case 814:
                case 1063:
                case 1073:
                    originalScript = "game.global_vars[543] <= 2 and game.global_vars[544] <= 2 and game.global_vars[545] <= 2";
                    return GetGlobalVar(543) <= 2 && GetGlobalVar(544) <= 2 && GetGlobalVar(545) <= 2;
                case 812:
                case 1071:
                    originalScript = "game.global_vars[542] == 3 and game.global_vars[545] >= 3";
                    return GetGlobalVar(542) == 3 && GetGlobalVar(545) >= 3;
                case 813:
                case 1072:
                    originalScript = "game.global_vars[542] == 1 and game.global_vars[544] >= 3";
                    return GetGlobalVar(542) == 1 && GetGlobalVar(544) >= 3;
                case 821:
                    originalScript = "game.global_flags[543] == 1 and game.global_vars[555] == 2 and game.global_vars[552] >= 1 and (anyone( pc.group_list(), \"has_follower\", 8791 ) or anyone( pc.group_list(), \"has_follower\", 8792 ) or anyone( pc.group_list(), \"has_follower\", 8793 ) or anyone( pc.group_list(), \"has_follower\", 8794 ) or anyone( pc.group_list(), \"has_follower\", 8795 ) or anyone( pc.group_list(), \"has_follower\", 8796 ) or anyone( pc.group_list(), \"has_follower\", 8797 ) or anyone( pc.group_list(), \"has_follower\", 8798 ))";
                    return GetGlobalFlag(543) && GetGlobalVar(555) == 2 && GetGlobalVar(552) >= 1 && (pc.GetPartyMembers().Any(o => o.HasFollowerByName(8791)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8792)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8793)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8794)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8795)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8796)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8797)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8798)));
                case 822:
                    originalScript = "game.global_flags[543] == 1 and game.global_vars[555] == 2 and game.global_vars[552] >= 1 and not anyone( pc.group_list(), \"has_follower\", 8791 ) and not anyone( pc.group_list(), \"has_follower\", 8792 ) and not anyone( pc.group_list(), \"has_follower\", 8793 ) and not anyone( pc.group_list(), \"has_follower\", 8794 ) and not anyone( pc.group_list(), \"has_follower\", 8795 ) and not anyone( pc.group_list(), \"has_follower\", 8796 ) and not anyone( pc.group_list(), \"has_follower\", 8797 ) and not anyone( pc.group_list(), \"has_follower\", 8798 )";
                    return GetGlobalFlag(543) && GetGlobalVar(555) == 2 && GetGlobalVar(552) >= 1 && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8791)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8792)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8793)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8794)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8795)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8796)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8797)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8798));
                case 823:
                    originalScript = "game.global_flags[543] == 1 and game.global_vars[555] == 2 and game.global_vars[552] == 0 and (anyone( pc.group_list(), \"has_follower\", 8791 ) or anyone( pc.group_list(), \"has_follower\", 8792 ) or anyone( pc.group_list(), \"has_follower\", 8793 ) or anyone( pc.group_list(), \"has_follower\", 8794 ) or anyone( pc.group_list(), \"has_follower\", 8795 ) or anyone( pc.group_list(), \"has_follower\", 8796 ) or anyone( pc.group_list(), \"has_follower\", 8797 ) or anyone( pc.group_list(), \"has_follower\", 8798 ))";
                    return GetGlobalFlag(543) && GetGlobalVar(555) == 2 && GetGlobalVar(552) == 0 && (pc.GetPartyMembers().Any(o => o.HasFollowerByName(8791)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8792)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8793)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8794)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8795)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8796)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8797)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8798)));
                case 824:
                    originalScript = "game.global_flags[543] == 1 and game.global_vars[555] == 2 and game.global_vars[552] == 0 and not anyone( pc.group_list(), \"has_follower\", 8791 ) and not anyone( pc.group_list(), \"has_follower\", 8792 ) and not anyone( pc.group_list(), \"has_follower\", 8793 ) and not anyone( pc.group_list(), \"has_follower\", 8794 ) and not anyone( pc.group_list(), \"has_follower\", 8795 ) and not anyone( pc.group_list(), \"has_follower\", 8796 ) and not anyone( pc.group_list(), \"has_follower\", 8797 ) and not anyone( pc.group_list(), \"has_follower\", 8798 )";
                    return GetGlobalFlag(543) && GetGlobalVar(555) == 2 && GetGlobalVar(552) == 0 && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8791)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8792)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8793)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8794)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8795)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8796)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8797)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8798));
                case 825:
                    originalScript = "game.global_flags[543] == 1 and game.global_vars[555] == 1 and game.global_vars[552] >= 1 and (anyone( pc.group_list(), \"has_follower\", 8791 ) or anyone( pc.group_list(), \"has_follower\", 8792 ) or anyone( pc.group_list(), \"has_follower\", 8793 ) or anyone( pc.group_list(), \"has_follower\", 8794 ) or anyone( pc.group_list(), \"has_follower\", 8795 ) or anyone( pc.group_list(), \"has_follower\", 8796 ) or anyone( pc.group_list(), \"has_follower\", 8797 ) or anyone( pc.group_list(), \"has_follower\", 8798 ))";
                    return GetGlobalFlag(543) && GetGlobalVar(555) == 1 && GetGlobalVar(552) >= 1 && (pc.GetPartyMembers().Any(o => o.HasFollowerByName(8791)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8792)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8793)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8794)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8795)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8796)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8797)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8798)));
                case 826:
                    originalScript = "game.global_flags[543] == 1 and game.global_vars[555] == 1 and game.global_vars[552] >= 1 and not anyone( pc.group_list(), \"has_follower\", 8791 ) and not anyone( pc.group_list(), \"has_follower\", 8792 ) and not anyone( pc.group_list(), \"has_follower\", 8793 ) and not anyone( pc.group_list(), \"has_follower\", 8794 ) and not anyone( pc.group_list(), \"has_follower\", 8795 ) and not anyone( pc.group_list(), \"has_follower\", 8796 ) and not anyone( pc.group_list(), \"has_follower\", 8797 ) and not anyone( pc.group_list(), \"has_follower\", 8798 )";
                    return GetGlobalFlag(543) && GetGlobalVar(555) == 1 && GetGlobalVar(552) >= 1 && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8791)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8792)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8793)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8794)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8795)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8796)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8797)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8798));
                case 827:
                    originalScript = "game.global_flags[543] == 0 and game.global_vars[555] == 2 and game.global_vars[552] >= 1 and (anyone( pc.group_list(), \"has_follower\", 8791 ) or anyone( pc.group_list(), \"has_follower\", 8792 ) or anyone( pc.group_list(), \"has_follower\", 8793 ) or anyone( pc.group_list(), \"has_follower\", 8794 ) or anyone( pc.group_list(), \"has_follower\", 8795 ) or anyone( pc.group_list(), \"has_follower\", 8796 ) or anyone( pc.group_list(), \"has_follower\", 8797 ) or anyone( pc.group_list(), \"has_follower\", 8798 ))";
                    return !GetGlobalFlag(543) && GetGlobalVar(555) == 2 && GetGlobalVar(552) >= 1 && (pc.GetPartyMembers().Any(o => o.HasFollowerByName(8791)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8792)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8793)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8794)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8795)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8796)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8797)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8798)));
                case 828:
                    originalScript = "game.global_flags[543] == 0 and game.global_vars[555] == 2 and game.global_vars[552] >= 1 and not anyone( pc.group_list(), \"has_follower\", 8791 ) and not anyone( pc.group_list(), \"has_follower\", 8792 ) and not anyone( pc.group_list(), \"has_follower\", 8793 ) and not anyone( pc.group_list(), \"has_follower\", 8794 ) and not anyone( pc.group_list(), \"has_follower\", 8795 ) and not anyone( pc.group_list(), \"has_follower\", 8796 ) and not anyone( pc.group_list(), \"has_follower\", 8797 ) and not anyone( pc.group_list(), \"has_follower\", 8798 )";
                    return !GetGlobalFlag(543) && GetGlobalVar(555) == 2 && GetGlobalVar(552) >= 1 && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8791)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8792)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8793)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8794)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8795)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8796)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8797)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8798));
                case 829:
                    originalScript = "game.global_flags[541] == 1 and game.global_vars[557] == 2 and game.global_vars[554] >= 1 and anyone( pc.group_list(), \"has_follower\", 8766 ) and (anyone( pc.group_list(), \"has_follower\", 8791 ) or anyone( pc.group_list(), \"has_follower\", 8792 ) or anyone( pc.group_list(), \"has_follower\", 8793 ) or anyone( pc.group_list(), \"has_follower\", 8794 ) or anyone( pc.group_list(), \"has_follower\", 8795 ) or anyone( pc.group_list(), \"has_follower\", 8796 ) or anyone( pc.group_list(), \"has_follower\", 8797 ) or anyone( pc.group_list(), \"has_follower\", 8798 ))";
                ...
                case 830:
                    ...
                    return GetGlobalFlag(541) && GetGlobalVar(557) == 2 && GetGlobalVar(554) >= 1 && pc.GetPartyMembers().Any(o => o.HasFollowerByName(8766)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8791)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8792)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8793)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8794)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8795)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8796)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8797)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8798));
                case 831:
                    originalScript = "game.global_flags[541] == 1 and game.global_vars[557] == 2 and game.global_vars[554] >= 1 and not anyone( pc.group_list(), \"has_follower\", 8766 ) and (anyone( pc.group_list(), \"has_follower\", 8791 ) or anyone( pc.group_list(), \"has_follower\", 8792 ) or anyone( pc.group_list(), \"has_follower\", 8793 ) or anyone( pc.group_list(), \"has_follower\", 8794 ) or anyone( pc.group_list(), \"has_follower\", 8795 ) or anyone( pc.group_list(), \"has_follower\", 8796 ) or anyone( pc.group_list(), \"has_follower\", 8797 ) or anyone( pc.group_list(), \"has_follower\", 8798 ))";
                    return GetGlobalFlag(541) && GetGlobalVar(557) == 2 && GetGlobalVar(554) >= 1 && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8766)) && (pc.GetPartyMembers().Any(o => o.HasFollowerByName(8791)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8792)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8793)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8794)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8795)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8796)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8797)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8798)));
                case 832:
                    originalScript = "game.global_flags[541] == 1 and game.global_vars[557] == 2 and game.global_vars[554] >= 1 and not anyone( pc.group_list(), \"has_follower\", 8766 ) and not anyone( pc.group_list(), \"has_follower\", 8791 ) and not anyone( pc.group_list(), \"has_follower\", 8792 ) and not anyone( pc.group_list(), \"has_follower\", 8793 ) and not anyone( pc.group_list(), \"has_follower\", 8794 ) and not anyone( pc.group_list(), \"has_follower\", 8795 ) and not anyone( pc.group_list(), \"has_follower\", 8796 ) and not anyone( pc.group_list(), \"has_follower\", 8797 ) and not anyone( pc.group_list(), \"has_follower\", 8798 )";
                    return GetGlobalFlag(541) && GetGlobalVar(557) == 2 && GetGlobalVar(554) >= 1 && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8766)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8791)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8792)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8793)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8794)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8795)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8796)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8797)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8798));
                case 833:
                    originalScript = "game.global_flags[541] == 1 and game.global_vars[557] == 2 and game.global_vars[554] == 0 and anyone( pc.group_list(), \"has_follower\", 8766 ) and (anyone( pc.group_list(), \"has_follower\", 8791 ) or anyone( pc.group_list(), \"has_follower\", 8792 ) or anyone( pc.group_list(), \"has_follower\", 8793 ) or anyone( pc.group_list(), \"has_follower\", 8794 ) or anyone( pc.group_list(), \"has_follower\", 8795 ) or anyone( pc.group_list(), \"has_follower\", 8796 ) or anyone( pc.group_list(), \"has_follower\", 8797 ) or anyone( pc.group_list(), \"has_follower\", 8798 ))";
                ...
                case 834:
                    ...
                    return GetGlobalFlag(541) && GetGlobalVar(557) == 2 && GetGlobalVar(554) == 0 && pc.GetPartyMembers().Any(o => o.HasFollowerByName(8766)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8791)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8792)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8793)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8794)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8795)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8796)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8797)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8798));
                case 835:
                    originalScript = "game.global_flags[541] == 1 and game.global_vars[557] == 2 and game.global_vars[554] == 0 and not anyone( pc.group_list(), \"has_follower\", 8766 ) and (anyone( pc.group_list(), \"has_follower\", 8791 ) or anyone( pc.group_list(), \"has_follower\", 8792 ) or anyone( pc.group_list(), \"has_follower\", 8793 ) or anyone( pc.group_list(), \"has_follower\", 8794 ) or anyone( pc.group_list(), \"has_follower\", 8795 ) or anyone( pc.group_list(), \"has_follower\", 8796 ) or anyone( pc.group_list(), \"has_follower\", 8797 ) or anyone( pc.group_list(), \"has_follower\", 8798 ))";
                    return GetGlobalFlag(541) && GetGlobalVar(557) == 2 && GetGlobalVar(554) == 0 && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8766)) && (pc.GetPartyMembers().Any(o => o.HasFollowerByName(8791)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8792)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8793)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8794)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8795)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8796)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8797)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8798)));
                case 836:
                    originalScript = "game.global_flags[541] == 1 and game.global_vars[557] == 2 and game.global_vars[554] == 0 and not anyone( pc.group_list(), \"has_follower\", 8766 ) and not anyone( pc.group_list(), \"has_follower\", 8791 ) and not anyone( pc.group_list(), \"has_follower\", 8792 ) and not anyone( pc.group_list(), \"has_follower\", 8793 ) and not anyone( pc.group_list(), \"has_follower\", 8794 ) and not anyone( pc.group_list(), \"has_follower\", 8795 ) and not anyone( pc.group_list(), \"has_follower\", 8796 ) and not anyone( pc.group_list(), \"has_follower\", 8797 ) and not anyone( pc.group_list(), \"has_follower\", 8798 )";
                    return GetGlobalFlag(541) && GetGlobalVar(557) == 2 && GetGlobalVar(554) == 0 && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8766)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8791)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8792)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8793)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8794)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8795)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8796)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8797)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8798));
                case 837:
                    originalScript = "game.global_flags[541] == 1 and game.global_vars[557] == 1 and game.global_vars[554] >= 1 and anyone( pc.group_list(), \"has_follower\", 8766 ) and (anyone( pc.group_list(), \"has_follower\", 8791 ) or anyone( pc.group_list(), \"has_follower\", 8792 ) or anyone( pc.group_list(), \"has_follower\", 8793 ) or anyone( pc.group_list(), \"has_follower\", 8794 ) or anyone( pc.group_list(), \"has_follower\", 8795 ) or anyone( pc.group_list(), \"has_follower\", 8796 ) or anyone( pc.group_list(), \"has_follower\", 8797 ) or anyone( pc.group_list(), \"has_follower\", 8798 ))";
                ...
                case 838:
                    ...
                    return GetGlobalFlag(541) && GetGlobalVar(557) == 1 && GetGlobalVar(554) >= 1 && pc.GetPartyMembers().Any(o => o.HasFollowerByName(8766)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8791)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8792)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8793)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8794)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8795)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8796)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8797)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8798));
                case 839:
                    originalScript = "game.global_flags[541] == 1 and game.global_vars[557] == 1 and game.global_vars[554] >= 1 and not anyone( pc.group_list(), \"has_follower\", 8766 ) and (anyone( pc.group_list(), \"has_follower\", 8791 ) or anyone( pc.group_list(), \"has_follower\", 8792 ) or anyone( pc.group_list(), \"has_follower\", 8793 ) or anyone( pc.group_list(), \"has_follower\", 8794 ) or anyone( pc.group_list(), \"has_follower\", 8795 ) or anyone( pc.group_list(), \"has_follower\", 8796 ) or anyone( pc.group_list(), \"has_follower\", 8797 ) or anyone( pc.group_list(), \"has_follower\", 8798 ))";
                    return GetGlobalFlag(541) && GetGlobalVar(557) == 1 && GetGlobalVar(554) >= 1 && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8766)) && (pc.GetPartyMembers().Any(o => o.HasFollowerByName(8791)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8792)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8793)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8794)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8795)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8796)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8797)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8798)));
                case 840:
                    originalScript = "game.global_flags[541] == 1 and game.global_vars[557] == 1 and game.global_vars[554] >= 1 and not anyone( pc.group_list(), \"has_follower\", 8766 ) and not anyone( pc.group_list(), \"has_follower\", 8791 ) and not anyone( pc.group_list(), \"has_follower\", 8792 ) and not anyone( pc.group_list(), \"has_follower\", 8793 ) and not anyone( pc.group_list(), \"has_follower\", 8794 ) and not anyone( pc.group_list(), \"has_follower\", 8795 ) and not anyone( pc.group_list(), \"has_follower\", 8796 ) and not anyone( pc.group_list(), \"has_follower\", 8797 ) and not anyone( pc.group_list(), \"has_follower\", 8798 )";
                    return GetGlobalFlag(541) && GetGlobalVar(557) == 1 && GetGlobalVar(554) >= 1 && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8766)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8791)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8792)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8793)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8794)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8795)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8796)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8797)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8798));
                case 841:
                    originalScript = "game.global_flags[541] == 0 and game.global_vars[557] == 2 and game.global_vars[554] >= 1 and anyone( pc.group_list(), \"has_follower\", 8766 ) and (anyone( pc.group_list(), \"has_follower\", 8791 ) or anyone( pc.group_list(), \"has_follower\", 8792 ) or anyone( pc.group_list(), \"has_follower\", 8793 ) or anyone( pc.group_list(), \"has_follower\", 8794 ) or anyone( pc.group_list(), \"has_follower\", 8795 ) or anyone( pc.group_list(), \"has_follower\", 8796 ) or anyone( pc.group_list(), \"has_follower\", 8797 ) or anyone( pc.group_list(), \"has_follower\", 8798 ))";
                    return !GetGlobalFlag(541) && GetGlobalVar(557) == 2 && GetGlobalVar(554) >= 1 && pc.GetPartyMembers().Any(o => o.HasFollowerByName(8766)) && (pc.GetPartyMembers().Any(o => o.HasFollowerByName(8791)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8792)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8793)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8794)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8795)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8796)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8797)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8798)));
                case 842:
                    originalScript = "game.global_flags[541] == 0 and game.global_vars[557] == 2 and game.global_vars[554] >= 1 and anyone( pc.group_list(), \"has_follower\", 8766 ) and not anyone( pc.group_list(), \"has_follower\", 8791 ) and not anyone( pc.group_list(), \"has_follower\", 8792 ) and not anyone( pc.group_list(), \"has_follower\", 8793 ) and not anyone( pc.group_list(), \"has_follower\", 8794 ) and not anyone( pc.group_list(), \"has_follower\", 8795 ) and not anyone( pc.group_list(), \"has_follower\", 8796 ) and not anyone( pc.group_list(), \"has_follower\", 8797 ) and not anyone( pc.group_list(), \"has_follower\", 8798 )";
                    return !GetGlobalFlag(541) && GetGlobalVar(557) == 2 && GetGlobalVar(554) >= 1 && pc.GetPartyMembers().Any(o => o.HasFollowerByName(8766)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8791)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8792)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8793)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8794)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8795)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8796)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8797)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8798));
                case 843:
                    originalScript = "game.global_flags[541] == 0 and game.global_vars[557] == 2 and game.global_vars[554] >= 1 and not anyone( pc.group_list(), \"has_follower\", 8766 ) and (anyone( pc.group_list(), \"has_follower\", 8791 ) or anyone( pc.group_list(), \"has_follower\", 8792 ) or anyone( pc.group_list(), \"has_follower\", 8793 ) or anyone( pc.group_list(), \"has_follower\", 8794 ) or anyone( pc.group_list(), \"has_follower\", 8795 ) or anyone( pc.group_list(), \"has_follower\", 8796 ) or anyone( pc.group_list(), \"has_follower\", 8797 ) or anyone( pc.group_list(), \"has_follower\", 8798 ))";
                    return !GetGlobalFlag(541) && GetGlobalVar(557) == 2 && GetGlobalVar(554) >= 1 && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8766)) && (pc.GetPartyMembers().Any(o => o.HasFollowerByName(8791)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8792)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8793)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8794)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8795)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8796)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8797)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8798)));
                case 844:
                    originalScript = "game.global_flags[541] == 0 and game.global_vars[557] == 2 and game.global_vars[554] >= 1 and not anyone( pc.group_list(), \"has_follower\", 8766 ) and not anyone( pc.group_list(), \"has_follower\", 8791 ) and not anyone( pc.group_list(), \"has_follower\", 8792 ) and not anyone( pc.group_list(), \"has_follower\", 8793 ) and not anyone( pc.group_list(), \"has_follower\", 8794 ) and not anyone( pc.group_list(), \"has_follower\", 8795 ) and not anyone( pc.group_list(), \"has_follower\", 8796 ) and not anyone( pc.group_list(), \"has_follower\", 8797 ) and not anyone( pc.group_list(), \"has_follower\", 8798 )";
                    return !GetGlobalFlag(541) && GetGlobalVar(557) == 2 && GetGlobalVar(554) >= 1 && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8766)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8791)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8792)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8793)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8794)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8795)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8796)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8797)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8798));
                case 845:
                    originalScript = "game.global_flags[542] == 1 and game.global_vars[556] == 2 and game.global_vars[553] >= 1 and anyone( pc.group_list(), \"has_follower\", 8767 ) and (anyone( pc.group_list(), \"has_follower\", 8791 ) or anyone( pc.group_list(), \"has_follower\", 8792 ) or anyone( pc.group_list(), \"has_follower\", 8793 ) or anyone( pc.group_list(), \"has_follower\", 8794 ) or anyone( pc.group_list(), \"has_follower\", 8795 ) or anyone( pc.group_list(), \"has_follower\", 8796 ) or anyone( pc.group_list(), \"has_follower\", 8797 ) or anyone( pc.group_list(), \"has_follower\", 8798 ))";
                ...
                case 846:
                    ...
                    return GetGlobalFlag(542) && GetGlobalVar(556) == 2 && GetGlobalVar(553) >= 1 && pc.GetPartyMembers().Any(o => o.HasFollowerByName(8767)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8791)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8792)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8793)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8794)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8795)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8796)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8797)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8798));
                case 847:
                    originalScript = "game.global_flags[542] == 1 and game.global_vars[556] == 2 and game.global_vars[553] >= 1 and not anyone( pc.group_list(), \"has_follower\", 8767 ) and (anyone( pc.group_list(), \"has_follower\", 8791 ) or anyone( pc.group_list(), \"has_follower\", 8792 ) or anyone( pc.group_list(), \"has_follower\", 8793 ) or anyone( pc.group_list(), \"has_follower\", 8794 ) or anyone( pc.group_list(), \"has_follower\", 8795 ) or anyone( pc.group_list(), \"has_follower\", 8796 ) or anyone( pc.group_list(), \"has_follower\", 8797 ) or anyone( pc.group_list(), \"has_follower\", 8798 ))";
                    return GetGlobalFlag(542) && GetGlobalVar(556) == 2 && GetGlobalVar(553) >= 1 && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8767)) && (pc.GetPartyMembers().Any(o => o.HasFollowerByName(8791)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8792)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8793)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8794)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8795)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8796)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8797)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8798)));
                case 848:
                    originalScript = "game.global_flags[542] == 1 and game.global_vars[556] == 2 and game.global_vars[553] >= 1 and not anyone( pc.group_list(), \"has_follower\", 8767 ) and not anyone( pc.group_list(), \"has_follower\", 8791 ) and not anyone( pc.group_list(), \"has_follower\", 8792 ) and not anyone( pc.group_list(), \"has_follower\", 8793 ) and not anyone( pc.group_list(), \"has_follower\", 8794 ) and not anyone( pc.group_list(), \"has_follower\", 8795 ) and not anyone( pc.group_list(), \"has_follower\", 8796 ) and not anyone( pc.group_list(), \"has_follower\", 8797 ) and not anyone( pc.group_list(), \"has_follower\", 8798 )";
                    return GetGlobalFlag(542) && GetGlobalVar(556) == 2 && GetGlobalVar(553) >= 1 && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8767)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8791)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8792)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8793)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8794)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8795)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8796)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8797)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8798));
                case 849:
                    originalScript = "game.global_flags[542] == 1 and game.global_vars[556] == 2 and game.global_vars[553] == 0 and anyone( pc.group_list(), \"has_follower\", 8767 ) and (anyone( pc.group_list(), \"has_follower\", 8791 ) or anyone( pc.group_list(), \"has_follower\", 8792 ) or anyone( pc.group_list(), \"has_follower\", 8793 ) or anyone( pc.group_list(), \"has_follower\", 8794 ) or anyone( pc.group_list(), \"has_follower\", 8795 ) or anyone( pc.group_list(), \"has_follower\", 8796 ) or anyone( pc.group_list(), \"has_follower\", 8797 ) or anyone( pc.group_list(), \"has_follower\", 8798 ))";
                ...
                case 850:
                    ...
                    return GetGlobalFlag(542) && GetGlobalVar(556) == 2 && GetGlobalVar(553) == 0 && pc.GetPartyMembers().Any(o => o.HasFollowerByName(8767)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8791)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8792)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8793)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8794)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8795)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8796)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8797)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8798));
                case 851:
                    originalScript = "game.global_flags[542] == 1 and game.global_vars[556] == 2 and game.global_vars[553] == 0 and not anyone( pc.group_list(), \"has_follower\", 8767 ) and (anyone( pc.group_list(), \"has_follower\", 8791 ) or anyone( pc.group_list(), \"has_follower\", 8792 ) or anyone( pc.group_list(), \"has_follower\", 8793 ) or anyone( pc.group_list(), \"has_follower\", 8794 ) or anyone( pc.group_list(), \"has_follower\", 8795 ) or anyone( pc.group_list(), \"has_follower\", 8796 ) or anyone( pc.group_list(), \"has_follower\", 8797 ) or anyone( pc.group_list(), \"has_follower\", 8798 ))";
                    return GetGlobalFlag(542) && GetGlobalVar(556) == 2 && GetGlobalVar(553) == 0 && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8767)) && (pc.GetPartyMembers().Any(o => o.HasFollowerByName(8791)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8792)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8793)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8794)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8795)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8796)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8797)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8798)));
                case 852:
                    originalScript = "game.global_flags[542] == 1 and game.global_vars[556] == 2 and game.global_vars[553] == 0 and not anyone( pc.group_list(), \"has_follower\", 8767 ) and not anyone( pc.group_list(), \"has_follower\", 8791 ) and not anyone( pc.group_list(), \"has_follower\", 8792 ) and not anyone( pc.group_list(), \"has_follower\", 8793 ) and not anyone( pc.group_list(), \"has_follower\", 8794 ) and not anyone( pc.group_list(), \"has_follower\", 8795 ) and not anyone( pc.group_list(), \"has_follower\", 8796 ) and not anyone( pc.group_list(), \"has_follower\", 8797 ) and not anyone( pc.group_list(), \"has_follower\", 8798 )";
                    return GetGlobalFlag(542) && GetGlobalVar(556) == 2 && GetGlobalVar(553) == 0 && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8767)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8791)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8792)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8793)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8794)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8795)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8796)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8797)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8798));
                case 853:
                    originalScript = "game.global_flags[542] == 1 and game.global_vars[556] == 1 and game.global_vars[553] >= 1 and anyone( pc.group_list(), \"has_follower\", 8767 ) and (anyone( pc.group_list(), \"has_follower\", 8791 ) or anyone( pc.group_list(), \"has_follower\", 8792 ) or anyone( pc.group_list(), \"has_follower\", 8793 ) or anyone( pc.group_list(), \"has_follower\", 8794 ) or anyone( pc.group_list(), \"has_follower\", 8795 ) or anyone( pc.group_list(), \"has_follower\", 8796 ) or anyone( pc.group_list(), \"has_follower\", 8797 ) or anyone( pc.group_list(), \"has_follower\", 8798 ))";
                ...
                case 854:
                    ...
                    return GetGlobalFlag(542) && GetGlobalVar(556) == 1 && GetGlobalVar(553) >= 1 && pc.GetPartyMembers().Any(o => o.HasFollowerByName(8767)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8791)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8792)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8793)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8794)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8795)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8796)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8797)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8798));
                case 855:
                    originalScript = "game.global_flags[542] == 1 and game.global_vars[556] == 1 and game.global_vars[553] >= 1 and not anyone( pc.group_list(), \"has_follower\", 8767 ) and (anyone( pc.group_list(), \"has_follower\", 8791 ) or anyone( pc.group_list(), \"has_follower\", 8792 ) or anyone( pc.group_list(), \"has_follower\", 8793 ) or anyone( pc.group_list(), \"has_follower\", 8794 ) or anyone( pc.group_list(), \"has_follower\", 8795 ) or anyone( pc.group_list(), \"has_follower\", 8796 ) or anyone( pc.group_list(), \"has_follower\", 8797 ) or anyone( pc.group_list(), \"has_follower\", 8798 ))";
                    return GetGlobalFlag(542) && GetGlobalVar(556) == 1 && GetGlobalVar(553) >= 1 && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8767)) && (pc.GetPartyMembers().Any(o => o.HasFollowerByName(8791)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8792)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8793)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8794)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8795)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8796)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8797)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8798)));
                case 856:
                    originalScript = "game.global_flags[542] == 1 and game.global_vars[556] == 1 and game.global_vars[553] >= 1 and not anyone( pc.group_list(), \"has_follower\", 8767 ) and not anyone( pc.group_list(), \"has_follower\", 8791 ) and not anyone( pc.group_list(), \"has_follower\", 8792 ) and not anyone( pc.group_list(), \"has_follower\", 8793 ) and not anyone( pc.group_list(), \"has_follower\", 8794 ) and not anyone( pc.group_list(), \"has_follower\", 8795 ) and not anyone( pc.group_list(), \"has_follower\", 8796 ) and not anyone( pc.group_list(), \"has_follower\", 8797 ) and not anyone( pc.group_list(), \"has_follower\", 8798 )";
                    return GetGlobalFlag(542) && GetGlobalVar(556) == 1 && GetGlobalVar(553) >= 1 && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8767)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8791)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8792)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8793)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8794)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8795)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8796)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8797)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8798));
                case 857:
                    originalScript = "game.global_flags[542] == 0 and game.global_vars[556] == 2 and game.global_vars[553] >= 1 and anyone( pc.group_list(), \"has_follower\", 8767 ) and (anyone( pc.group_list(), \"has_follower\", 8791 ) or anyone( pc.group_list(), \"has_follower\", 8792 ) or anyone( pc.group_list(), \"has_follower\", 8793 ) or anyone( pc.group_list(), \"has_follower\", 8794 ) or anyone( pc.group_list(), \"has_follower\", 8795 ) or anyone( pc.group_list(), \"has_follower\", 8796 ) or anyone( pc.group_list(), \"has_follower\", 8797 ) or anyone( pc.group_list(), \"has_follower\", 8798 ))";
                    return !GetGlobalFlag(542) && GetGlobalVar(556) == 2 && GetGlobalVar(553) >= 1 && pc.GetPartyMembers().Any(o => o.HasFollowerByName(8767)) && (pc.GetPartyMembers().Any(o => o.HasFollowerByName(8791)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8792)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8793)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8794)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8795)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8796)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8797)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8798)));
                case 858:
                    originalScript = "game.global_flags[542] == 0 and game.global_vars[556] == 2 and game.global_vars[553] >= 1 and anyone( pc.group_list(), \"has_follower\", 8767 ) and not anyone( pc.group_list(), \"has_follower\", 8791 ) and not anyone( pc.group_list(), \"has_follower\", 8792 ) and not anyone( pc.group_list(), \"has_follower\", 8793 ) and not anyone( pc.group_list(), \"has_follower\", 8794 ) and not anyone( pc.group_list(), \"has_follower\", 8795 ) and not anyone( pc.group_list(), \"has_follower\", 8796 ) and not anyone( pc.group_list(), \"has_follower\", 8797 ) and not anyone( pc.group_list(), \"has_follower\", 8798 )";
                    return !GetGlobalFlag(542) && GetGlobalVar(556) == 2 && GetGlobalVar(553) >= 1 && pc.GetPartyMembers().Any(o => o.HasFollowerByName(8767)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8791)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8792)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8793)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8794)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8795)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8796)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8797)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8798));
                case 859:
                    originalScript = "game.global_flags[542] == 0 and game.global_vars[556] == 2 and game.global_vars[553] >= 1 and not anyone( pc.group_list(), \"has_follower\", 8767 ) and (anyone( pc.group_list(), \"has_follower\", 8791 ) or anyone( pc.group_list(), \"has_follower\", 8792 ) or anyone( pc.group_list(), \"has_follower\", 8793 ) or anyone( pc.group_list(), \"has_follower\", 8794 ) or anyone( pc.group_list(), \"has_follower\", 8795 ) or anyone( pc.group_list(), \"has_follower\", 8796 ) or anyone( pc.group_list(), \"has_follower\", 8797 ) or anyone( pc.group_list(), \"has_follower\", 8798 ))";
                    return !GetGlobalFlag(542) && GetGlobalVar(556) == 2 && GetGlobalVar(553) >= 1 && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8767)) && (pc.GetPartyMembers().Any(o => o.HasFollowerByName(8791)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8792)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8793)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8794)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8795)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8796)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8797)) || pc.GetPartyMembers().Any(o => o.HasFollowerByName(8798)));
                case 860:
                    originalScript = "game.global_flags[542] == 0 and game.global_vars[556] == 2 and game.global_vars[553] >= 1 and not anyone( pc.group_list(), \"has_follower\", 8767 ) and not anyone( pc.group_list(), \"has_follower\", 8791 ) and not anyone( pc.group_list(), \"has_follower\", 8792 ) and not anyone( pc.group_list(), \"has_follower\", 8793 ) and not anyone( pc.group_list(), \"has_follower\", 8794 ) and not anyone( pc.group_list(), \"has_follower\", 8795 ) and not anyone( pc.group_list(), \"has_follower\", 8796 ) and not anyone( pc.group_list(), \"has_follower\", 8797 ) and not anyone( pc.group_list(), \"has_follower\", 8798 )";
                    return !GetGlobalFlag(542) && GetGlobalVar(556) == 2 && GetGlobalVar(553) >= 1 && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8767)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8791)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8792)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8793)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8794)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8795)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8796)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8797)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8798));
                case 911:
                    originalScript = "pc.stat_level_get(stat_level_barbarian) >= 1";
                ...
                case 915:
                    originalScript = "pc.stat_level_get(stat_level_fighter) >= 1";
                    return pc.GetStat(Stat.level_fighter) >= 1;
                case 916:
                    originalScript = "pc.stat_level_get(stat_level_monk) >= 1";
                ...
                case 918:
                    originalScript = "pc.stat_level_get(stat_level_ranger) >= 1";
                ...
                case 1241:
                case 1261:
                    originalScript = "game.global_vars[550] == 2";
                ...
                case 1242:
                case 1262:
                    originalScript = "game.global_vars[550] == 0";
                    return GetGlobalVar(550) == 0;
                case 1141:
                case 1251:
                    originalScript = "game.global_flags[539] == 0";
                    return !GetGlobalFlag(539);
                case 1142:
                case 1252:
                    originalScript = "game.global_flags[539] == 1";
                    return GetGlobalFlag(539);
                case 1151:
                case 1271:
                    originalScript = "game.global_flags[540] == 0";
                    return !GetGlobalFlag(540);
                case 1152:
                case 1272:
                    originalScript = "game.global_flags[540] == 1";
                    return GetGlobalFlag(540);
                case 1191:
                    originalScript = "game.global_flags[809] == 0";
                    return !GetGlobalFlag(809);
                case 1192:
                    originalScript = "game.global_flags[809] == 1";
                    return GetGlobalFlag(809);
                default:
                    originalScript = null;
                    return true;
        ...
        public void ApplySideEffect(GameObjectBody npc, GameObjectBody pc, int lineNumber, out string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 114:
                case 424:
                    originalScript = "game.global_vars[979] = 1";
                    SetGlobalVar(979, 1);
                    break;
                case 76:
                case 122:
                ...
                case 77:
                case 123:
                    originalScript = "game.global_vars[535] = 1; game.quests[110].state = qs_completed";
                    SetGlobalVar(535, 1);
                ...
                case 170:
                case 180:
                    originalScript = "game.global_vars[948] = 1";
                    SetGlobalVar(948, 1);
                    break;
                case 171:
                case 181:
                ...
                case 250:
                    ...
                    break;
                case 270:
                    originalScript = "game.global_vars[948] = 2; record_time_stamp('abiram_off_to_arrest')";
                    SetGlobalVar(948, 2);
                ...
                case 470:
                    ...
                    break;
                case 580:
                    originalScript = "game.quests[109].state = qs_mentioned";
                    SetQuestState(109, QuestState.Mentioned);
                    break;
                case 671:
                    originalScript = "game.quests[109].state = qs_accepted; game.global_vars[535] = 3";
                    SetQuestState(109, QuestState.Accepted);
                    SetGlobalVar(535, 3);
                    ;
                    break;
                case 690:
                    originalScript = "npc.item_transfer_to(pc,4408); game.global_flags[532] = 1";
                ...
                case 1139:
                    ...
                    break;
                case 891:
                    originalScript = "pc.money_adj(110000); game.quests[109].state = qs_completed; rep_routine(npc,pc)";
                    ...
                    break;
                case 1100:
                    originalScript = "remove_rakham(npc,pc); remove_panathaes(npc,pc)";
                    remove_rakham(npc, pc);
                    remove_panathaes(npc, pc);
                    ;
                    break;
                case 1110:
                    originalScript = "remove_boroquin(npc,pc); remove_panathaes(npc,pc)";
                ...
                case 1150:
                case 1200:
                    originalScript = "remove_panathaes(npc,pc)";
                    remove_panathaes(npc, pc);
                    break;
                case 1141:
                case 1251:
                    originalScript = "game.global_vars[549] = 3";
                    SetGlobalVar(549, 3);
                    break;
                case 1040:
                ...
                case 1151:
                case 1271:
                    originalScript = "game.global_vars[549] = 1";
                    SetGlobalVar(549, 1);
                    break;
                case 1221:
                    originalScript = "game.party[0].reputation_add( 67 )";
                    PartyLeader.AddReputation(67);
                    break;
                case 1240:
                    originalScript = "remove_rakham(npc,pc)";
                    remove_rakham(npc, pc);
                    break;
                case 1260:
                    originalScript = "remove_boroquin(npc,pc)";
                    remove_boroquin(npc, pc);
                    break;
                default:
                    originalScript = null;
