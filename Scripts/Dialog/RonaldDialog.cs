    ...
    public class RonaldDialog : Ronald, IDialogScript
    {
        public bool CheckPrecondition(GameObjectBody npc, GameObjectBody pc, int lineNumber, string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 13:
                    Trace.Assert(originalScript == "(pc.follower_atmax() == 0) and game.global_vars[693] == 0 and not anyone( pc.group_list(), \"has_follower\", 8002 )");
                    return (!pc.HasMaxFollowers()) && GetGlobalVar(693) == 0 && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8002));
                case 14:
                    Trace.Assert(originalScript == "(pc.follower_atmax() == 0) and anyone( pc.group_list(), \"has_follower\", 8002 )");
                    return (!pc.HasMaxFollowers()) && pc.GetPartyMembers().Any(o => o.HasFollowerByName(8002));
                case 15:
                    Trace.Assert(originalScript == "(pc.follower_atmax() == 0) and game.global_vars[693] == 3 and not anyone( pc.group_list(), \"has_follower\", 8002 )");
                    return (!pc.HasMaxFollowers()) && GetGlobalVar(693) == 3 && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8002));
                case 16:
                    Trace.Assert(originalScript == "(pc.follower_atmax() == 0) and game.global_vars[693] == 2 and not anyone( pc.group_list(), \"has_follower\", 8002 )");
                    return (!pc.HasMaxFollowers()) && GetGlobalVar(693) == 2 && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8002));
                case 17:
                    Trace.Assert(originalScript == "(pc.follower_atmax() == 0) and game.global_vars[693] == 1 and not anyone( pc.group_list(), \"has_follower\", 8002 )");
                ...
                case 55:
                    Trace.Assert(originalScript == "pc.stat_level_get(stat_race) == race_halforc and pc.stat_level_get( stat_deity ) == 16");
                ...
                case 62:
                    ...
                    return pc.GetMoney() < 10000;
                case 101:
                    Trace.Assert(originalScript == "pc.money_get() >= 10000 and game.global_vars[692] == 5");
                    return pc.GetMoney() >= 10000 && GetGlobalVar(692) == 5;
                case 106:
                    Trace.Assert(originalScript == "pc.money_get() >= 5000 and game.global_vars[692] == 6");
                    return pc.GetMoney() >= 5000 && GetGlobalVar(692) == 6;
                case 124:
                    Trace.Assert(originalScript == "game.global_vars[692] == 4");
                    return GetGlobalVar(692) == 4;
                case 171:
                    Trace.Assert(originalScript == "game.global_vars[692] == 1 or game.global_vars[692] == 2");
                    return GetGlobalVar(692) == 1 || GetGlobalVar(692) == 2;
                case 172:
                    Trace.Assert(originalScript == "game.global_vars[692] != 1 and game.global_vars[692] != 2");
                    return GetGlobalVar(692) != 1 && GetGlobalVar(692) != 2;
                case 211:
                case 212:
                case 364:
                ...
                case 261:
                case 262:
                    Trace.Assert(originalScript == "(pc.follower_atmax() == 0) and game.global_vars[693] == 4");
                ...
                case 943:
                case 944:
                    Trace.Assert(originalScript == "game.global_flags[833] == 1");
                    return GetGlobalFlag(833);
                case 269:
                    Trace.Assert(originalScript == "game.global_vars[693] == 4");
                    return GetGlobalVar(693) == 4;
                case 281:
                    Trace.Assert(originalScript == "game.global_vars[693] == 3");
                    return GetGlobalVar(693) == 3;
                case 282:
                    Trace.Assert(originalScript == "game.global_vars[693] == 1");
                    return GetGlobalVar(693) == 1;
                case 283:
                    Trace.Assert(originalScript == "game.global_vars[693] == 2");
                    return GetGlobalVar(693) == 2;
                case 284:
                    Trace.Assert(originalScript == "game.global_vars[693] == 0");
                    return GetGlobalVar(693) == 0;
                case 301:
                    Trace.Assert(originalScript == "game.global_vars[693] == 3 and (pc.follower_atmax() == 0)");
                    return GetGlobalVar(693) == 3 && (!pc.HasMaxFollowers());
                case 302:
                    Trace.Assert(originalScript == "game.global_vars[693] == 1 and (pc.follower_atmax() == 0)");
                    return GetGlobalVar(693) == 1 && (!pc.HasMaxFollowers());
                case 303:
                    Trace.Assert(originalScript == "game.global_vars[693] == 2 and (pc.follower_atmax() == 0)");
                    return GetGlobalVar(693) == 2 && (!pc.HasMaxFollowers());
                case 304:
                    Trace.Assert(originalScript == "game.global_vars[693] == 0 and (pc.follower_atmax() == 0)");
                ...
                case 392:
                    Trace.Assert(originalScript == "game.global_flags[21] != 1");
                ...
                case 501:
                    Trace.Assert(originalScript == "(npc.item_find(6070) != OBJ_HANDLE_NULL) and (npc.item_find(6056) != OBJ_HANDLE_NULL)");
                    return (npc.FindItemByName(6070) != null) && (npc.FindItemByName(6056) != null);
                case 502:
                    Trace.Assert(originalScript == "npc.item_find(6064) != OBJ_HANDLE_NULL");
                    return npc.FindItemByName(6064) != null;
                case 505:
                    Trace.Assert(originalScript == "(npc.item_find(6056) == OBJ_HANDLE_NULL) and (npc.item_find(6070) != OBJ_HANDLE_NULL)");
                    return (npc.FindItemByName(6056) == null) && (npc.FindItemByName(6070) != null);
                case 512:
                case 514:
                    Trace.Assert(originalScript == "npc.stat_level_get(stat_level_cleric) < 2");
                ...
                case 515:
                    ...
                    return npc.GetStat(Stat.level_cleric) >= 2;
                case 531:
                    Trace.Assert(originalScript == "pc.money_get() >= 6000 and pc.skill_level_get(npc, skill_appraise) >= 10");
                    throw new NotSupportedException("Conversion failed.");
                case 532:
                    Trace.Assert(originalScript == "pc.money_get() >= 1500 and (npc.item_find(6056) != OBJ_HANDLE_NULL)");
                    return pc.GetMoney() >= 1500 && (npc.FindItemByName(6056) != null);
                case 533:
                    Trace.Assert(originalScript == "pc.money_get() >= 8000");
                    return pc.GetMoney() >= 8000;
                case 561:
                    Trace.Assert(originalScript == "pc.money_get() >= 6500");
                    return pc.GetMoney() >= 6500;
                case 562:
                    Trace.Assert(originalScript == "pc.money_get() >= 4500 and pc.skill_level_get(npc, skill_appraise) >= 10");
                    throw new NotSupportedException("Conversion failed.");
                case 711:
                case 714:
                ...
                case 2006:
                case 2061:
                    Trace.Assert(originalScript == "npc.map == 5012 or npc.map == 5013");
                    return npc.GetMap() == 5012 || npc.GetMap() == 5013;
                case 2007:
                    Trace.Assert(originalScript == "npc.map != 5012 and npc.map != 5013");
                    return npc.GetMap() != 5012 && npc.GetMap() != 5013;
                case 2042:
                    Trace.Assert(originalScript == "game.global_vars[692] == 2 or game.global_vars[692] == 3");
                    return GetGlobalVar(692) == 2 || GetGlobalVar(692) == 3;
                case 2043:
                    Trace.Assert(originalScript == "game.global_vars[692] != 2 and game.global_vars[692] != 3");
                    return GetGlobalVar(692) != 2 && GetGlobalVar(692) != 3;
                case 2064:
                    Trace.Assert(originalScript == "npc.map == 5011");
        ...
        public void ApplySideEffect(GameObjectBody npc, GameObjectBody pc, int lineNumber, string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 915:
                    ...
                    break;
                case 31:
                    Trace.Assert(originalScript == "game.global_vars[692] = 4; argue_lareth(npc,pc,630)");
                    SetGlobalVar(692, 4);
                    argue_lareth(npc, pc, 630);
                    ;
                    break;
                case 35:
                    Trace.Assert(originalScript == "game.global_vars[692] = 1");
                    SetGlobalVar(692, 1);
                    break;
                case 40:
                    Trace.Assert(originalScript == "game.global_vars[692] = 2");
                    SetGlobalVar(692, 2);
                    break;
                case 56:
                case 65:
                    Trace.Assert(originalScript == "game.global_vars[692] = 3");
                    SetGlobalVar(692, 3);
                    break;
                case 70:
                    Trace.Assert(originalScript == "pc.money_adj(-10000); pc.follower_add( npc )");
                ...
                case 75:
                case 337:
                    Trace.Assert(originalScript == "game.global_vars[692] = 5");
                    SetGlobalVar(692, 5);
                    break;
                case 101:
                case 325:
                ...
                case 341:
                    ...
                    break;
                case 190:
                    Trace.Assert(originalScript == "pc.follower_remove( npc ); game.global_vars[692] = 3");
                    pc.RemoveFollower(npc);
                    SetGlobalVar(692, 3);
                    ;
                    break;
                case 195:
                    Trace.Assert(originalScript == "pc.follower_remove( npc ); game.global_vars[692] = 0");
                    pc.RemoveFollower(npc);
                    SetGlobalVar(692, 0);
                    ;
                    break;
                case 271:
                case 272:
                    Trace.Assert(originalScript == "game.global_vars[692] = 4; argue_lareth(npc,pc,200)");
                    SetGlobalVar(692, 4);
                    argue_lareth(npc, pc, 200);
                    ;
                    break;
                case 300:
                    Trace.Assert(originalScript == "game.global_vars[692] == 0");
                    SetGlobalVar(692, 0);
                    break;
                case 316:
                case 551:
                    ...
                    break;
                case 342:
                    Trace.Assert(originalScript == "game.global_vars[692] = 6");
                    SetGlobalVar(692, 6);
                    break;
                case 355:
                case 360:
                ...
                case 371:
                case 372:
                    Trace.Assert(originalScript == "game.global_vars[692] = 4; argue_lareth(npc,pc,360)");
                    SetGlobalVar(692, 4);
                ...
                case 380:
                case 1015:
                    Trace.Assert(originalScript == "pc.follower_remove( npc ); game.global_vars[692] = 1");
                    pc.RemoveFollower(npc);
                    SetGlobalVar(692, 1);
                    ;
                    break;
                case 381:
                    Trace.Assert(originalScript == "run_off( npc, pc ); argue_lareth(npc,pc,180)");
                    run_off(npc, pc);
                    argue_lareth(npc, pc, 180);
                    ;
                    break;
                case 520:
                    Trace.Assert(originalScript == "pc.follower_remove( npc ); pc.follower_add( npc )");
                    pc.RemoveFollower(npc);
                    pc.AddFollower(npc);
                    ;
                    break;
                case 532:
                    Trace.Assert(originalScript == "pc.money_adj(-1500); equip_leather(npc,pc)");
                    pc.AdjustMoney(-1500);
                    equip_leather(npc, pc);
                    ;
                    break;
                case 533:
                    Trace.Assert(originalScript == "pc.money_adj(-8000); equip_all(npc,pc)");
                    pc.AdjustMoney(-8000);
                    equip_all(npc, pc);
                    ;
                    break;
                case 537:
                    Trace.Assert(originalScript == "pc.money_adj(-6000); equip_all(npc,pc)");
                    pc.AdjustMoney(-6000);
                    equip_all(npc, pc);
                    ;
                    break;
                case 550:
                    Trace.Assert(originalScript == "game.global_vars[692] = 1; pc.follower_remove( npc )");
                    SetGlobalVar(692, 1);
                    pc.RemoveFollower(npc);
                    ;
                    break;
                case 561:
                    Trace.Assert(originalScript == "pc.money_adj(-6500); equip_rest(npc,pc)");
                    pc.AdjustMoney(-6500);
                    equip_rest(npc, pc);
                    ;
                    break;
                case 562:
                    Trace.Assert(originalScript == "pc.money_adj(-4500); equip_rest(npc,pc)");
                    pc.AdjustMoney(-4500);
                    equip_rest(npc, pc);
                    ;
                    break;
                case 611:
                case 612:
                    Trace.Assert(originalScript == "war(npc,pc)");
                    war(npc, pc);
                    break;
                case 621:
                case 622:
                    ...
                    break;
                case 751:
                    Trace.Assert(originalScript == "argue_tuelk(npc,pc,310)");
                    argue_tuelk(npc, pc, 310);
                    break;
                case 752:
                    Trace.Assert(originalScript == "argue_tuelk(npc,pc,300)");
                ...
                case 827:
                case 828:
                    Trace.Assert(originalScript == "argue_tuelk(npc,pc,40)");
                    argue_tuelk(npc, pc, 40);
                    break;
                case 855:
                    Trace.Assert(originalScript == "game.global_vars[692] = 7");
                    SetGlobalVar(692, 7);
                    break;
                case 866:
                    Trace.Assert(originalScript == "pc.follower_remove( npc ); run_off(npc,pc); argue_tuelk(npc,pc,160)");
                    pc.RemoveFollower(npc);
                    run_off(npc, pc);
                ...
                case 2051:
                case 2053:
                    Trace.Assert(originalScript == "game.global_vars[692] = 9");
                    SetGlobalVar(692, 9);
                    break;
                case 2054:
                    Trace.Assert(originalScript == "npc.attack(pc)");
                    ...
                    break;
                case 2055:
                    Trace.Assert(originalScript == "game.global_vars[692] = 8; pc.follower_remove( npc )");
                    SetGlobalVar(692, 8);
                    pc.RemoveFollower(npc);
                    ;
                    break;
