    ...
    public class ReclusiveFarmerDialog : ReclusiveFarmer, IDialogScript
    {
        public bool CheckPrecondition(GameObjectBody npc, GameObjectBody pc, int lineNumber, string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 4:
                case 5:
                    Trace.Assert(originalScript == "game.global_flags[26] == 1 and npc.has_met( pc ) and game.quests[12].state == qs_unknown");
                ...
                case 8:
                case 9:
                    Trace.Assert(originalScript == "game.quests[12].state == qs_mentioned and pc.stat_level_get( stat_gender ) == gender_male");
                    return GetQuestState(12) == QuestState.Mentioned && pc.GetGender() == Gender.Male;
                case 10:
                case 11:
                    Trace.Assert(originalScript == "game.quests[12].state == qs_completed");
                    return GetQuestState(12) == QuestState.Completed;
                case 12:
                case 13:
                    Trace.Assert(originalScript == "game.quests[12].state == qs_accepted and game.global_flags[42] == 0");
                    return GetQuestState(12) == QuestState.Accepted && !GetGlobalFlag(42);
                case 14:
                case 15:
                    Trace.Assert(originalScript == "game.quests[12].state == qs_accepted and game.global_flags[42] == 1 and game.global_flags[26] == 0");
                    return GetQuestState(12) == QuestState.Accepted && GetGlobalFlag(42) && !GetGlobalFlag(26);
                case 16:
                case 17:
                    Trace.Assert(originalScript == "game.quests[12].state == qs_accepted and game.global_flags[42] == 1 and game.global_flags[26] == 1");
                    return GetQuestState(12) == QuestState.Accepted && GetGlobalFlag(42) && GetGlobalFlag(26);
                case 21:
                case 22:
                    Trace.Assert(originalScript == "game.global_flags[26] == 1 and game.quests[12].state == qs_unknown");
                    return GetGlobalFlag(26) && GetQuestState(12) == QuestState.Unknown;
                case 53:
                case 54:
                    Trace.Assert(originalScript == "pc.skill_level_get(npc,skill_gather_information) >= 2 and game.quests[12].state == qs_unknown");
        ...
        public void ApplySideEffect(GameObjectBody npc, GameObjectBody pc, int lineNumber, string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 63:
                case 64:
                    Trace.Assert(originalScript == "game.quests[12].state = qs_accepted");
                    SetQuestState(12, QuestState.Accepted);
                    break;
                case 60:
                case 135:
                    Trace.Assert(originalScript == "game.quests[12].state = qs_mentioned");
                ...
                case 80:
                    ...
                    break;
                case 115:
                    Trace.Assert(originalScript == "game.global_flags[43] = 1");
                ...
                case 172:
                case 173:
                    Trace.Assert(originalScript == "game.global_flags[43] = 1; game.quests[12].state = qs_accepted");
                    SetGlobalFlag(43, true);
                    SetQuestState(12, QuestState.Accepted);
                    ;
                    break;
