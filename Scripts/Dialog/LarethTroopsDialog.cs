...
{
    [DialogScript(450)]
    public class LarethTroopsDialog : LarethTroops, IDialogScript
    {
        ...
        public void ApplySideEffect(GameObjectBody npc, GameObjectBody pc, int lineNumber, string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 41:
                case 401:
                    Trace.Assert(originalScript == "game.global_flags[363] = 1; run_off_to_back(npc, pc, 0)");
                    SetGlobalFlag(363, true);
                    run_off_to_back(npc, pc);
                    break;
                case 50:
