...
namespace Scripts.Dialog
{
    ...
    public class AssassinLeaderDialog : AssassinLeader, IDialogScript
    {
        public bool CheckPrecondition(GameObjectBody npc, GameObjectBody pc, int lineNumber, string originalScript)
        {
            ...
            {
                case 2:
                    Trace.Assert(originalScript == "not npc.has_met( pc ) and pc.stat_level_get( stat_gender ) == gender_male");
                    return !npc.HasMet(pc) && pc.GetGender() == Gender.Male;
                case 3:
                    Trace.Assert(originalScript == "npc.has_met( pc ) and pc.stat_level_get( stat_gender ) == gender_male");
                    return npc.HasMet(pc) && pc.GetGender() == Gender.Male;
                case 4:
                    Trace.Assert(originalScript == "not npc.has_met( pc ) and pc.stat_level_get( stat_gender ) == gender_female");
                    return !npc.HasMet(pc) && pc.GetGender() == Gender.Female;
                case 5:
                    Trace.Assert(originalScript == "npc.has_met( pc ) and pc.stat_level_get( stat_gender ) == gender_female");
                    return npc.HasMet(pc) && pc.GetGender() == Gender.Female;
                case 21:
                case 121:
                    Trace.Assert(originalScript == "game.global_vars[704] == 1 and game.quests[77].state == qs_accepted");
                    return GetGlobalVar(704) == 1 && GetQuestState(77) == QuestState.Accepted;
                case 22:
                case 122:
                    Trace.Assert(originalScript == "game.global_flags[992] == 1 and game.global_flags[935] == 0 and game.quests[77].state == qs_accepted");
                    return GetGlobalFlag(992) && !GetGlobalFlag(935) && GetQuestState(77) == QuestState.Accepted;
                case 23:
                case 123:
                    Trace.Assert(originalScript == "game.quests[76].state == qs_accepted");
                ...
                case 25:
                case 125:
                    Trace.Assert(originalScript == "game.global_flags[965] == 1 and game.quests[66].state == qs_accepted");
                    return GetGlobalFlag(965) && GetQuestState(66) == QuestState.Accepted;
                case 26:
                case 126:
                    Trace.Assert(originalScript == "game.global_flags[964] == 1 and game.global_flags[963] == 0 and game.quests[67].state == qs_accepted");
                    return GetGlobalFlag(964) && !GetGlobalFlag(963) && GetQuestState(67) == QuestState.Accepted;
                case 27:
                case 127:
                    Trace.Assert(originalScript == "game.global_flags[964] == 1 and game.global_flags[963] == 1 and game.quests[67].state == qs_accepted and game.party[0].reputation_has(35)");
                ...
                case 31:
                case 131:
                    Trace.Assert(originalScript == "game.global_vars[978] == 1 and game.global_vars[965] == 0 and (pc.skill_level_get(npc,skill_spot) >= 11 or party_spot_check() >= 11)");
                    throw new NotSupportedException("Conversion failed.");
                case 32:
                case 132:
                    Trace.Assert(originalScript == "game.global_vars[978] == 3 and game.global_vars[965] == 1");
                    return GetGlobalVar(978) == 3 && GetGlobalVar(965) == 1;
                case 33:
                case 133:
                    Trace.Assert(originalScript == "game.global_vars[978] == 4 and game.global_vars[965] == 1");
                    return GetGlobalVar(978) == 4 && GetGlobalVar(965) == 1;
                case 34:
                case 134:
                    Trace.Assert(originalScript == "game.global_vars[978] == 5 and game.global_vars[965] == 1");
                    return GetGlobalVar(978) == 5 && GetGlobalVar(965) == 1;
                case 35:
                case 135:
                    Trace.Assert(originalScript == "game.global_vars[958] == 8");
                    return GetGlobalVar(958) == 8;
                case 36:
                case 136:
                    Trace.Assert(originalScript == "game.global_vars[959] == 4");
                    return GetGlobalVar(959) == 4;
                case 37:
                case 137:
                    Trace.Assert(originalScript == "game.global_vars[704] == 2 and game.quests[77].state == qs_accepted and is_daytime()");
                    return GetGlobalVar(704) == 2 && GetQuestState(77) == QuestState.Accepted && Utilities.is_daytime();
                case 38:
                case 138:
                    Trace.Assert(originalScript == "game.global_flags[964] == 1 and game.global_flags[963] == 1 and game.quests[67].state == qs_accepted and not game.party[0].reputation_has(35)");
                    return GetGlobalFlag(964) && GetGlobalFlag(963) && GetQuestState(67) == QuestState.Accepted && !PartyLeader.HasReputation(35);
                case 39:
                case 139:
                    Trace.Assert(originalScript == "game.global_vars[704] == 20");
                    return GetGlobalVar(704) == 20;
                case 40:
                case 140:
                    Trace.Assert(originalScript == "game.global_flags[992] == 0 and game.global_flags[935] == 0 and game.quests[77].state == qs_accepted and game.global_vars[704] == 9");
                    return !GetGlobalFlag(992) && !GetGlobalFlag(935) && GetQuestState(77) == QuestState.Accepted && GetGlobalVar(704) == 9;
                case 41:
                case 141:
                    Trace.Assert(originalScript == "game.global_flags[960] == 1 and game.quests[78].state == qs_accepted");
                    return GetGlobalFlag(960) && GetQuestState(78) == QuestState.Accepted;
                case 46:
                case 146:
                    Trace.Assert(originalScript == "pc.skill_level_get(npc,skill_bluff) >= 10 and pc.reputation_has( 24 ) == 0");
                    return pc.GetSkillLevel(npc, SkillId.bluff) >= 10 && !pc.HasReputation(24);
                case 47:
                case 147:
                    Trace.Assert(originalScript == "pc.skill_level_get(npc,skill_bluff) <= 9 and pc.reputation_has( 24 ) == 0");
                    return pc.GetSkillLevel(npc, SkillId.bluff) <= 9 && !pc.HasReputation(24);
                case 48:
                case 148:
                    Trace.Assert(originalScript == "pc.reputation_has( 24 ) == 1");
                    return pc.HasReputation(24);
                case 71:
                case 171:
                    Trace.Assert(originalScript == "pc.skill_level_get(npc,skill_bluff) <= 9 and pc.reputation_has( 24 ) == 0 and pc.reputation_has( 21 ) == 0");
                    return pc.GetSkillLevel(npc, SkillId.bluff) <= 9 && !pc.HasReputation(24) && !pc.HasReputation(21);
                case 72:
                case 172:
                    Trace.Assert(originalScript == "pc.skill_level_get(npc,skill_bluff) >= 10 and pc.reputation_has( 24 ) == 0 and pc.reputation_has( 21 ) == 0");
                    return pc.GetSkillLevel(npc, SkillId.bluff) >= 10 && !pc.HasReputation(24) && !pc.HasReputation(21);
                case 73:
                case 173:
                    Trace.Assert(originalScript == "pc.reputation_has( 24 ) == 1 and pc.reputation_has( 21 ) == 0");
                    return pc.HasReputation(24) && !pc.HasReputation(21);
                case 74:
                case 174:
                    Trace.Assert(originalScript == "pc.reputation_has( 24 ) == 1 and pc.reputation_has( 21 ) == 1");
                    return pc.HasReputation(24) && pc.HasReputation(21);
                case 261:
                    Trace.Assert(originalScript == "(anyone( pc.group_list(), \"item_find\", 12036 ))");
                    return (pc.GetPartyMembers().Any(o => o.FindItemByName(12036) != null));
                case 281:
                case 561:
                    Trace.Assert(originalScript == "game.global_flags[992] == 0");
                    return !GetGlobalFlag(992);
                case 282:
                case 562:
                    Trace.Assert(originalScript == "game.global_flags[992] == 1");
                    return GetGlobalFlag(992);
                case 311:
                ...
                case 392:
                case 402:
                    Trace.Assert(originalScript == "game.global_flags[704] == 1");
                ...
                case 462:
                case 471:
                    Trace.Assert(originalScript == "game.global_flags[974] == 0");
                    return !GetGlobalFlag(974);
                case 445:
                case 463:
                case 473:
                    Trace.Assert(originalScript == "game.global_flags[974] == 1");
                    return GetGlobalFlag(974);
                case 621:
                ...
                case 632:
                    Trace.Assert(originalScript == "pc.skill_level_get(npc,skill_intimidate) >= 16 and game.quests[77].state == qs_botched");
                    return pc.GetSkillLevel(npc, SkillId.intimidate) >= 16 && GetQuestState(77) == QuestState.Botched;
                case 633:
                    Trace.Assert(originalScript == "pc.skill_level_get(npc,skill_intimidate) >= 16 and game.quests[77].state == qs_completed");
                ...
                case 642:
                    Trace.Assert(originalScript == "game.quests[77].state == qs_completed");
                    return GetQuestState(77) == QuestState.Completed;
                case 661:
                    Trace.Assert(originalScript == "game.global_vars[945] == 1");
                    return GetGlobalVar(945) == 1;
                case 662:
                    Trace.Assert(originalScript == "game.global_vars[945] == 2");
                    return GetGlobalVar(945) == 2;
                case 663:
                    Trace.Assert(originalScript == "game.global_vars[945] == 3");
        ...
        public void ApplySideEffect(GameObjectBody npc, GameObjectBody pc, int lineNumber, string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 129:
                case 271:
                    Trace.Assert(originalScript == "game.quests[67].state = qs_accepted; create_item_in_inventory( 4244, pc )");
                ...
                case 31:
                case 131:
                    Trace.Assert(originalScript == "game.global_vars[965] = 1");
                    SetGlobalVar(965, 1);
                    break;
                case 32:
                case 33:
                ...
                case 133:
                case 134:
                    Trace.Assert(originalScript == "game.global_vars[978] = 6; game.global_vars[965] = 2");
                    SetGlobalVar(978, 6);
                    SetGlobalVar(965, 2);
                    ;
                    break;
                case 35:
                case 135:
                    Trace.Assert(originalScript == "game.global_vars[958] = 9");
                    SetGlobalVar(958, 9);
                    break;
                case 36:
                case 136:
                    Trace.Assert(originalScript == "game.global_vars[959] = 5");
                    SetGlobalVar(959, 5);
                    break;
                case 37:
                case 137:
                    Trace.Assert(originalScript == "game.global_vars[704] = 3");
                    SetGlobalVar(704, 3);
                    break;
                case 39:
                case 139:
                    Trace.Assert(originalScript == "game.global_vars[704] = 21");
                    SetGlobalVar(704, 21);
                    break;
                case 40:
                case 140:
                    Trace.Assert(originalScript == "game.global_vars[704] = 10");
                    SetGlobalVar(704, 10);
                    break;
                case 52:
                case 152:
                ...
                case 210:
                    ...
                    break;
                case 230:
                    Trace.Assert(originalScript == "pc.reputation_add( 19 ); pc.money_adj(1000000); game.quests[77].state = qs_completed");
                    pc.AddReputation(19);
                ...
                case 740:
                    ...
                    break;
                case 250:
                    Trace.Assert(originalScript == "game.quests[66].state = qs_mentioned; game.global_flags[960] = 1");
                    SetQuestState(66, QuestState.Mentioned);
                    SetGlobalFlag(960, true);
                    ;
                    break;
                case 261:
                    Trace.Assert(originalScript == "game.quests[66].state = qs_completed");
                    SetQuestState(66, QuestState.Completed);
                    break;
                case 262:
                    Trace.Assert(originalScript == "game.quests[66].state = qs_botched");
                ...
                case 280:
                case 560:
                    Trace.Assert(originalScript == "pc.money_adj(200000); game.quests[67].state = qs_completed");
                ...
                case 300:
                    ...
                    break;
                case 301:
                    Trace.Assert(originalScript == "party_transfer_to( npc, 12036 )");
                    Utilities.party_transfer_to(npc, 12036);
                    break;
                case 310:
                    Trace.Assert(originalScript == "game.quests[67].state = qs_botched");
                    SetQuestState(67, QuestState.Botched);
                    break;
                case 320:
                    Trace.Assert(originalScript == "game.global_vars[958] = 1");
                    SetGlobalVar(958, 1);
                    break;
                case 330:
                    Trace.Assert(originalScript == "game.global_vars[959] = 1");
                    SetGlobalVar(959, 1);
                    break;
                case 370:
                ...
                case 410:
                case 420:
                    Trace.Assert(originalScript == "game.quests[68].state = qs_completed");
                ...
                case 523:
                    ...
                    break;
                case 530:
                    Trace.Assert(originalScript == "game.quests[77].state = qs_accepted; game.global_vars[704] = 1");
                    SetQuestState(77, QuestState.Accepted);
                    SetGlobalVar(704, 1);
                    ;
                    break;
                case 531:
                    Trace.Assert(originalScript == "wilfrick_countdown(npc,pc)");
                    wilfrick_countdown(npc, pc);
                    break;
                case 540:
                    Trace.Assert(originalScript == "game.global_vars[950] = 1");
                    SetGlobalVar(950, 1);
                    break;
                case 640:
                    Trace.Assert(originalScript == "game.global_vars[704] = 11");
                    SetGlobalVar(704, 11);
                    break;
                case 641:
                ...
                case 642:
                    ...
                    break;
                case 661:
                    Trace.Assert(originalScript == "schedule_sb_retaliation_for_snitch(npc,pc)");
                    schedule_sb_retaliation_for_snitch(npc, pc);
                    break;
                case 662:
                    Trace.Assert(originalScript == "schedule_sb_retaliation_for_narc(npc,pc)");
                    schedule_sb_retaliation_for_narc(npc, pc);
                    break;
                case 663:
                    Trace.Assert(originalScript == "schedule_sb_retaliation_for_whistleblower(npc,pc)");
                    schedule_sb_retaliation_for_whistleblower(npc, pc);
                    break;
                case 690:
                    Trace.Assert(originalScript == "darlia_release(npc,pc)");
                    darlia_release(npc, pc);
                    break;
                case 700:
                    Trace.Assert(originalScript == "game.party[0].reputation_add( 49 )");
                    PartyLeader.AddReputation(49);
                    break;
                case 710:
                    Trace.Assert(originalScript == "game.party[0].reputation_add( 48 )");
