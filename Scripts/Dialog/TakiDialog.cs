        ...
        public void ApplySideEffect(GameObjectBody npc, GameObjectBody pc, int lineNumber, string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 120:
                    ...
                    break;
                case 2:
                    Trace.Assert(originalScript == "switch_to_ashrem( npc, pc, 1 )");
                    switch_to_ashrem(npc, pc, 1);
                    break;
                case 111:
                case 112:
                case 113:
                ...
                case 150:
                    ...
                    break;
                case 171:
                    Trace.Assert(originalScript == "switch_to_ashrem( npc, pc, 10 )");
                    switch_to_ashrem(npc, pc, 10);
                    break;
                case 210:
                ...
                case 211:
                    ...
                    break;
                case 231:
                    Trace.Assert(originalScript == "switch_to_ashrem( npc, pc, 100 )");
                    switch_to_ashrem(npc, pc, 100);
                    break;
                case 22000:
                    Trace.Assert(originalScript == "game.global_vars[908] = 32");
                    SetGlobalVar(908, 32);
                    break;
                default:
                    Trace.Assert(originalScript == null);
