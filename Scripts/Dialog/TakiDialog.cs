        ...
        public void ApplySideEffect(GameObjectBody npc, GameObjectBody pc, int lineNumber, out string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 120:
                    ...
                    break;
                case 2:
                    originalScript = "switch_to_ashrem( npc, pc, 1 )";
                ...
                case 150:
                    ...
                    break;
                case 171:
                    originalScript = "switch_to_ashrem( npc, pc, 10 )";
                ...
                case 211:
                    ...
                    break;
                case 231:
                    originalScript = "switch_to_ashrem( npc, pc, 100 )";
                    switch_to_ashrem(npc, pc, 100);
                    break;
                case 22000:
                    originalScript = "game.global_vars[908] = 32";
                    SetGlobalVar(908, 32);
                    break;
                default:
                    originalScript = null;
