    ...
    public class TailorDialog : Tailor, IDialogScript
    {
        public bool CheckPrecondition(GameObjectBody npc, GameObjectBody pc, int lineNumber, out string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 8:
                case 9:
                    originalScript = "game.global_vars[1] == 0 and game.quests[1].state == qs_completed";
        ...
        public void ApplySideEffect(GameObjectBody npc, GameObjectBody pc, int lineNumber, out string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 8:
                case 9:
                    originalScript = "game.global_vars[1] = 4";
                    SetGlobalVar(1, 4);
                    break;
                case 40:
                    originalScript = "game.quests[1].state = qs_mentioned";
                ...
                case 184:
                    ...
                    break;
                case 220:
                    originalScript = "npc.rotation = 2.3";
                    npc.Rotation = 2.3f;
                    break;
                case 221:
                    originalScript = "npc.turn_towards(pc)";
                    npc.TurnTowards(pc);
                    break;
                case 225:
                    originalScript = "create_item_in_inventory(4489,pc)";
