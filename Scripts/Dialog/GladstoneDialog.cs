...
namespace Scripts.Dialog
{
    ...
    public class GladstoneDialog : Gladstone, IDialogScript
    {
        public bool CheckPrecondition(GameObjectBody npc, GameObjectBody pc, int lineNumber, out string originalScript)
        {
            ...
            {
                case 2:
                    originalScript = "not anyone( pc.group_list(), \"has_follower\", 8717 ) and not anyone( pc.group_list(), \"has_follower\", 8718 )";
                    return !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8717)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8718));
                case 3:
                    originalScript = "anyone( pc.group_list(), \"has_follower\", 8717 ) and not anyone( pc.group_list(), \"has_follower\", 8718 )";
                    return pc.GetPartyMembers().Any(o => o.HasFollowerByName(8717)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8718));
                case 4:
                    originalScript = "anyone( pc.group_list(), \"has_follower\", 8718 ) and not anyone( pc.group_list(), \"has_follower\", 8717 )";
                    return pc.GetPartyMembers().Any(o => o.HasFollowerByName(8718)) && !pc.GetPartyMembers().Any(o => o.HasFollowerByName(8717));
                case 5:
                    originalScript = "anyone( pc.group_list(), \"has_follower\", 8717 ) and anyone( pc.group_list(), \"has_follower\", 8718 )";
                    return pc.GetPartyMembers().Any(o => o.HasFollowerByName(8717)) && pc.GetPartyMembers().Any(o => o.HasFollowerByName(8718));
                case 52:
                case 62:
                case 72:
        ...
        public void ApplySideEffect(GameObjectBody npc, GameObjectBody pc, int lineNumber, out string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 2000:
                case 3000:
                    originalScript = "pc.follower_remove( npc ); game.quests[79].state = qs_botched";
