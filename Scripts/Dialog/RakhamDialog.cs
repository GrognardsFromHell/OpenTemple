...
public class RakhamDialog : Rakham, IDialogScript
{
    public bool CheckPrecondition(GameObject npc, GameObject pc, int lineNumber, out string originalScript)
    {
        switch (lineNumber)
        {
            ...
            case 141:
                originalScript = "(game.quests[109].state == qs_mentioned or game.quests[109].state == qs_accepted) not npc_get(npc,5)";
            ...
            case 211:
                originalScript = "game.global_vars[559] == 0 and game.global_flags[541] == 0";
                return GetGlobalVar(559) == 0 && !GetGlobalFlag(541);
            case 212:
                originalScript = "game.global_vars[559] == 1 and game.global_flags[541] == 0";
                return GetGlobalVar(559) == 1 && !GetGlobalFlag(541);
            case 213:
                originalScript = "game.global_vars[559] == 2 and game.global_flags[541] == 0";
                return GetGlobalVar(559) == 2 && !GetGlobalFlag(541);
            case 214:
                originalScript = "game.global_vars[559] == 0 and game.global_flags[541] == 1";
                return GetGlobalVar(559) == 0 && GetGlobalFlag(541);
            case 222:
            case 231:
            case 321:
            ...
            case 392:
            case 422:
                originalScript = "not anyone( pc.group_list(), \"has_follower\", 8766 ) and game.global_vars[545] == 3 and pc.follower_atmax() == 0";
    ...
    public void ApplySideEffect(GameObject npc, GameObject pc, int lineNumber, out string originalScript)
    {
        switch (lineNumber)
        {
            ...
            case 125:
                ...
                break;
            case 311:
                originalScript = "game.global_vars[559] = 1";
                SetGlobalVar(559, 1);
                break;
            case 312:
                originalScript = "game.global_vars[559] = 2";
                SetGlobalVar(559, 2);
                break;
            case 313:
                originalScript = "game.global_flags[541] = 1";
            ...
            case 330:
                ...
                break;
            case 340:
                originalScript = "increment_var_545(npc,pc); check_evidence_rep_rak(npc,pc)";
            ...
            case 422:
                ...
                break;
            case 410:
                originalScript = "game.global_flags[536] = 1";
            ...
            case 440:
            case 480:
                originalScript = "game.global_vars[558] = 2";
                SetGlobalVar(558, 2);
                break;
            default:
                originalScript = null;
