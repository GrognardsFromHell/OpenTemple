    ...
    public class MonaDialog : Mona, IDialogScript
    {
        public bool CheckPrecondition(GameObjectBody npc, GameObjectBody pc, int lineNumber, string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 212:
                case 213:
                    Trace.Assert(originalScript == "game.quests[60].state == qs_accepted and anyone( pc.group_list(), \"has_item\", 5815 ) == 0");
                ...
                case 411:
                case 485:
                    Trace.Assert(originalScript == "game.quests[90].state == qs_mentioned");
                ...
                case 412:
                case 486:
                    Trace.Assert(originalScript == "game.quests[90].state == qs_accepted and game.global_flags[929] == 1");
                ...
                case 267:
                case 268:
                    Trace.Assert(originalScript == "game.quests[60].state == qs_botched and anyone( pc.group_list(), \"has_item\", 5815 ) == 0");
                ...
                case 335:
                    Trace.Assert(originalScript == "anyone( pc.group_list(), \"has_item\", 5815 ) and game.quests[60].state == qs_accepted");
                ...
                case 471:
                case 472:
                    Trace.Assert(originalScript == "pc.skill_level_get(npc, skill_diplomacy) >= 8 and game.global_flags[317] == 0");
        ...
        public void ApplySideEffect(GameObjectBody npc, GameObjectBody pc, int lineNumber, string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 512:
                    ...
                    break;
                case 541:
                    Trace.Assert(originalScript == "gremlich_movie_setup(npc,pc)");
                    gremlich_movie_setup(npc, pc);
                    break;
                case 601:
                    Trace.Assert(originalScript == "game.quests[90].state = qs_accepted");
                    SetQuestState(90, QuestState.Accepted);
                    break;
                case 611:
                case 612:
                case 613:
                    Trace.Assert(originalScript == "schedule_gremlich(npc,pc)");
                    schedule_gremlich(npc, pc);
                    break;
                case 620:
                    Trace.Assert(originalScript == "game.quests[90].state = qs_completed");
                    SetQuestState(90, QuestState.Completed);
                    break;
                case 640:
                    Trace.Assert(originalScript == "pc.money_adj(800)");
                    pc.AdjustMoney(800);
                    break;
                case 650:
                    Trace.Assert(originalScript == "game.global_vars[924] = 1; create_item_in_inventory(11010,pc)");
                    SetGlobalVar(924, 1);
                    Utilities.create_item_in_inventory(11010, pc);
                    ;
                    break;
                case 660:
                    Trace.Assert(originalScript == "encounter_picker(npc,pc)");
