    ...
    public class BurneDialog : Burne, IDialogScript
    {
        public bool CheckPrecondition(GameObjectBody npc, GameObjectBody pc, int lineNumber, string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 23:
                case 30:
                    Trace.Assert(originalScript == "game.party_alignment == TRUE_NEUTRAL and game.global_flags[1] == 0");
                    return PartyAlignment == Alignment.NEUTRAL && !GetGlobalFlag(1);
                case 24:
                case 31:
                    Trace.Assert(originalScript == "(game.party_alignment == NEUTRAL_EVIL or game.party_alignment == NEUTRAL_GOOD) and game.global_flags[67] == 0");
                ...
                case 113:
                case 184:
                    Trace.Assert(originalScript == "game.quests[15].state != qs_unknown and game.areas[2] == 1 and game.story_state <= 1");
                    return GetQuestState(15) != QuestState.Unknown && IsAreaKnown(2) && StoryState <= 1;
                case 123:
                    Trace.Assert(originalScript == "pc.stat_level_get( stat_gender ) == gender_male and pc.skill_level_get(npc,skill_diplomacy) >= 10");
                    return pc.GetGender() == Gender.Male && pc.GetSkillLevel(npc, SkillId.diplomacy) >= 10;
                case 124:
                    Trace.Assert(originalScript == "pc.stat_level_get( stat_gender ) == gender_female and pc.skill_level_get(npc,skill_intimidate) >= 14");
                ...
                case 542:
                    Trace.Assert(originalScript == "game.quests[61].state != qs_botched");
                ...
                case 591:
                    Trace.Assert(originalScript == "game.story_state >= 2 and pc.stat_level_get( stat_gender ) == gender_female and pc.skill_level_get(npc,skill_intimidate) >= 1");
                    return StoryState >= 2 && pc.GetGender() == Gender.Female && pc.GetSkillLevel(npc, SkillId.intimidate) >= 1;
                case 592:
                case 593:
                case 594:
                    Trace.Assert(originalScript == "pc.stat_level_get( stat_gender ) == gender_female and pc.skill_level_get(npc,skill_intimidate) >= 1");
                    return pc.GetGender() == Gender.Female && pc.GetSkillLevel(npc, SkillId.intimidate) >= 1;
                case 595:
                    Trace.Assert(originalScript == "game.story_state >= 2 and pc.stat_level_get( stat_gender ) == gender_male");
                    return StoryState >= 2 && pc.GetGender() == Gender.Male;
                case 597:
                    Trace.Assert(originalScript == "game.story_state <= 1 and pc.stat_level_get( stat_gender ) == gender_female and pc.skill_level_get(npc,skill_intimidate) >= 1");
                    return StoryState <= 1 && pc.GetGender() == Gender.Female && pc.GetSkillLevel(npc, SkillId.intimidate) >= 1;
                case 598:
                    Trace.Assert(originalScript == "game.story_state <= 1 and pc.stat_level_get( stat_gender ) == gender_male");
                    return StoryState <= 1 && pc.GetGender() == Gender.Male;
                case 821:
                    Trace.Assert(originalScript == "pc.money_get() >= 2000");
                    return pc.GetMoney() >= 2000;
                case 862:
                    Trace.Assert(originalScript == "game.quests[61].state == qs_unknown or game.quests[61].state == qs_mentioned");
                    return GetQuestState(61) == QuestState.Unknown || GetQuestState(61) == QuestState.Mentioned;
                case 863:
                    Trace.Assert(originalScript == "game.quests[61].state == qs_accepted");
                    return GetQuestState(61) == QuestState.Accepted;
                case 864:
                case 870:
                    Trace.Assert(originalScript == "(game.party_alignment == LAWFUL_GOOD or game.party_alignment == NEUTRAL_GOOD or game.party_alignment == CHAOTIC_GOOD or game.party_alignment == LAWFUL_NEUTRAL or game.party_alignment == TRUE_NEUTRAL or game.party_alignment == CHAOTIC_NEUTRAL) and game.areas[3] == 0 and game.global_vars[562] != 1");
                ...
                case 866:
                case 872:
                    Trace.Assert(originalScript == "(game.party_alignment == LAWFUL_GOOD or game.party_alignment == NEUTRAL_GOOD or game.party_alignment == CHAOTIC_GOOD or game.party_alignment == LAWFUL_NEUTRAL or game.party_alignment == TRUE_NEUTRAL or game.party_alignment == CHAOTIC_NEUTRAL) and game.areas[3] == 1 and game.global_vars[562] == 1");
                    return (PartyAlignment == Alignment.LAWFUL_GOOD || PartyAlignment == Alignment.NEUTRAL_GOOD || PartyAlignment == Alignment.CHAOTIC_GOOD || PartyAlignment == Alignment.LAWFUL_NEUTRAL || PartyAlignment == Alignment.NEUTRAL || PartyAlignment == Alignment.CHAOTIC_NEUTRAL) && IsAreaKnown(3) && GetGlobalVar(562) == 1;
                case 867:
                case 873:
                    Trace.Assert(originalScript == "(game.party_alignment == CHAOTIC_EVIL or game.party_alignment == NEUTRAL_EVIL or game.party_alignment == LAWFUL_EVIL) and game.areas[3] == 0 and game.global_vars[562] != 1");
                ...
                case 874:
                    ...
                    return (PartyAlignment == Alignment.CHAOTIC_EVIL || PartyAlignment == Alignment.NEUTRAL_EVIL || PartyAlignment == Alignment.LAWFUL_EVIL) && !IsAreaKnown(3) && GetGlobalVar(562) == 1;
                case 869:
                    Trace.Assert(originalScript == "(game.party_alignment == CHAOTIC_EVIL or game.party_alignment == NEUTRAL_EVIL or game.party_alignment == LAWFUL_EVIL) and game.areas[3] == 0");
                ...
                case 875:
                    Trace.Assert(originalScript == "(game.party_alignment == CHAOTIC_EVIL or game.party_alignment == NEUTRAL_EVIL or game.party_alignment == LAWFUL_EVIL) and game.areas[3] == 1 and game.global_vars[562] == 1");
                    return (PartyAlignment == Alignment.CHAOTIC_EVIL || PartyAlignment == Alignment.NEUTRAL_EVIL || PartyAlignment == Alignment.LAWFUL_EVIL) && IsAreaKnown(3) && GetGlobalVar(562) == 1;
                case 876:
                    Trace.Assert(originalScript == "game.global_flags[277] == 1 and game.global_flags[428] == 0 and game.global_flags[815] == 0 and game.global_flags[814] == 0 and game.quests[64].state == qs_unknown");
                    return GetGlobalFlag(277) && !GetGlobalFlag(428) && !GetGlobalFlag(815) && !GetGlobalFlag(814) && GetQuestState(64) == QuestState.Unknown;
                case 877:
                    Trace.Assert(originalScript == "game.global_flags[428] == 0 and game.quests[64].state == qs_mentioned and game.global_flags[815] == 0 and game.global_flags[814] == 0");
                    return !GetGlobalFlag(428) && GetQuestState(64) == QuestState.Mentioned && !GetGlobalFlag(815) && !GetGlobalFlag(814);
                case 878:
                    Trace.Assert(originalScript == "game.global_flags[428] == 1 and game.quests[64].state == qs_accepted");
                    return GetGlobalFlag(428) && GetQuestState(64) == QuestState.Accepted;
                case 879:
                    Trace.Assert(originalScript == "game.global_flags[428] == 1 and game.quests[64].state == qs_completed");
                    return GetGlobalFlag(428) && GetQuestState(64) == QuestState.Completed;
                case 880:
                    Trace.Assert(originalScript == "game.global_flags[428] == 1 and game.quests[64].state == qs_botched");
                    return GetGlobalFlag(428) && GetQuestState(64) == QuestState.Botched;
                case 881:
                    Trace.Assert(originalScript == "game.global_flags[428] == 1 and (game.quests[64].state == qs_unknown or game.quests[64].state == qs_mentioned) and (game.global_flags[815] == 1 or game.global_flags[814] == 1)");
                ...
                case 883:
                case 884:
                    Trace.Assert(originalScript == "(game.party_alignment == LAWFUL_GOOD or game.party_alignment == NEUTRAL_GOOD or game.party_alignment == CHAOTIC_GOOD or game.party_alignment == LAWFUL_NEUTRAL) and game.story_state >= 4 and game.global_flags[195] == 0 and game.global_flags[839] == 0");
                ...
                case 885:
                case 886:
                    Trace.Assert(originalScript == "(game.party_alignment == LAWFUL_GOOD or game.party_alignment == NEUTRAL_GOOD or game.party_alignment == CHAOTIC_GOOD or game.party_alignment == LAWFUL_NEUTRAL) and game.story_state >= 4 and game.global_flags[195] == 1");
                ...
                case 887:
                case 888:
                    Trace.Assert(originalScript == "game.global_flags[195] == 0 and (anyone( pc.group_list(), \"item_find\", 2203 ))");
                    return !GetGlobalFlag(195) && (pc.GetPartyMembers().Any(o => o.FindItemByName(2203) != null));
                case 889:
                case 890:
                    Trace.Assert(originalScript == "game.global_flags[195] == 1 and game.global_flags[358] == 0");
                    return GetGlobalFlag(195) && !GetGlobalFlag(358);
                case 891:
                    Trace.Assert(originalScript == "game.global_flags[195] == 1 and game.global_flags[358] == 1 and game.global_flags[359] == 0 and (game.quests[61].state == qs_unknown or game.quests[61].state == qs_botched)");
                ...
                case 961:
                    Trace.Assert(originalScript == "game.quests[64].state == qs_mentioned");
                    return GetQuestState(64) == QuestState.Mentioned;
                case 962:
                    Trace.Assert(originalScript == "game.quests[64].state == qs_unknown");
                ...
                case 1092:
                    ...
                    return !GetGlobalFlag(292);
                case 1121:
                    Trace.Assert(originalScript == "game.quests[64].state == qs_accepted and game.global_flags[815] == 1 and game.global_flags[814] == 1");
                    return GetQuestState(64) == QuestState.Accepted && GetGlobalFlag(815) && GetGlobalFlag(814);
                case 1122:
                    Trace.Assert(originalScript == "game.quests[64].state == qs_accepted and game.global_flags[815] == 0 and game.global_flags[814] == 1");
                    return GetQuestState(64) == QuestState.Accepted && !GetGlobalFlag(815) && GetGlobalFlag(814);
                case 1123:
                    Trace.Assert(originalScript == "game.quests[64].state == qs_accepted and game.global_flags[815] == 1 and game.global_flags[814] == 0");
                    return GetQuestState(64) == QuestState.Accepted && GetGlobalFlag(815) && !GetGlobalFlag(814);
                case 1124:
                    Trace.Assert(originalScript == "game.quests[64].state == qs_accepted and game.global_flags[815] == 0 and game.global_flags[814] == 0");
                    return GetQuestState(64) == QuestState.Accepted && !GetGlobalFlag(815) && !GetGlobalFlag(814);
                case 1125:
                    Trace.Assert(originalScript == "(game.quests[64].state == qs_unknown or game.quests[64].state == qs_mentioned) and game.global_flags[815] == 1 and game.global_flags[814] == 1 and game.global_flags[883] == 0");
                ...
                case 1126:
                    Trace.Assert(originalScript == "(game.quests[64].state == qs_unknown or game.quests[64].state == qs_mentioned) and game.global_flags[815] == 0 and game.global_flags[814] == 1 and game.global_flags[883] == 0");
                    return (GetQuestState(64) == QuestState.Unknown || GetQuestState(64) == QuestState.Mentioned) && !GetGlobalFlag(815) && GetGlobalFlag(814) && !GetGlobalFlag(883);
                case 1127:
                    Trace.Assert(originalScript == "(game.quests[64].state == qs_unknown or game.quests[64].state == qs_mentioned) and game.global_flags[815] == 1 and game.global_flags[814] == 0 and game.global_flags[883] == 0");
                    return (GetQuestState(64) == QuestState.Unknown || GetQuestState(64) == QuestState.Mentioned) && GetGlobalFlag(815) && !GetGlobalFlag(814) && !GetGlobalFlag(883);
                case 1128:
                    Trace.Assert(originalScript == "game.global_flags[883] == 1 and (game.party_alignment == LAWFUL_GOOD or game.party_alignment == NEUTRAL_GOOD or game.party_alignment == CHAOTIC_GOOD or game.party_alignment == LAWFUL_NEUTRAL or game.party_alignment == TRUE_NEUTRAL or game.party_alignment == CHAOTIC_NEUTRAL)");
                ...
                case 1129:
                    Trace.Assert(originalScript == "game.global_flags[883] == 1 and (game.party_alignment == CHAOTIC_EVIL or game.party_alignment == NEUTRAL_EVIL or game.party_alignment == LAWFUL_EVIL)");
        ...
        public void ApplySideEffect(GameObjectBody npc, GameObjectBody pc, int lineNumber, string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 150:
                case 1080:
                    Trace.Assert(originalScript == "pc.money_adj(+5000); npc.reaction_adj( pc,+20)");
                    pc.AdjustMoney(+5000);
                ...
                case 223:
                case 224:
                    Trace.Assert(originalScript == "game.quests[72].state = qs_accepted; game.global_vars[562] = 1");
                ...
                case 221:
                case 222:
                    Trace.Assert(originalScript == "game.quests[72].state = qs_accepted; game.global_vars[562] = 1; game.worldmap_travel_by_dialog(2)");
                    SetQuestState(72, QuestState.Accepted);
                    SetGlobalVar(562, 1);
                ...
                case 207:
                    ...
                    break;
                case 220:
                    Trace.Assert(originalScript == "game.areas[2] = 1; game.story_state = 1; npc.reaction_adj( pc,-10); game.quests[72].state = qs_mentioned");
                    MakeAreaKnown(2);
                    StoryState = 1;
                ...
                case 254:
                    ...
                    break;
                case 260:
                    Trace.Assert(originalScript == "game.areas[3] = 1; game.story_state = 3; npc.reaction_adj( pc,+10)");
                    MakeAreaKnown(3);
                    StoryState = 3;
                    npc.AdjustReaction(pc, +10);
                    ;
                ...
                case 482:
                    ...
                    break;
                case 420:
                    Trace.Assert(originalScript == "game.global_flags[358] = 1");
                    SetGlobalFlag(358, true);
                    break;
                case 450:
                case 470:
                    Trace.Assert(originalScript == "game.global_flags[195] = 1");
                    SetGlobalFlag(195, true);
                    break;
                case 520:
                case 540:
                    Trace.Assert(originalScript == "game.quests[61].state = qs_mentioned");
                ...
                case 542:
                    ...
                    break;
                case 541:
                    Trace.Assert(originalScript == "pc.money_adj(-30000); create_item_in_inventory( 9171, pc )");
                    pc.AdjustMoney(-30000);
                    Utilities.create_item_in_inventory(9171, pc);
                    ;
                    break;
                case 561:
                    Trace.Assert(originalScript == "game.party[0].reputation_add(27)");
                    PartyLeader.AddReputation(27);
                    break;
                case 582:
                    Trace.Assert(originalScript == "game.party[0].reputation_add(28)");
                ...
                case 770:
                case 780:
                    Trace.Assert(originalScript == "create_item_in_inventory( 9196, pc ); game.quests[61].state = qs_botched");
                    Utilities.create_item_in_inventory(9196, pc);
                    SetQuestState(61, QuestState.Botched);
                    ;
                    break;
                case 810:
                    Trace.Assert(originalScript == "create_item_in_inventory( 9196, pc ); create_item_in_inventory( 9171, pc )");
                    Utilities.create_item_in_inventory(9196, pc);
                    Utilities.create_item_in_inventory(9171, pc);
                    ;
                    break;
                ...
                case 880:
                case 881:
                    Trace.Assert(originalScript == "game.global_flags[428] = 0");
                ...
                case 921:
                case 961:
                    Trace.Assert(originalScript == "game.quests[64].state = qs_accepted");
                ...
                case 940:
                    ...
                    break;
                case 1010:
                    Trace.Assert(originalScript == "game.areas[3] = 1; game.story_state = 3; npc.reaction_adj( pc,+10); game.quests[72].state = qs_completed; game.global_vars[562] = 6");
                    MakeAreaKnown(3);
                    StoryState = 3;
                    npc.AdjustReaction(pc, +10);
                    SetQuestState(72, QuestState.Completed);
                    ...
                    break;
                case 1110:
                    Trace.Assert(originalScript == "npc.reaction_adj( pc,+10); game.quests[72].state = qs_completed; game.global_vars[562] = 6");
                    npc.AdjustReaction(pc, +10);
                    SetQuestState(72, QuestState.Completed);
                    SetGlobalVar(562, 6);
                    ;
                ...
                case 1128:
                case 1129:
                    Trace.Assert(originalScript == "game.global_flags[883] = 0");
                ...
                case 1140:
                    ...
                    break;
                case 1211:
                    Trace.Assert(originalScript == "game.quests[61].state = qs_completed");
                    SetQuestState(61, QuestState.Completed);
                    break;
                case 22000:
                    Trace.Assert(originalScript == "game.global_vars[909] = 32");
                    SetGlobalVar(909, 32);
                    break;
                default:
                    Trace.Assert(originalScript == null);
