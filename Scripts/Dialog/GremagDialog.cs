    ...
    public class GremagDialog : Gremag, IDialogScript
    {
        public bool CheckPrecondition(GameObjectBody npc, GameObjectBody pc, int lineNumber, string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 265:
                case 266:
                    Trace.Assert(originalScript == "game.global_flags[835] == 1 or game.global_flags[837] == 1 and game.global_flags[37] == 0");
                    return GetGlobalFlag(835) || GetGlobalFlag(837) && !GetGlobalFlag(37);
                case 333:
                case 334:
                case 391:
                case 392:
                    Trace.Assert(originalScript == "game.global_flags[297] == 1");
                    return GetGlobalFlag(297);
                case 353:
                case 354:
                case 401:
                case 402:
                    Trace.Assert(originalScript == "game.global_flags[298] == 1");
        ...
        public void ApplySideEffect(GameObjectBody npc, GameObjectBody pc, int lineNumber, string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 171:
                case 172:
                    Trace.Assert(originalScript == "npc.item_transfer_to_by_proto(pc,4107); pc.condition_add_with_args(\"Fallen_Paladin\",0,0)");
                ...
                case 290:
                    ...
                    break;
                case 330:
                    Trace.Assert(originalScript == "game.quests[91].state = qs_mentioned");
                    SetQuestState(91, QuestState.Mentioned);
                    break;
                case 331:
                case 332:
                    Trace.Assert(originalScript == "game.global_flags[294] = 1; game.quests[91].state = qs_accepted");
                    SetGlobalFlag(294, true);
                    SetQuestState(91, QuestState.Accepted);
                    ;
                    break;
                case 350:
                    Trace.Assert(originalScript == "game.quests[91].state = qs_completed; game.quests[92].state = qs_mentioned");
                ...
                case 351:
                case 352:
                    Trace.Assert(originalScript == "game.global_flags[295] = 1; game.quests[92].state = qs_accepted");
                    SetGlobalFlag(295, true);
                    SetQuestState(92, QuestState.Accepted);
                    ;
                    break;
                case 360:
                    Trace.Assert(originalScript == "game.quests[92].state = qs_completed; game.quests[93].state = qs_mentioned");
                    SetQuestState(92, QuestState.Completed);
                    SetQuestState(93, QuestState.Mentioned);
                    ;
                    break;
                case 361:
                    Trace.Assert(originalScript == "game.global_flags[296] = 1; game.quests[93].state = qs_accepted");
                    SetGlobalFlag(296, true);
                    SetQuestState(93, QuestState.Accepted);
                    ;
                    break;
                case 362:
                    Trace.Assert(originalScript == "game.global_flags[296] = 1; game.quests[92].state = qs_accepted");
                    SetGlobalFlag(296, true);
                    SetQuestState(92, QuestState.Accepted);
                    ;
                    break;
                case 370:
                    Trace.Assert(originalScript == "game.party[0].reputation_add( 24 ); game.quests[93].state = qs_completed");
                ...
                case 1001:
                    Trace.Assert(originalScript == "switch_to_rannos(npc,pc)");
