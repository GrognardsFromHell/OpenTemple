...
{
    [SpellScript(714)]
    public class PotionOfProtectionFromOutsiders : BaseSpellScript
    {

        public override void OnBeginSpellCast(SpellPacketBody spell)
        {
            Logger.Info("Protection From Outsiders OnBeginSpellCast");
        ...
        {
            Logger.Info("Protection From Outsiders OnSpellEffect");
            ...
            if (target_item.Object.IsFriendly(spell.caster))
            {
                ...
                target_item.ParticleSystem = AttachParticles("sp-Protection From outsiders", target_item.Object);
