...
namespace VanillaScripts
{
    ...
    public class KOSOnNonFire : BaseObjectScript
    {
        ...
        public override bool OnWillKos(GameObject attachee, GameObject triggerer)
        {
            ...
            {
                if ((obj.FindItemByName(3017) != null))
                {
                    saw_ally_robe = true;
                ...
                else if (((obj.FindItemByName(3020) != null) || (obj.FindItemByName(3016) != null) || (obj.FindItemByName(3010) != null)))
                {
                    saw_enemy_robe = true;
            ...
            if ((saw_greater_robe) || (GetQuestState(52) >= QuestState.Accepted))
            {
                return SkipDefault;
            }
