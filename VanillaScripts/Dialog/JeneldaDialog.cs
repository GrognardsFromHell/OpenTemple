    ...
    public class JeneldaDialog : Jenelda, IDialogScript
    {
        public bool CheckPrecondition(GameObjectBody npc, GameObjectBody pc, int lineNumber, string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 43:
                case 44:
                    Trace.Assert(originalScript == "pc.skill_level_get(npc, skill_intimidation) >= 7");
        ...
        public void ApplySideEffect(GameObjectBody npc, GameObjectBody pc, int lineNumber, string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 183:
                    ...
                    break;
                case 52:
                    Trace.Assert(originalScript == "game.fade_and_teleport( 14400, 0, 0, 5051, 557, 531 ); get_rep( npc, pc )");
                    FadeAndTeleport(14400, 0, 0, 5051, 557, 531);
                    get_rep(npc, pc);
                    ;
                    break;
                ...
                case 193:
                case 194:
                    Trace.Assert(originalScript == "game.fade_and_teleport( 21600, 0, 0, 5051, 557, 531 )");
