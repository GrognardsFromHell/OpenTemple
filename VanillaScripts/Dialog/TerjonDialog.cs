    ...
    public class TerjonDialog : Terjon, IDialogScript
    {
        public bool CheckPrecondition(GameObjectBody npc, GameObjectBody pc, int lineNumber, out string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 121:
                case 122:
                    originalScript = "game.story_state >= 2 and game.party_alignment == NEUTRAL_GOOD and game.areas[3] == 0";
                ...
                case 169:
                case 170:
                    originalScript = "pc.skill_level_get(npc,skill_diplomacy) >= 7 and game.global_vars[27] == 1";
                ...
                case 1251:
                case 1252:
                    originalScript = "pc.skill_level_get(npc,skill_diplomacy) >= 4 or pc.skill_level_get(npc,skill_bluff) >= 2";
        ...
        public void ApplySideEffect(GameObjectBody npc, GameObjectBody pc, int lineNumber, out string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 561:
                case 563:
                    originalScript = "pc.money_adj(-24000); npc.cast_spell( spell_cure_neutralize_poison, picker_obj )";
                ...
                case 621:
                case 623:
                    originalScript = "pc.money_adj(-27000); npc.cast_spell( spell_cure_neutralize_poison, picker_obj )";
                ...
                case 681:
                case 683:
                    originalScript = "pc.money_adj(-30000); npc.cast_spell( spell_cure_neutralize_poison, picker_obj )";
                ...
                case 741:
                case 743:
                    originalScript = "pc.money_adj(-36000); npc.cast_spell( spell_cure_neutralize_poison, picker_obj )";
                ...
                case 801:
                case 803:
                    originalScript = "pc.money_adj(-40000); npc.cast_spell( spell_cure_neutralize_poison, picker_obj )";
                ...
                case 861:
                case 863:
                    originalScript = "pc.money_adj(-45000); npc.cast_spell( spell_cure_neutralize_poison, picker_obj )";
                ...
                case 921:
                case 923:
                    originalScript = "pc.money_adj(-50000); npc.cast_spell( spell_cure_neutralize_poison, picker_obj )";
