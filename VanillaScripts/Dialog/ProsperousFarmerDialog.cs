...
namespace VanillaScripts.Dialog
{
    ...
    public class ProsperousFarmerDialog : ProsperousFarmer, IDialogScript
    {
        public bool CheckPrecondition(GameObjectBody npc, GameObjectBody pc, int lineNumber, string originalScript)
        {
            ...
            {
                case 2:
                    Trace.Assert(originalScript == "pc.skill_level_get(npc,skill_bluff) >= 4 and pc.item_find(5801) == OBJ_HANDLE_NULL");
                    return pc.GetSkillLevel(npc, SkillId.bluff) >= 4 && pc.FindItemByName(5801) == null;
                case 3:
                case 4:
                case 123:
                case 124:
                    Trace.Assert(originalScript == "pc.item_find(5801) != OBJ_HANDLE_NULL and pc.skill_level_get(npc,skill_bluff) >= 2");
                ...
                case 18:
                case 19:
                    Trace.Assert(originalScript == "game.global_flags[9] == 0");
                    return !GetGlobalFlag(9);
                case 21:
                case 24:
                ...
                case 22:
                case 27:
                    Trace.Assert(originalScript == "game.global_vars[4] >= 1 and game.quests[9].state == qs_accepted");
                    return GetGlobalVar(4) >= 1 && GetQuestState(9) == QuestState.Accepted;
                case 23:
                case 25:
                    Trace.Assert(originalScript == "game.quests[9].state <= qs_mentioned");
                ...
                case 52:
                    Trace.Assert(originalScript == "game.quests[5].state == qs_mentioned or game.quests[5].state == qs_accepted");
                    return GetQuestState(5) == QuestState.Mentioned || GetQuestState(5) == QuestState.Accepted;
                case 121:
                case 122:
                    Trace.Assert(originalScript == "pc.skill_level_get(npc,skill_bluff) >= 5 and pc.item_find(5801) == OBJ_HANDLE_NULL");
                    return pc.GetSkillLevel(npc, SkillId.bluff) >= 5 && pc.FindItemByName(5801) == null;
                case 129:
                case 130:
                    Trace.Assert(originalScript == "game.quests[5].state <= qs_mentioned and game.global_flags[2] == 1");
                ...
                case 224:
                case 227:
                    Trace.Assert(originalScript == "game.global_vars[4] == 1");
                ...
                case 236:
                    Trace.Assert(originalScript == "game.global_flags[1] == 1 and (game.party_alignment == LAWFUL_GOOD or game.party_alignment == CHAOTIC_GOOD or game.party_alignment == LAWFUL_EVIL or game.party_alignment == CHAOTIC_EVIL)");
        ...
        public void ApplySideEffect(GameObjectBody npc, GameObjectBody pc, int lineNumber, string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 142:
                case 190:
                    Trace.Assert(originalScript == "game.global_flags[10] = 1");
                    SetGlobalFlag(10, true);
                    break;
                case 191:
                case 192:
                case 194:
                    Trace.Assert(originalScript == "game.quests[7].state = qs_completed");
                    SetQuestState(7, QuestState.Completed);
                    break;
                case 195:
                    Trace.Assert(originalScript == "create_item_in_inventory(4222,pc)");
                ...
                case 228:
                case 229:
                    Trace.Assert(originalScript == "game.quests[9].state = qs_completed");
                ...
                case 291:
                case 292:
                    Trace.Assert(originalScript == "game.global_vars[4] = 3");
                    SetGlobalVar(4, 3);
                    break;
                case 302:
                case 304:
                ...
                case 311:
                case 312:
                    Trace.Assert(originalScript == "pc.money_adj(+2000); npc.reaction_adj( pc,+10 )");
                    pc.AdjustMoney(+2000);
                    npc.AdjustReaction(pc, +10);
                    ;
                    break;
