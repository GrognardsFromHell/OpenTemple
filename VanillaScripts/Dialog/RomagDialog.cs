    ...
    public class RomagDialog : Romag, IDialogScript
    {
        public bool CheckPrecondition(GameObjectBody npc, GameObjectBody pc, int lineNumber, string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 323:
                case 324:
                    Trace.Assert(originalScript == "game.quests[44].state == qs_mentioned and game.global_flags[119] == 1");
                    return GetQuestState(44) == QuestState.Mentioned && GetGlobalFlag(119);
                case 325:
                case 326:
                ...
                case 403:
                case 404:
                    Trace.Assert(originalScript == "game.quests[44].state == qs_completed and game.global_flags[119] == 1");
                    return GetQuestState(44) == QuestState.Completed && GetGlobalFlag(119);
                case 407:
                case 408:
                    Trace.Assert(originalScript == "game.quests[44].state == qs_completed and game.global_flags[119] == 0");
                    return GetQuestState(44) == QuestState.Completed && !GetGlobalFlag(119);
                case 409:
        ...
        public void ApplySideEffect(GameObjectBody npc, GameObjectBody pc, int lineNumber, string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 123:
                case 124:
                    Trace.Assert(originalScript == "game.quests[43].state = qs_completed; game.global_flags[347] = 1");
                ...
                case 308:
                    ...
                    break;
                case 160:
                    Trace.Assert(originalScript == "game.global_flags[347] = 1");
                    SetGlobalFlag(347, true);
                    break;
                case 230:
                ...
                case 323:
                case 324:
                    Trace.Assert(originalScript == "game.quests[44].state = qs_accepted");
                ...
                case 250:
                    ...
                    break;
                case 280:
                    Trace.Assert(originalScript == "game.global_flags[119] = 1");
                ...
                case 319:
                case 320:
                    Trace.Assert(originalScript == "game.quests[44].state = qs_completed");
                ...
                case 311:
                case 312:
                    Trace.Assert(originalScript == "game.quests[43].state = qs_completed");
                    SetQuestState(43, QuestState.Completed);
                    break;
                case 329:
                case 330:
