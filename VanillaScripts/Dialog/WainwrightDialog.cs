        ...
        public void ApplySideEffect(GameObject npc, GameObject pc, int lineNumber, out string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 331:
                    ...
                    break;
                case 231:
                    originalScript = "create_item_in_inventory( 6065, pc ); game.global_vars[17] = 1";
                    Utilities.create_item_in_inventory(6065, pc);
                    SetGlobalVar(17, 1);
                    ;
                    break;
                case 251:
                    originalScript = "create_item_in_inventory( 6065, pc ); game.global_vars[17] = game.global_vars[17] + 1";
                    Utilities.create_item_in_inventory(6065, pc);
