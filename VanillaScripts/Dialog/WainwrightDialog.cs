    ...
    public class WainwrightDialog : Wainwright, IDialogScript
    {
        public bool CheckPrecondition(GameObjectBody npc, GameObjectBody pc, int lineNumber, string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 6:
                case 7:
                    Trace.Assert(originalScript == "game.party_alignment == LAWFUL_GOOD and game.story_state >= 2 and game.areas[3] == 0 and game.global_flags[35] == 1");
                    return PartyAlignment == Alignment.LAWFUL_GOOD && StoryState >= 2 && !IsAreaKnown(3) && GetGlobalFlag(35);
                case 8:
                case 10:
                    Trace.Assert(originalScript == "(game.party_alignment != LAWFUL_GOOD and game.story_state >= 2) or (game.party_alignment == LAWFUL_GOOD and game.story_state >= 2 and game.global_flags[35] == 0)");
                ...
                case 11:
                case 12:
                    Trace.Assert(originalScript == "game.party_alignment == LAWFUL_GOOD and game.areas[3] == 1 and game.global_flags[35] == 1 and game.global_flags[153] == 0");
                    return PartyAlignment == Alignment.LAWFUL_GOOD && IsAreaKnown(3) && GetGlobalFlag(35) && !GetGlobalFlag(153);
                case 13:
                case 14:
                    Trace.Assert(originalScript == "game.global_flags[153] == 1 and game.quests[20].state != qs_botched");
                ...
                case 71:
                case 72:
                    Trace.Assert(originalScript == "game.party_alignment == LAWFUL_GOOD and game.global_flags[35] == 0");
                    return PartyAlignment == Alignment.LAWFUL_GOOD && !GetGlobalFlag(35);
                case 81:
                case 82:
                    Trace.Assert(originalScript == "game.global_flags[35] == 1");
                    return GetGlobalFlag(35);
                case 83:
                case 84:
                    Trace.Assert(originalScript == "game.global_flags[35] == 0");
                    return !GetGlobalFlag(35);
                case 123:
                case 124:
                ...
                case 127:
                    Trace.Assert(originalScript == "game.global_flags[153] == 1");
                ...
                case 157:
                case 158:
                    Trace.Assert(originalScript == "game.party_alignment == CHAOTIC_EVIL or game.party_alignment == NEUTRAL_EVIL or game.party_alignment == LAWFUL_EVIL");
                ...
                case 203:
                case 204:
                    Trace.Assert(originalScript == "game.global_vars[17] == 0 and game.global_flags[160] == 0");
                    return GetGlobalVar(17) == 0 && !GetGlobalFlag(160);
                case 205:
                case 206:
                    Trace.Assert(originalScript == "game.global_vars[17] >= 1 and game.global_vars[17] <= 4");
                    return GetGlobalVar(17) >= 1 && GetGlobalVar(17) <= 4;
                case 207:
                case 208:
                    Trace.Assert(originalScript == "game.global_vars[17] >= 5");
                    return GetGlobalVar(17) >= 5;
                case 221:
                case 222:
                    Trace.Assert(originalScript == "game.quests[20].state != qs_botched");
        ...
        public void ApplySideEffect(GameObjectBody npc, GameObjectBody pc, int lineNumber, string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 7:
                case 35:
                    Trace.Assert(originalScript == "game.quests[22].state = qs_completed");
                    SetQuestState(22, QuestState.Completed);
                    break;
                case 30:
                    Trace.Assert(originalScript == "game.global_flags[35] = 1; game.global_flags[67] = 1");
                ...
                case 40:
                case 120:
                    Trace.Assert(originalScript == "game.quests[20].state = qs_mentioned");
                ...
                case 121:
                case 122:
                    Trace.Assert(originalScript == "game.quests[20].state = qs_accepted");
                    SetQuestState(20, QuestState.Accepted);
                    break;
                case 53:
                case 54:
                    Trace.Assert(originalScript == "game.quests[20].state = qs_accepted; game.worldmap_travel_by_dialog(2)");
                    SetQuestState(20, QuestState.Accepted);
                ...
                case 130:
                    ...
                    break;
                case 150:
                    Trace.Assert(originalScript == "game.global_flags[38] = 1");
                ...
                case 155:
                case 156:
                    Trace.Assert(originalScript == "game.quests[20].state = qs_completed");
                ...
                case 310:
                    ...
                    break;
                case 160:
                    Trace.Assert(originalScript == "npc.reaction_adj( pc,+20); game.global_flags[160] = 0");
                ...
                case 331:
                    ...
                    break;
                case 231:
                    Trace.Assert(originalScript == "create_item_in_inventory( 6065, pc ); game.global_vars[17] = 1");
                    Utilities.create_item_in_inventory(6065, pc);
                    SetGlobalVar(17, 1);
                    ;
                    break;
                case 251:
                    Trace.Assert(originalScript == "create_item_in_inventory( 6065, pc ); game.global_vars[17] = game.global_vars[17] + 1");
                    Utilities.create_item_in_inventory(6065, pc);
