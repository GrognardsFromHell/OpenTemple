    ...
    public class CalmertDialog : Calmert, IDialogScript
    {
        public bool CheckPrecondition(GameObjectBody npc, GameObjectBody pc, int lineNumber, string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 43:
                case 44:
                    Trace.Assert(originalScript == "pc.skill_level_get(npc,skill_intimidate) >= 5 and (game.party_alignment ==  CHAOTIC_EVIL or game.party_alignment ==  CHAOTIC_NEUTRAL)");
                ...
                case 243:
                case 244:
                    Trace.Assert(originalScript == "pc.skill_level_get(npc,skill_bluff) >= 2 and pc.money_get() >= 200");
                ...
                case 251:
                case 252:
                    Trace.Assert(originalScript == "pc.skill_level_get(npc,skill_diplomacy) >= 2");
