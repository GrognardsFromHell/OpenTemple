...
namespace VanillaScripts.Dialog
{
    ...
    public class AshremDialog : Ashrem, IDialogScript
    {
        ...
        public void ApplySideEffect(GameObjectBody npc, GameObjectBody pc, int lineNumber, string originalScript)
        {
            ...
            {
                case 2:
                    Trace.Assert(originalScript == "talk_Taki(npc,pc,10,20)");
                    talk_Taki(npc, pc, 10, 20);
                    break;
                case 11:
                    Trace.Assert(originalScript == "talk_Taki(npc,pc,180,20)");
                ...
                case 76:
                    ...
                    break;
                case 91:
                    Trace.Assert(originalScript == "talk_Taki(npc,pc,230,100)");
                ...
                case 230:
                    ...
                    break;
                case 231:
                    Trace.Assert(originalScript == "talk_Alrrem(npc,pc,230,100)");
