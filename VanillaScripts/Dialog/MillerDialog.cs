    ...
    public class MillerDialog : Miller, IDialogScript
    {
        public bool CheckPrecondition(GameObjectBody npc, GameObjectBody pc, int lineNumber, string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 15:
                case 17:
                    Trace.Assert(originalScript == "game.quests[8].state == qs_accepted and game.global_flags[12] == 1 and game.global_flags[13] == 0 and pc.skill_level_get(npc,skill_bluff) >= 4");
                    return GetQuestState(8) == QuestState.Accepted && GetGlobalFlag(12) && !GetGlobalFlag(13) && pc.GetSkillLevel(npc, SkillId.bluff) >= 4;
                case 18:
                case 19:
