    ...
    public class DeggumDialog : Deggum, IDialogScript
    {
        public bool CheckPrecondition(GameObjectBody npc, GameObjectBody pc, int lineNumber, string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 92:
                case 93:
                    Trace.Assert(originalScript == "pc.stat_level_get(stat_race) == race_elf or pc.stat_level_get(stat_race) == race_half_elf");
                    return pc.GetRace() == RaceId.aquatic_elf || pc.GetRace() == RaceId.halfelf;
                case 94:
                case 95:
                case 96:
                    Trace.Assert(originalScript == "pc.stat_level_get(stat_race) != race_elf and pc.stat_level_get(stat_race) != race_half_elf");
                    return pc.GetRace() != RaceId.aquatic_elf && pc.GetRace() != RaceId.halfelf;
                case 103:
                case 104:
