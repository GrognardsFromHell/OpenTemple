    ...
    public class TubalDialog : Tubal, IDialogScript
    {
        public bool CheckPrecondition(GameObjectBody npc, GameObjectBody pc, int lineNumber, string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 181:
                case 182:
                    Trace.Assert(originalScript == "game.global_flags[141] == 0 and game.global_flags[115] == 0 and pc.skill_level_get(npc, skill_sense_motive) >= 10");
                ...
                case 185:
                case 186:
                    Trace.Assert(originalScript == "game.global_flags[115] == 1 and pc.skill_level_get(npc, skill_diplomacy) >= 11 and game.global_flags[107] == 0");
