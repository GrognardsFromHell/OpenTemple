    ...
    public class DarleyAsDemonDialog : DarleyAsDemon, IDialogScript
    {
        public bool CheckPrecondition(GameObject npc, GameObject pc, int lineNumber, out string originalScript)
        {
            switch (lineNumber)
            {
                case 31:
                case 32:
                    originalScript = "pc.skill_level_get(npc, skill_sense_motive) >= 8 and pc.stat_level_get(stat_level_paladin) == 0";
                ...
                case 54:
                case 56:
                    originalScript = "(pc.stat_level_get(stat_race) == race_half_elf or pc.stat_level_get(stat_race) == race_half_orc) and pc.stat_level_get(stat_level_paladin) == 0";
