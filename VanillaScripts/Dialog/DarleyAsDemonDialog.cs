...
{
    [DialogScript(229)]
    public class DarleyAsDemonDialog : DarleyAsDemon, IDialogScript
    {
        public bool CheckPrecondition(GameObjectBody npc, GameObjectBody pc, int lineNumber, string originalScript)
        {
            switch (lineNumber)
            {
                case 31:
                case 32:
                    Trace.Assert(originalScript == "pc.skill_level_get(npc, skill_sense_motive) >= 8 and pc.stat_level_get(stat_level_paladin) == 0");
                    return pc.GetSkillLevel(npc, SkillId.sense_motive) >= 8 && pc.GetStat(Stat.level_paladin) == 0;
                case 33:
                case 34:
                case 57:
                case 58:
                ...
                case 54:
                case 56:
                    Trace.Assert(originalScript == "(pc.stat_level_get(stat_race) == race_half_elf or pc.stat_level_get(stat_race) == race_half_orc) and pc.stat_level_get(stat_level_paladin) == 0");
