        ...
        public void ApplySideEffect(GameObjectBody npc, GameObjectBody pc, int lineNumber, string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 200:
                    ...
                    break;
                case 100:
                    Trace.Assert(originalScript == "game.quests[47].state = qs_accepted; npc.item_transfer_to(pc,3602); game.global_flags[345] = 1");
                ...
                case 180:
                    ...
                    break;
                case 160:
                    Trace.Assert(originalScript == "game.quests[48].state = qs_accepted; create_item_in_inventory(6110,pc); game.global_flags[345] = 1");
                    ...
                    break;
                case 300:
                    Trace.Assert(originalScript == "game.quests[46].state = qs_accepted; game.global_flags[345] = 1");
                ...
                case 540:
                    ...
                    break;
                case 550:
                    Trace.Assert(originalScript == "game.map_flags( 5078, 3, 1 )");
                    // FIXME: map_flags;
                    break;
                case 560:
                    Trace.Assert(originalScript == "game.map_flags( 5078, 4, 1 )");
                    // FIXME: map_flags;
                    break;
                default:
                    Trace.Assert(originalScript == null);
