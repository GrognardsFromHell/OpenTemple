    ...
    public class AgentOfEvilDialog : AgentOfEvil, IDialogScript
    {
        public bool CheckPrecondition(GameObjectBody npc, GameObjectBody pc, int lineNumber, string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 4:
                case 5:
                    Trace.Assert(originalScript == "game.quests[15].state == qs_accepted and not npc.has_met( pc ) and game.global_flags[31] == 0");
                    return GetQuestState(15) == QuestState.Accepted && !npc.HasMet(pc) && !GetGlobalFlag(31);
                case 6:
                case 7:
                    Trace.Assert(originalScript == "game.quests[15].state == qs_accepted and npc.has_met( pc ) and game.global_flags[31] == 0");
                    return GetQuestState(15) == QuestState.Accepted && npc.HasMet(pc) && !GetGlobalFlag(31);
                case 13:
                case 14:
