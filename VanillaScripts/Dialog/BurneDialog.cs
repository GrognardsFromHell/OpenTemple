    ...
    public class BurneDialog : Burne, IDialogScript
    {
        public bool CheckPrecondition(GameObjectBody npc, GameObjectBody pc, int lineNumber, string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 121:
                case 123:
                    Trace.Assert(originalScript == "(game.party_alignment == LAWFUL_GOOD or game.party_alignment == NEUTRAL_GOOD or game.party_alignment == CHAOTIC_GOOD or game.party_alignment == LAWFUL_NEUTRAL or game.party_alignment == TRUE_NEUTRAL or game.party_alignment == CHAOTIC_NEUTRAL) and game.areas[3] == 0");
                ...
                case 128:
                case 129:
                    Trace.Assert(originalScript == "(game.party_alignment == LAWFUL_GOOD or game.party_alignment == NEUTRAL_GOOD or game.party_alignment == CHAOTIC_GOOD or game.party_alignment == LAWFUL_NEUTRAL) and game.story_state >= 4 and game.global_flags[195] == 0");
                ...
                case 184:
                case 185:
                    Trace.Assert(originalScript == "game.quests[15].state != qs_unknown and game.areas[2] == 1 and game.story_state >= 2");
        ...
        public void ApplySideEffect(GameObjectBody npc, GameObjectBody pc, int lineNumber, string originalScript)
        {
            switch (lineNumber)
            {
                ...
                case 207:
                    ...
                    break;
                case 220:
                    Trace.Assert(originalScript == "game.areas[2] = 1; game.story_state = 1; npc.reaction_adj( pc,-10)");
                    MakeAreaKnown(2);
                    StoryState = 1;
