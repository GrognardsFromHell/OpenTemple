...
internal static class PythonConstants
{
    ...
    static PythonConstants()
    {
        ...
        AddTemplePlusEventTypes();
        AddTemplePlusEventKeys();
    }
    ...
    private static void AddTemplePlusEventTypes()
    {
        Add("ET_OnConditionAdd", DispatcherType.ConditionAdd);
        Add("ET_OnConditionRemove", DispatcherType.ConditionRemove);
        Add("ET_OnConditionAddPre", DispatcherType.ConditionAddPre);
        Add("ET_OnConditionRemove2", DispatcherType.ConditionRemove2);
        Add("ET_OnConditionAddFromD20StatusInit", DispatcherType.ConditionAddFromD20StatusInit);
        Add("ET_OnD20AdvanceTime", DispatcherType.D20AdvanceTime);
        Add("ET_OnTurnBasedStatusInit", DispatcherType.TurnBasedStatusInit);
        Add("ET_OnInitiative", DispatcherType.Initiative);
        Add("ET_OnNewDay", DispatcherType.NewDay);
        Add("ET_OnAbilityScoreLevel", DispatcherType.AbilityScoreLevel);
        Add("ET_OnGetAC", DispatcherType.GetAC);
        Add("ET_OnGetAcModifierFromAttacker", DispatcherType.AcModifyByAttacker);
        Add("ET_OnSaveThrowLevel", DispatcherType.SaveThrowLevel);
        Add("ET_OnSaveThrowSpellResistanceBonus", DispatcherType.SaveThrowSpellResistanceBonus);
        Add("ET_OnToHitBonusBase", DispatcherType.ToHitBonusBase);
        Add("ET_OnToHitBonus2", DispatcherType.ToHitBonus2);
        Add("ET_OnToHitBonusFromDefenderCondition", DispatcherType.ToHitBonusFromDefenderCondition);
        Add("ET_OnDealingDamage", DispatcherType.DealingDamage);
        Add("ET_OnTakingDamage", DispatcherType.TakingDamage);
        Add("ET_OnDealingDamage2", DispatcherType.DealingDamage2);
        Add("ET_OnTakingDamage2", DispatcherType.TakingDamage2);
        Add("ET_OnReceiveHealing", DispatcherType.ReceiveHealing);
        Add("ET_OnGetCriticalHitRange", DispatcherType.GetCriticalHitRange);
        Add("ET_OnGetCriticalHitExtraDice", DispatcherType.GetCriticalHitExtraDice);
        Add("ET_OnGetCurrentHP", DispatcherType.CurrentHP);
        Add("ET_OnGetMaxHP", DispatcherType.MaxHP);
        Add("ET_OnGetInitiativeMod", DispatcherType.InitiativeMod);
        Add("ET_OnD20Signal", DispatcherType.D20Signal);
        Add("ET_OnD20Query", DispatcherType.D20Query);
        Add("ET_OnGetSkillLevel", DispatcherType.SkillLevel);
        Add("ET_OnBuildRadialMenuEntry", DispatcherType.RadialMenuEntry);
        Add("ET_OnGetTooltip", DispatcherType.Tooltip);
        Add("ET_OnDispelCheck", DispatcherType.DispelCheck);
        Add("ET_OnGetDefenderConcealmentMissChance", DispatcherType.GetDefenderConcealmentMissChance);
        Add("ET_OnGetCasterLevelMod", DispatcherType.BaseCasterLevelMod);
        Add("ET_OnD20ActionCheck", DispatcherType.D20ActionCheck);
        Add("ET_OnD20ActionPerform", DispatcherType.D20ActionPerform);
        Add("ET_OnD20ActionOnActionFrame", DispatcherType.D20ActionOnActionFrame);
        Add("ET_OnDestructionDomain", DispatcherType.DestructionDomain);
        Add("ET_OnGetMoveSpeedBase", DispatcherType.GetMoveSpeedBase);
        Add("ET_OnGetMoveSpeed", DispatcherType.GetMoveSpeed);
        Add("ET_OnGetAbilityCheckModifier", DispatcherType.AbilityCheckModifier);
        Add("ET_OnGetAttackerConcealmentMissChance", DispatcherType.GetAttackerConcealmentMissChance);
        Add("ET_OnCountersongSaveThrow", DispatcherType.CountersongSaveThrow);
        Add("ET_OnGetSpellResistanceMod", DispatcherType.SpellResistanceMod);
        Add("ET_OnGetSpellDcBase", DispatcherType.SpellDcBase);
        Add("ET_OnGetSpellDcMod", DispatcherType.SpellDcMod);
        Add("ET_OnBeginRound", DispatcherType.BeginRound);
        Add("ET_OnReflexThrow", DispatcherType.ReflexThrow);
        Add("ET_OnDeflectArrows", DispatcherType.DeflectArrows);
        Add("ET_OnGetNumAttacksBase", DispatcherType.GetNumAttacksBase);
        Add("ET_OnGetBonusAttacks", DispatcherType.GetBonusAttacks);
        Add("ET_OnGetCritterNaturalAttacksNum", DispatcherType.GetCritterNaturalAttacksNum);
        Add("ET_OnObjectEvent", DispatcherType.ObjectEvent);
        Add("ET_OnProjectileCreated", DispatcherType.ProjectileCreated);
        Add("ET_OnProjectileDestroyed", DispatcherType.ProjectileDestroyed);
        Add("ET_OnGetAbilityLoss", DispatcherType.GetAbilityLoss);
        Add("ET_OnGetAttackDice", DispatcherType.GetAttackDice);
        Add("ET_OnGetLevel", DispatcherType.GetLevel);
        Add("ET_OnImmunityTrigger", DispatcherType.ImmunityTrigger);
        Add("ET_OnSpellImmunityCheck", DispatcherType.SpellImmunityCheck);
        Add("ET_OnGetEffectTooltip", DispatcherType.EffectTooltip);
        Add("ET_OnStatBaseGet", DispatcherType.StatBaseGet);
        Add("ET_OnWeaponGlowType", DispatcherType.WeaponGlowType);
        Add("ET_OnItemForceRemove", DispatcherType.ItemForceRemove);
        Add("ET_OnGetArmorToHitPenalty", DispatcherType.ArmorCheckPenalty);
        Add("ET_OnGetMaxDexAcBonus", DispatcherType.MaxDexAcBonus);
        Add("ET_OnGetSizeCategory", DispatcherType.GetSizeCategory);
        Add("ET_OnGetBucklerAcPenalty", DispatcherType.BucklerAcPenalty);
        Add("ET_OnGetModelScale", DispatcherType.GetModelScale);
        Add("ET_OnD20PythonQuery", DispatcherType.PythonQuery);
        Add("ET_OnD20PythonSignal", DispatcherType.PythonSignal);
        Add("ET_OnD20PythonActionCheck", DispatcherType.PythonActionCheck);
        Add("ET_OnD20PythonActionPerform", DispatcherType.PythonActionPerform);
        Add("ET_OnD20PythonActionFrame", DispatcherType.PythonActionFrame);
        Add("ET_OnD20PythonActionAdd", DispatcherType.PythonActionAdd);
        Add("ET_OnPythonAdf", DispatcherType.PythonAdf);
        Add("ET_OnSpellListExtensionGet", DispatcherType.SpellListExtension);
        Add("ET_OnGetBaseCasterLevel", DispatcherType.GetBaseCasterLevel);
        Add("ET_OnLevelupSystemEvent", DispatcherType.LevelupSystemEvent);
        Add("ET_OnDealingDamageWeaponlikeSpell", DispatcherType.DealingDamageWeaponlikeSpell);
        Add("ET_OnActionCostMod", DispatcherType.ActionCostMod);
        Add("ET_OnMetaMagicMod", DispatcherType.MetaMagicMod);
        Add("ET_OnSpecialAttack", DispatcherType.SpecialAttack);
        Add("ET_OnConfirmCriticalBonus", DispatcherType.ConfirmCriticalBonus);
        Add("ET_OnRangeIncrementBonus", DispatcherType.RangeIncrementBonus);
        Add("ET_OnDispatchSpellDamage", DispatcherType.DealingDamageSpell);
        Add("ET_OnSpellResistanceCheckBonus", DispatcherType.SpellResistanceCasterLevelCheck);
        Add("ET_OnTargetSpellDCBonus", DispatcherType.TargetSpellDCBonus);
    }

    private static void AddTemplePlusEventKeys()
    {
        Add("EK_NONE", D20DispatcherKey.NONE);
        Add("EK_STAT_STRENGTH", D20DispatcherKey.STAT_STRENGTH);
        Add("EK_STAT_DEXTERITY", D20DispatcherKey.STAT_DEXTERITY);
        Add("EK_STAT_CONSTITUTION", D20DispatcherKey.STAT_CONSTITUTION);
        Add("EK_STAT_INTELLIGENCE", D20DispatcherKey.STAT_INTELLIGENCE);
        Add("EK_STAT_WISDOM", D20DispatcherKey.STAT_WISDOM);
        Add("EK_STAT_CHARISMA", D20DispatcherKey.STAT_CHARISMA);
        Add("EK_SAVE_FORTITUDE", D20DispatcherKey.SAVE_FORTITUDE);
        Add("EK_SAVE_REFLEX", D20DispatcherKey.SAVE_REFLEX);
        Add("EK_SAVE_WILL", D20DispatcherKey.SAVE_WILL);
        Add("EK_IMMUNITY_SPELL", D20DispatcherKey.IMMUNITY_SPELL);
        Add("EK_IMMUNITY_11", D20DispatcherKey.IMMUNITY_11);
        Add("EK_IMMUNITY_12", D20DispatcherKey.IMMUNITY_12);
        Add("EK_IMMUNITY_COURAGE", D20DispatcherKey.IMMUNITY_COURAGE);
        Add("EK_IMMUNITY_RACIAL", D20DispatcherKey.IMMUNITY_RACIAL);
        Add("EK_IMMUNITY_15", D20DispatcherKey.IMMUNITY_15);
        Add("EK_IMMUNITY_SPECIAL", D20DispatcherKey.IMMUNITY_SPECIAL);
        Add("EK_OnEnterAoE", D20DispatcherKey.OnEnterAoE);
        Add("EK_OnLeaveAoE", D20DispatcherKey.OnLeaveAoE);
        Add("EK_SKILL_APPRAISE", D20DispatcherKey.SKILL_APPRAISE);
        Add("EK_SKILL_BLUFF", D20DispatcherKey.SKILL_BLUFF);
        Add("EK_SKILL_CONCENTRATION", D20DispatcherKey.SKILL_CONCENTRATION);
        Add("EK_SKILL_RIDE", D20DispatcherKey.SKILL_RIDE);
        Add("EK_SKILL_SWIM", D20DispatcherKey.SKILL_SWIM);
        Add("EK_SKILL_USE_ROPE", D20DispatcherKey.SKILL_USE_ROPE);
        Add("EK_D20A_UNSPECIFIED_MOVE", D20DispatcherKey.D20A_UNSPECIFIED_MOVE);
        Add("EK_D20A_UNSPECIFIED_ATTACK", D20DispatcherKey.D20A_UNSPECIFIED_ATTACK);
        Add("EK_D20A_STANDARD_ATTACK", D20DispatcherKey.D20A_STANDARD_ATTACK);
        Add("EK_D20A_FULL_ATTACK", D20DispatcherKey.D20A_FULL_ATTACK);
        Add("EK_D20A_STANDARD_RANGED_ATTACK", D20DispatcherKey.D20A_STANDARD_RANGED_ATTACK);
        Add("EK_D20A_RELOAD", D20DispatcherKey.D20A_RELOAD);
        Add("EK_D20A_5FOOTSTEP", D20DispatcherKey.D20A_5FOOTSTEP);
        Add("EK_D20A_MOVE", D20DispatcherKey.D20A_MOVE);
        Add("EK_D20A_DOUBLE_MOVE", D20DispatcherKey.D20A_DOUBLE_MOVE);
        Add("EK_D20A_RUN", D20DispatcherKey.D20A_RUN);
        Add("EK_D20A_CAST_SPELL", D20DispatcherKey.D20A_CAST_SPELL);
        Add("EK_D20A_HEAL", D20DispatcherKey.D20A_HEAL);
        Add("EK_D20A_CLEAVE", D20DispatcherKey.D20A_CLEAVE);
        Add("EK_D20A_ATTACK_OF_OPPORTUNITY", D20DispatcherKey.D20A_ATTACK_OF_OPPORTUNITY);
        Add("EK_D20A_WHIRLWIND_ATTACK", D20DispatcherKey.D20A_WHIRLWIND_ATTACK);
        Add("EK_D20A_TOUCH_ATTACK", D20DispatcherKey.D20A_TOUCH_ATTACK);
        Add("EK_D20A_TOTAL_DEFENSE", D20DispatcherKey.D20A_TOTAL_DEFENSE);
        Add("EK_D20A_CHARGE", D20DispatcherKey.D20A_CHARGE);
        Add("EK_D20A_FALL_TO_PRONE", D20DispatcherKey.D20A_FALL_TO_PRONE);
        Add("EK_D20A_STAND_UP", D20DispatcherKey.D20A_STAND_UP);
        Add("EK_D20A_TURN_UNDEAD", D20DispatcherKey.D20A_TURN_UNDEAD);
        Add("EK_D20A_DEATH_TOUCH", D20DispatcherKey.D20A_DEATH_TOUCH);
        Add("EK_D20A_PROTECTIVE_WARD", D20DispatcherKey.D20A_PROTECTIVE_WARD);
        Add("EK_D20A_FEAT_OF_STRENGTH", D20DispatcherKey.D20A_FEAT_OF_STRENGTH);
        Add("EK_D20A_BARDIC_MUSIC", D20DispatcherKey.D20A_BARDIC_MUSIC);
        Add("EK_D20A_PICKUP_OBJECT", D20DispatcherKey.D20A_PICKUP_OBJECT);
        Add("EK_D20A_COUP_DE_GRACE", D20DispatcherKey.D20A_COUP_DE_GRACE);
        Add("EK_D20A_USE_ITEM", D20DispatcherKey.D20A_USE_ITEM);
        Add("EK_D20A_BARBARIAN_RAGE", D20DispatcherKey.D20A_BARBARIAN_RAGE);
        Add("EK_D20A_STUNNING_FIST", D20DispatcherKey.D20A_STUNNING_FIST);
        Add("EK_D20A_SMITE_EVIL", D20DispatcherKey.D20A_SMITE_EVIL);
        Add("EK_D20A_LAY_ON_HANDS_SET", D20DispatcherKey.D20A_LAY_ON_HANDS_SET);
        Add("EK_D20A_DETECT_EVIL", D20DispatcherKey.D20A_DETECT_EVIL);
        Add("EK_D20A_STOP_CONCENTRATION", D20DispatcherKey.D20A_STOP_CONCENTRATION);
        Add("EK_D20A_BREAK_FREE", D20DispatcherKey.D20A_BREAK_FREE);
        Add("EK_D20A_TRIP", D20DispatcherKey.D20A_TRIP);
        Add("EK_D20A_REMOVE_DISEASE", D20DispatcherKey.D20A_REMOVE_DISEASE);
        Add("EK_D20A_ITEM_CREATION", D20DispatcherKey.D20A_ITEM_CREATION);
        Add("EK_D20A_WHOLENESS_OF_BODY_SET", D20DispatcherKey.D20A_WHOLENESS_OF_BODY_SET);
        Add("EK_D20A_USE_MAGIC_DEVICE_DECIPHER_WRITTEN_SPELL",
            D20DispatcherKey.D20A_USE_MAGIC_DEVICE_DECIPHER_WRITTEN_SPELL);
        Add("EK_D20A_TRACK", D20DispatcherKey.D20A_TRACK);
        Add("EK_D20A_ACTIVATE_DEVICE_STANDARD", D20DispatcherKey.D20A_ACTIVATE_DEVICE_STANDARD);
        Add("EK_D20A_SPELL_CALL_LIGHTNING", D20DispatcherKey.D20A_SPELL_CALL_LIGHTNING);
        Add("EK_D20A_AOO_MOVEMENT", D20DispatcherKey.D20A_AOO_MOVEMENT);
        Add("EK_D20A_CLASS_ABILITY_SA", D20DispatcherKey.D20A_CLASS_ABILITY_SA);
        Add("EK_D20A_ACTIVATE_DEVICE_FREE", D20DispatcherKey.D20A_ACTIVATE_DEVICE_FREE);
        Add("EK_D20A_OPEN_INVENTORY", D20DispatcherKey.D20A_OPEN_INVENTORY);
        Add("EK_D20A_ACTIVATE_DEVICE_SPELL", D20DispatcherKey.D20A_ACTIVATE_DEVICE_SPELL);
        Add("EK_D20A_DISABLE_DEVICE", D20DispatcherKey.D20A_DISABLE_DEVICE);
        Add("EK_D20A_SEARCH", D20DispatcherKey.D20A_SEARCH);
        Add("EK_D20A_SNEAK", D20DispatcherKey.D20A_SNEAK);
        Add("EK_D20A_TALK", D20DispatcherKey.D20A_TALK);
        Add("EK_D20A_OPEN_LOCK", D20DispatcherKey.D20A_OPEN_LOCK);
        Add("EK_D20A_SLEIGHT_OF_HAND", D20DispatcherKey.D20A_SLEIGHT_OF_HAND);
        Add("EK_D20A_OPEN_CONTAINER", D20DispatcherKey.D20A_OPEN_CONTAINER);
        Add("EK_D20A_THROW", D20DispatcherKey.D20A_THROW);
        Add("EK_D20A_THROW_GRENADE", D20DispatcherKey.D20A_THROW_GRENADE);
        Add("EK_D20A_FEINT", D20DispatcherKey.D20A_FEINT);
        Add("EK_D20A_READY_SPELL", D20DispatcherKey.D20A_READY_SPELL);
        Add("EK_D20A_READY_COUNTERSPELL", D20DispatcherKey.D20A_READY_COUNTERSPELL);
        Add("EK_D20A_READY_ENTER", D20DispatcherKey.D20A_READY_ENTER);
        Add("EK_D20A_READY_EXIT", D20DispatcherKey.D20A_READY_EXIT);
        Add("EK_D20A_COPY_SCROLL", D20DispatcherKey.D20A_COPY_SCROLL);
        Add("EK_D20A_READIED_INTERRUPT", D20DispatcherKey.D20A_READIED_INTERRUPT);
        Add("EK_D20A_LAY_ON_HANDS_USE", D20DispatcherKey.D20A_LAY_ON_HANDS_USE);
        Add("EK_D20A_WHOLENESS_OF_BODY_USE", D20DispatcherKey.D20A_WHOLENESS_OF_BODY_USE);
        Add("EK_D20A_DISMISS_SPELLS", D20DispatcherKey.D20A_DISMISS_SPELLS);
        Add("EK_D20A_FLEE_COMBAT", D20DispatcherKey.D20A_FLEE_COMBAT);
        Add("EK_D20A_USE_POTION", D20DispatcherKey.D20A_USE_POTION);
        Add("EK_D20A_DIVINE_MIGHT", D20DispatcherKey.D20A_DIVINE_MIGHT);
        Add("EK_D20A_EMPTY_BODY", D20DispatcherKey.D20A_EMPTY_BODY);
        Add("EK_D20A_QUIVERING_PALM", D20DispatcherKey.D20A_QUIVERING_PALM);
        Add("EK_NEWDAY_REST", D20DispatcherKey.NEWDAY_REST);
        Add("EK_NEWDAY_CALENDARICAL", D20DispatcherKey.NEWDAY_CALENDARICAL);
        Add("EK_S_HP_Changed", D20DispatcherKey.SIG_HP_Changed);
        Add("EK_S_HealSkill", D20DispatcherKey.SIG_HealSkill);
        Add("EK_S_Sequence", D20DispatcherKey.SIG_Sequence);
        Add("EK_S_Pre_Action_Sequence", D20DispatcherKey.SIG_Pre_Action_Sequence);
        Add("EK_S_Action_Recipient", D20DispatcherKey.SIG_Action_Recipient);
        Add("EK_S_BeginTurn", D20DispatcherKey.SIG_BeginTurn);
        Add("EK_S_EndTurn", D20DispatcherKey.SIG_EndTurn);
        Add("EK_S_Dropped_Enemy", D20DispatcherKey.SIG_Dropped_Enemy);
        Add("EK_S_Concentration_Broken", D20DispatcherKey.SIG_Concentration_Broken);
        Add("EK_S_Remove_Concentration", D20DispatcherKey.SIG_Remove_Concentration);
        Add("EK_S_BreakFree", D20DispatcherKey.SIG_BreakFree);
        Add("EK_S_Spell_Cast", D20DispatcherKey.SIG_Spell_Cast);
        Add("EK_S_Spell_End", D20DispatcherKey.SIG_Spell_End);
        Add("EK_S_Spell_Grapple_Removed", D20DispatcherKey.SIG_Spell_Grapple_Removed);
        Add("EK_S_Killed", D20DispatcherKey.SIG_Killed);
        Add("EK_S_AOOPerformed", D20DispatcherKey.SIG_AOOPerformed);
        Add("EK_S_Aid_Another", D20DispatcherKey.SIG_Aid_Another);
        Add("EK_S_TouchAttackAdded", D20DispatcherKey.SIG_TouchAttackAdded);
        Add("EK_S_TouchAttack", D20DispatcherKey.SIG_TouchAttack);
        Add("EK_S_Temporary_Hit_Points_Removed", D20DispatcherKey.SIG_Temporary_Hit_Points_Removed);
        Add("EK_S_Standing_Up", D20DispatcherKey.SIG_Standing_Up);
        Add("EK_S_Bardic_Music_Completed", D20DispatcherKey.SIG_Bardic_Music_Completed);
        Add("EK_S_Combat_End", D20DispatcherKey.SIG_Combat_End);
        Add("EK_S_Initiative_Update", D20DispatcherKey.SIG_Initiative_Update);
        Add("EK_S_RadialMenu_Clear_Checkbox_Group", D20DispatcherKey.SIG_RadialMenu_Clear_Checkbox_Group);
        Add("EK_S_Combat_Critter_Moved", D20DispatcherKey.SIG_Combat_Critter_Moved);
        Add("EK_S_Hide", D20DispatcherKey.SIG_Hide);
        Add("EK_S_Show", D20DispatcherKey.SIG_Show);
        Add("EK_S_Feat_Remove_Slippery_Mind", D20DispatcherKey.SIG_Feat_Remove_Slippery_Mind);
        Add("EK_S_Broadcast_Action", D20DispatcherKey.SIG_Broadcast_Action);
        Add("EK_S_Remove_Disease", D20DispatcherKey.SIG_Remove_Disease);
        Add("EK_S_Rogue_Skill_Mastery_Init", D20DispatcherKey.SIG_Rogue_Skill_Mastery_Init);
        Add("EK_S_Spell_Call_Lightning", D20DispatcherKey.SIG_Spell_Call_Lightning);
        Add("EK_S_Magical_Item_Deactivate", D20DispatcherKey.SIG_Magical_Item_Deactivate);
        Add("EK_S_Spell_Mirror_Image_Struck", D20DispatcherKey.SIG_Spell_Mirror_Image_Struck);
        Add("EK_S_Spell_Sanctuary_Attempt_Save", D20DispatcherKey.SIG_Spell_Sanctuary_Attempt_Save);
        Add("EK_S_Experience_Awarded", D20DispatcherKey.SIG_Experience_Awarded);
        Add("EK_S_Pack", D20DispatcherKey.SIG_Pack);
        Add("EK_S_Unpack", D20DispatcherKey.SIG_Unpack);
        Add("EK_S_Teleport_Prepare", D20DispatcherKey.SIG_Teleport_Prepare);
        Add("EK_S_Teleport_Reconnect", D20DispatcherKey.SIG_Teleport_Reconnect);
        Add("EK_S_Atone_Fallen_Paladin", D20DispatcherKey.SIG_Atone_Fallen_Paladin);
        Add("EK_S_Summon_Creature", D20DispatcherKey.SIG_Summon_Creature);
        Add("EK_S_Attack_Made", D20DispatcherKey.SIG_Attack_Made);
        Add("EK_S_Golden_Skull_Combine", D20DispatcherKey.SIG_Golden_Skull_Combine);
        Add("EK_S_Inventory_Update", D20DispatcherKey.SIG_Inventory_Update);
        Add("EK_S_Critter_Killed", D20DispatcherKey.SIG_Critter_Killed);
        Add("EK_S_SetPowerAttack", D20DispatcherKey.SIG_SetPowerAttack);
        Add("EK_S_SetExpertise", D20DispatcherKey.SIG_SetExpertise);
        Add("EK_S_SetCastDefensively", D20DispatcherKey.SIG_SetCastDefensively);
        Add("EK_S_Resurrection", D20DispatcherKey.SIG_Resurrection);
        Add("EK_S_Dismiss_Spells", D20DispatcherKey.SIG_Dismiss_Spells);
        Add("EK_S_DealNormalDamage", D20DispatcherKey.SIG_DealNormalDamage);
        Add("EK_S_Update_Encumbrance", D20DispatcherKey.SIG_Update_Encumbrance);
        Add("EK_S_Remove_AI_Controlled", D20DispatcherKey.SIG_Remove_AI_Controlled);
        Add("EK_S_Verify_Obj_Conditions", D20DispatcherKey.SIG_Verify_Obj_Conditions);
        Add("EK_S_Web_Burning", D20DispatcherKey.SIG_Web_Burning);
        Add("EK_S_Anim_CastConjureEnd", D20DispatcherKey.SIG_Anim_CastConjureEnd);
        Add("EK_S_Item_Remove_Enhancement", D20DispatcherKey.SIG_Item_Remove_Enhancement);
        Add("EK_S_Disarmed_Weapon_Retrieve", D20DispatcherKey.SIG_Disarmed_Weapon_Retrieve);
        Add("EK_S_Disarm", D20DispatcherKey.SIG_Disarm);
        Add("EK_S_AID_ANOTHER_WAKE_UP", D20DispatcherKey.SIG_AID_ANOTHER_WAKE_UP);
        Add("EK_Q_Helpless", D20DispatcherKey.QUE_Helpless);
        Add("EK_Q_SneakAttack", D20DispatcherKey.QUE_SneakAttack);
        Add("EK_Q_OpponentSneakAttack", D20DispatcherKey.QUE_OpponentSneakAttack);
        Add("EK_Q_CoupDeGrace", D20DispatcherKey.QUE_CoupDeGrace);
        Add("EK_Q_Mute", D20DispatcherKey.QUE_Mute);
        Add("EK_Q_CannotCast", D20DispatcherKey.QUE_CannotCast);
        Add("EK_Q_CannotUseIntSkill", D20DispatcherKey.QUE_CannotUseIntSkill);
        Add("EK_Q_CannotUseChaSkill", D20DispatcherKey.QUE_CannotUseChaSkill);
        Add("EK_Q_RapidShot", D20DispatcherKey.QUE_RapidShot);
        Add("EK_Q_Critter_Is_Concentrating", D20DispatcherKey.QUE_Critter_Is_Concentrating);
        Add("EK_Q_Critter_Is_On_Consecrate_Ground", D20DispatcherKey.QUE_Critter_Is_On_Consecrate_Ground);
        Add("EK_Q_Critter_Is_On_Desecrate_Ground", D20DispatcherKey.QUE_Critter_Is_On_Desecrate_Ground);
        Add("EK_Q_Critter_Is_Held", D20DispatcherKey.QUE_Critter_Is_Held);
        Add("EK_Q_Critter_Is_Invisible", D20DispatcherKey.QUE_Critter_Is_Invisible);
        Add("EK_Q_Critter_Is_Afraid", D20DispatcherKey.QUE_Critter_Is_Afraid);
        Add("EK_Q_Critter_Is_Blinded", D20DispatcherKey.QUE_Critter_Is_Blinded);
        Add("EK_Q_Critter_Is_Charmed", D20DispatcherKey.QUE_Critter_Is_Charmed);
        Add("EK_Q_Critter_Is_Confused", D20DispatcherKey.QUE_Critter_Is_Confused);
        Add("EK_Q_Critter_Is_AIControlled", D20DispatcherKey.QUE_Critter_Is_AIControlled);
        Add("EK_Q_Critter_Is_Cursed", D20DispatcherKey.QUE_Critter_Is_Cursed);
        Add("EK_Q_Critter_Is_Deafened", D20DispatcherKey.QUE_Critter_Is_Deafened);
        Add("EK_Q_Critter_Is_Diseased", D20DispatcherKey.QUE_Critter_Is_Diseased);
        Add("EK_Q_Critter_Is_Poisoned", D20DispatcherKey.QUE_Critter_Is_Poisoned);
        Add("EK_Q_Critter_Is_Stunned", D20DispatcherKey.QUE_Critter_Is_Stunned);
        Add("EK_Q_Critter_Is_Immune_Critical_Hits", D20DispatcherKey.QUE_Critter_Is_Immune_Critical_Hits);
        Add("EK_Q_Critter_Is_Immune_Poison", D20DispatcherKey.QUE_Critter_Is_Immune_Poison);
        Add("EK_Q_Critter_Has_Spell_Resistance", D20DispatcherKey.QUE_Critter_Has_Spell_Resistance);
        Add("EK_Q_Critter_Has_Condition", D20DispatcherKey.QUE_Critter_Has_Condition);
        Add("EK_Q_Critter_Has_Freedom_of_Movement", D20DispatcherKey.QUE_Critter_Has_Freedom_of_Movement);
        Add("EK_Q_Critter_Has_Endure_Elements", D20DispatcherKey.QUE_Critter_Has_Endure_Elements);
        Add("EK_Q_Critter_Has_Protection_From_Elements", D20DispatcherKey.QUE_Critter_Has_Protection_From_Elements);
        Add("EK_Q_Critter_Has_Resist_Elements", D20DispatcherKey.QUE_Critter_Has_Resist_Elements);
        Add("EK_Q_Critter_Has_True_Seeing", D20DispatcherKey.QUE_Critter_Has_True_Seeing);
        Add("EK_Q_Critter_Has_Spell_Active", D20DispatcherKey.QUE_Critter_Has_Spell_Active);
        Add("EK_Q_Critter_Can_Call_Lightning", D20DispatcherKey.QUE_Critter_Can_Call_Lightning);
        Add("EK_Q_Critter_Can_See_Invisible", D20DispatcherKey.QUE_Critter_Can_See_Invisible);
        Add("EK_Q_Critter_Can_See_Darkvision", D20DispatcherKey.QUE_Critter_Can_See_Darkvision);
        Add("EK_Q_Critter_Can_See_Ethereal", D20DispatcherKey.QUE_Critter_Can_See_Ethereal);
        Add("EK_Q_Critter_Can_Discern_Lies", D20DispatcherKey.QUE_Critter_Can_Discern_Lies);
        Add("EK_Q_Critter_Can_Detect_Chaos", D20DispatcherKey.QUE_Critter_Can_Detect_Chaos);
        Add("EK_Q_Critter_Can_Detect_Evil", D20DispatcherKey.QUE_Critter_Can_Detect_Evil);
        Add("EK_Q_Critter_Can_Detect_Good", D20DispatcherKey.QUE_Critter_Can_Detect_Good);
        Add("EK_Q_Critter_Can_Detect_Law", D20DispatcherKey.QUE_Critter_Can_Detect_Law);
        Add("EK_Q_Critter_Can_Detect_Magic", D20DispatcherKey.QUE_Critter_Can_Detect_Magic);
        Add("EK_Q_Critter_Can_Detect_Undead", D20DispatcherKey.QUE_Critter_Can_Detect_Undead);
        Add("EK_Q_Critter_Can_Find_Traps", D20DispatcherKey.QUE_Critter_Can_Find_Traps);
        Add("EK_Q_Critter_Can_Dismiss_Spells", D20DispatcherKey.QUE_Critter_Can_Dismiss_Spells);
        Add("EK_Q_Obj_Is_Blessed", D20DispatcherKey.QUE_Obj_Is_Blessed);
        Add("EK_Q_Unconscious", D20DispatcherKey.QUE_Unconscious);
        Add("EK_Q_Dying", D20DispatcherKey.QUE_Dying);
        Add("EK_Q_Dead", D20DispatcherKey.QUE_Dead);
        Add("EK_Q_AOOPossible", D20DispatcherKey.QUE_AOOPossible);
        Add("EK_Q_AOOIncurs", D20DispatcherKey.QUE_AOOIncurs);
        Add("EK_Q_HoldingCharge", D20DispatcherKey.QUE_HoldingCharge);
        Add("EK_Q_Has_Temporary_Hit_Points", D20DispatcherKey.QUE_Has_Temporary_Hit_Points);
        Add("EK_Q_SpellInterrupted", D20DispatcherKey.QUE_SpellInterrupted);
        Add("EK_Q_ActionTriggersAOO", D20DispatcherKey.QUE_ActionTriggersAOO);
        Add("EK_Q_ActionAllowed", D20DispatcherKey.QUE_ActionAllowed);
        Add("EK_Q_Prone", D20DispatcherKey.QUE_Prone);
        Add("EK_Q_RerollSavingThrow", D20DispatcherKey.QUE_RerollSavingThrow);
        Add("EK_Q_RerollAttack", D20DispatcherKey.QUE_RerollAttack);
        Add("EK_Q_RerollCritical", D20DispatcherKey.QUE_RerollCritical);
        Add("EK_Q_Commanded", D20DispatcherKey.QUE_Commanded);
        Add("EK_Q_Turned", D20DispatcherKey.QUE_Turned);
        Add("EK_Q_Rebuked", D20DispatcherKey.QUE_Rebuked);
        Add("EK_Q_CanBeFlanked", D20DispatcherKey.QUE_CanBeFlanked);
        Add("EK_Q_Critter_Is_Grappling", D20DispatcherKey.QUE_Critter_Is_Grappling);
        Add("EK_Q_Barbarian_Raged", D20DispatcherKey.QUE_Barbarian_Raged);
        Add("EK_Q_Barbarian_Fatigued", D20DispatcherKey.QUE_Barbarian_Fatigued);
        Add("EK_Q_NewRound_This_Turn", D20DispatcherKey.QUE_NewRound_This_Turn);
        Add("EK_Q_Flatfooted", D20DispatcherKey.QUE_Flatfooted);
        Add("EK_Q_Masterwork", D20DispatcherKey.QUE_Masterwork);
        Add("EK_Q_FailedDecipherToday", D20DispatcherKey.QUE_FailedDecipherToday);
        Add("EK_Q_Polymorphed", D20DispatcherKey.QUE_Polymorphed);
        Add("EK_Q_IsActionInvalid_CheckAction", D20DispatcherKey.QUE_IsActionInvalid_CheckAction);
        Add("EK_Q_CanBeAffected_PerformAction", D20DispatcherKey.QUE_CanBeAffected_PerformAction);
        Add("EK_Q_CanBeAffected_ActionFrame", D20DispatcherKey.QUE_CanBeAffected_ActionFrame);
        Add("EK_Q_AOOWillTake", D20DispatcherKey.QUE_AOOWillTake);
        Add("EK_Q_Weapon_Is_Mighty_Cleaving", D20DispatcherKey.QUE_Weapon_Is_Mighty_Cleaving);
        Add("EK_Q_Autoend_Turn", D20DispatcherKey.QUE_Autoend_Turn);
        Add("EK_Q_ExperienceExempt", D20DispatcherKey.QUE_ExperienceExempt);
        Add("EK_Q_FavoredClass", D20DispatcherKey.QUE_FavoredClass);
        Add("EK_Q_IsFallenPaladin", D20DispatcherKey.QUE_IsFallenPaladin);
        Add("EK_Q_WieldedTwoHanded", D20DispatcherKey.QUE_WieldedTwoHanded);
        Add("EK_Q_Critter_Is_Immune_Energy_Drain", D20DispatcherKey.QUE_Critter_Is_Immune_Energy_Drain);
        Add("EK_Q_Critter_Is_Immune_Death_Touch", D20DispatcherKey.QUE_Critter_Is_Immune_Death_Touch);
        Add("EK_Q_Failed_Copy_Scroll", D20DispatcherKey.QUE_Failed_Copy_Scroll);
        Add("EK_Q_Armor_Get_AC_Bonus", D20DispatcherKey.QUE_Armor_Get_AC_Bonus);
        Add("EK_Q_Armor_Get_Max_DEX_Bonus", D20DispatcherKey.QUE_Armor_Get_Max_DEX_Bonus);
        Add("EK_Q_Armor_Get_Max_Speed", D20DispatcherKey.QUE_Armor_Get_Max_Speed);
        Add("EK_Q_FightingDefensively", D20DispatcherKey.QUE_FightingDefensively);
        Add("EK_Q_Elemental_Gem_State", D20DispatcherKey.QUE_Elemental_Gem_State);
        Add("EK_Q_Untripable", D20DispatcherKey.QUE_Untripable);
        Add("EK_Q_Has_Thieves_Tools", D20DispatcherKey.QUE_Has_Thieves_Tools);
        Add("EK_Q_Critter_Is_Encumbered_Light", D20DispatcherKey.QUE_Critter_Is_Encumbered_Light);
        Add("EK_Q_Critter_Is_Encumbered_Medium", D20DispatcherKey.QUE_Critter_Is_Encumbered_Medium);
        Add("EK_Q_Critter_Is_Encumbered_Heavy", D20DispatcherKey.QUE_Critter_Is_Encumbered_Heavy);
        Add("EK_Q_Critter_Is_Encumbered_Overburdened", D20DispatcherKey.QUE_Critter_Is_Encumbered_Overburdened);
        Add("EK_Q_Has_Aura_Of_Courage", D20DispatcherKey.QUE_Has_Aura_Of_Courage);
        Add("EK_Q_BardicInstrument", D20DispatcherKey.QUE_BardicInstrument);
        Add("EK_Q_EnterCombat", D20DispatcherKey.QUE_EnterCombat);
        Add("EK_Q_AI_Fireball_OK", D20DispatcherKey.QUE_AI_Fireball_OK);
        Add("EK_Q_Critter_Cannot_Loot", D20DispatcherKey.QUE_Critter_Cannot_Loot);
        Add("EK_Q_Critter_Cannot_Wield_Items", D20DispatcherKey.QUE_Critter_Cannot_Wield_Items);
        Add("EK_Q_Critter_Is_Spell_An_Ability", D20DispatcherKey.QUE_Critter_Is_Spell_An_Ability);
        Add("EK_Q_Play_Critical_Hit_Anim", D20DispatcherKey.QUE_Play_Critical_Hit_Anim);
        Add("EK_Q_Is_BreakFree_Possible", D20DispatcherKey.QUE_Is_BreakFree_Possible);
        Add("EK_Q_Critter_Has_Mirror_Image", D20DispatcherKey.QUE_Critter_Has_Mirror_Image);
        Add("EK_Q_Wearing_Ring_of_Change", D20DispatcherKey.QUE_Wearing_Ring_of_Change);
        Add("EK_Q_Critter_Has_No_Con_Score", D20DispatcherKey.QUE_Critter_Has_No_Con_Score);
        Add("EK_Q_Item_Has_Enhancement_Bonus", D20DispatcherKey.QUE_Item_Has_Enhancement_Bonus);
        Add("EK_Q_Item_Has_Keen_Bonus", D20DispatcherKey.QUE_Item_Has_Keen_Bonus);
        Add("EK_Q_AI_Has_Spell_Override", D20DispatcherKey.QUE_AI_Has_Spell_Override);
        Add("EK_Q_Weapon_Get_Keen_Bonus", D20DispatcherKey.QUE_Weapon_Get_Keen_Bonus);
        Add("EK_Q_Disarmed", D20DispatcherKey.QUE_Disarmed);
        Add("EK_S_Destruction_Domain_Smite", D20DispatcherKey.SIG_Destruction_Domain_Smite);
        Add("EK_Q_Can_Perform_Disarm", D20DispatcherKey.QUE_Can_Perform_Disarm);
        Add("EK_Q_Craft_Wand_Spell_Level", D20DispatcherKey.QUE_Craft_Wand_Spell_Level);
        Add("EK_Q_Is_Ethereal", D20DispatcherKey.QUE_Is_Ethereal);
        Add("EK_Q_Empty_Body_Num_Rounds", D20DispatcherKey.QUE_Empty_Body_Num_Rounds);
        Add("EK_Q_Quivering_Palm_Can_Perform", D20DispatcherKey.QUE_Quivering_Palm_Can_Perform);
        Add("EK_Q_Trip_AOO", D20DispatcherKey.QUE_Trip_AOO);
        Add("EK_Q_Get_Arcane_Spell_Failure", D20DispatcherKey.QUE_Get_Arcane_Spell_Failure);
        Add("EK_Q_Is_Preferring_One_Handed_Wield", D20DispatcherKey.QUE_Is_Preferring_One_Handed_Wield);
        Add("EK_Q_Scribe_Scroll_Spell_Level", D20DispatcherKey.QUE_Scribe_Scroll_Spell_Level);
        Add("EK_Q_Critter_Is_Immune_Paralysis", D20DispatcherKey.QUE_Critter_Is_Immune_Paralysis);
        Add("EK_LVL_Stats_Activate", D20DispatcherKey.LVL_Stats_Activate);
        Add("EK_LVL_Stats_Check_Complete", D20DispatcherKey.LVL_Stats_Check_Complete);
        Add("EK_LVL_Stats_Finalize", D20DispatcherKey.LVL_Stats_Finalize);
        Add("EK_LVL_Features_Activate", D20DispatcherKey.LVL_Features_Activate);
        Add("EK_LVL_Features_Check_Complete", D20DispatcherKey.LVL_Features_Check_Complete);
        Add("EK_LVL_Features_Finalize", D20DispatcherKey.LVL_Features_Finalize);
        Add("EK_LVL_Skills_Activate", D20DispatcherKey.LVL_Skills_Activate);
        Add("EK_LVL_Skills_Check_Complete", D20DispatcherKey.LVL_Skills_Check_Complete);
        Add("EK_LVL_Skills_Finalize", D20DispatcherKey.LVL_Skills_Finalize);
        Add("EK_LVL_Feats_Activate", D20DispatcherKey.LVL_Feats_Activate);
        Add("EK_LVL_Feats_Check_Complete", D20DispatcherKey.LVL_Feats_Check_Complete);
        Add("EK_LVL_Feats_Finalize", D20DispatcherKey.LVL_Feats_Finalize);
        Add("EK_LVL_Spells_Activate", D20DispatcherKey.LVL_Spells_Activate);
        Add("EK_LVL_Spells_Check_Complete", D20DispatcherKey.LVL_Spells_Check_Complete);
        Add("EK_LVL_Spells_Finalize", D20DispatcherKey.LVL_Spells_Finalize);
    }
}