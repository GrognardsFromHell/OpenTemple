...
public static class ScriptObjectExtensions
{
    ...
    public static void BeginDialog(this GameObject pc, GameObject npc, int line)
    {
    ...
    public static int GetReaction(this GameObject critter, GameObject towards)
    {
    ...
    public static void SetReaction(this GameObject critter, GameObject towards, int newReaction)
    {
    ...
    public static void AdjustReaction(this GameObject critter, GameObject towards, int adjustment)
    {
    ...
    public static bool TransferItemByNameTo(this GameObject container, GameObject transferTo, int nameId)
    {
    ...
    public static bool TransferItemByProtoTo(this GameObject container, GameObject transferTo, int protoId)
    {
    ...
    public static int GetMoney(this GameObject obj)
    {
    ...
    public static void AdjustMoney(this GameObject obj, int copperCoins)
    {
        if (copperCoins <= 0)
        {
    ...
    public static int GetSkillLevel(this GameObject obj, SkillId skill)
    {
    ...
    [PythonName("skill_level_get")]
    public static int GetSkillLevel(this GameObject obj, GameObject against, SkillId skill)
    {
    ...
    [PythonName("has_met")]
    public static bool HasMet(this GameObject npc, GameObject pc)
    {
        return GameSystems.Reaction.HasMet(npc, pc);
    }

    public static int GetNameId(this GameObject critter) => critter.GetInt32(obj_f.name);

    [TempleDllLocation(0x100afeb0)]
    [PythonName("has_follower")]
    public static bool HasFollowerByName(this GameObject critter, int nameId)
    {
    ...
    public static IEnumerable<GameObject> GetPartyMembers(this GameObject obj)
    {
    ...
    private static int GetStat(this GameObject obj, Stat stat)
    {
    ...
    private static int GetBaseStat(this GameObject obj, Stat stat)
    {
    ...
    public static int SetBaseStat(this GameObject obj, Stat stat, int value)
    {
    ...
    public static bool AddFollower(this GameObject leader, GameObject follower)
    {
    ...
    public static bool RemoveFollower(this GameObject obj, GameObject follower)
    {
    ...
    public static bool HasMaxFollowers(this GameObject obj)
    {
    ...
    public static bool AddAIFollower(this GameObject obj, GameObject follower)
    {
    ...
    public static bool RemoveAIFollower(this GameObject obj, GameObject follower)
    {
    ...
    public static bool HasMaxAIFollowers(this GameObject obj)
    {
        return false; // TODO Participation medal for ToEE
    }

    [PythonName("obj_remove_from_all_groups")]
    public static void RemoveFromAllGroups(this GameObject critter)
    {
    ...
    private static GameObject GetLeader(this GameObject obj)
    {
    ...
    [PythonName("can_see")]
    [PythonName("has_los")]
    public static bool HasLineOfSight(this GameObject obj, GameObject target)
    {
    ...
    public static bool HasEquippedByName(this GameObject obj, int nameId)
    {
    ...
    [PythonName("has_item")]
    public static bool HasItemByName(this GameObject container, int nameId)
    {
        return container.FindItemByName(nameId) != null;
    }

    [PythonName("inventory_item")]
    public static GameObject GetInventoryItem(this GameObject obj, int slot)
    {
    ...
    public static GameObject ItemWornAt(this GameObject obj, EquipSlot slot)
    {
    ...
    [PythonName("attack")]
    public static void Attack(this GameObject obj, GameObject target)
    {
    ...
    public static void TurnTowards(this GameObject obj, GameObject target)
    {
    ...
    public static void StealFrom(this GameObject obj, GameObject target)
    {
    ...
    public static bool HasReputation(this GameObject obj, int reputation)
    {
    ...
    public static void AddReputation(this GameObject obj, int reputation)
    {
    ...
    public static void RemoveReputation(this GameObject obj, int reputation)
    {
        // TODO: I find this kinda shoddy
        var leader = GameSystems.Party.GetLeader();
...
// TODO: Still being used a ton in scripts though...
    ...
    public static void AddConditionToItem(this GameObject item, string conditionName, params int[] args)
    {
    ...
    private static bool AddCondition(this GameObject obj, string conditionName, params object[] args)
    {
    ...
    public static bool IsFriendly(this GameObject obj, GameObject source)
    {
    ...
    [PythonName("fade_to")]
    public static void FadeTo(this GameObject obj, int goalOpacity, int timeTickMs, int fadeQuantum,
    ...
    [PythonName("move")]
    public static void Move(this GameObject obj, locXY location, float offsetX = 0, float offsetY = 0)
    {
    ...
    public static ObjectFlag GetObjectFlags(this GameObject obj)
    {
        return obj.GetFlags();
    }
    ...
    public static void SetObjectFlag(this GameObject obj, ObjectFlag flag)
    {
    ...
    public static void ClearObjectFlag(this GameObject obj, ObjectFlag flag)
    {
    ...
    public static PortalFlag GetPortalFlags(this GameObject obj)
    {
    ...
    public static void SetPortalFlag(this GameObject obj, PortalFlag flag)
    {
    ...
    public static void ClearPortalFlag(this GameObject obj, PortalFlag flag)
    {
        obj.SetPortalFlags(obj.GetPortalFlags() & ~flag);
    }
    ...
    public static ContainerFlag GetContainerFlags(this GameObject obj)
    {
    ...
    public static void SetContainerFlag(this GameObject obj, ContainerFlag flag)
    {
    ...
    private static void TogglePortalOpen(this GameObject obj)
    {
    ...
    public static void ToggleContainerOpen(this GameObject obj)
    {
    ...
    public static ItemFlag GetItemFlags(this GameObject obj)
    {
    ...
    public static CritterFlag GetCritterFlags(this GameObject obj)
    {
    ...
    public static void SetCritterFlag(this GameObject obj, CritterFlag flag)
    {
    ...
    public static void ClearCritterFlag(this GameObject obj, CritterFlag flag)
    {
        obj.SetCritterFlags(obj.GetCritterFlags() & ~flag);
    }
    ...
    public static NpcFlag GetNpcFlags(this GameObject obj)
    {
    ...
    public static void SetNpcFlag(this GameObject obj, NpcFlag flag)
    {
    ...
    public static void ClearNpcFlag(this GameObject obj, NpcFlag flag)
    {
        obj.SetNPCFlags(obj.GetNPCFlags() & ~flag);
    }
    ...
    public static int GetCritterSoundEffect(this GameObject obj, CritterSoundEffect soundEffect)
    {
    ...
    [PythonName("footstep")]
    public static void Footstep(this GameObject obj)
    {
    ...
    public static void DetectSecretDoor(this GameObject door, GameObject viewer)
    {
    ...
    public static bool IsAffectedBySpell(this GameObject obj)
    {
    ...
    [PythonName("item_get")]
    public static bool GetItem(this GameObject obj, GameObject item)
    {
    ...
    public static void AddToInitiative(this GameObject obj)
    {
    ...
    public static void RemoveFromInitiative(this GameObject obj)
    {
    ...
    public static int GetInitiative(this GameObject obj)
    {
    ...
    public static void SetInitiative(this GameObject obj, int initiative)
    {
    ...
    public static bool D20Query(this GameObject obj, string key, int data1 = 0, int data2 = 0)
    {
    ...
    private static bool HasCondition(this GameObject obj, ConditionSpec condition)
    {
    ...
    private static Alignment GetAlignment(this GameObject obj)
    {
    ...
    public static float DistanceTo(this GameObject obj, GameObject target)
    {
    ...
    public static void StartFrogGrapplePhase(this GameObject giantFrog, FrogGrapplePhase phase)
    {
        switch (phase)
        {
    ...
    public static void InterruptAnimations(this GameObject obj)
    {
    ...
    public static void InitD20Status(this GameObject obj)
    {
    ...
    public static LocAndOffsets RunOff(this GameObject obj, locXY location) =>
        RunOff(obj, new LocAndOffsets(location));

    [TempleDllLocation(0x100b3540)]
    [PythonName("runoff")]
    public static LocAndOffsets RunOff(this GameObject obj, LocAndOffsets location)
    {
    ...
    public static LocAndOffsets RunOff(this GameObject obj)
    {
    ...
    public static MonsterCategory GetMonsterCategory(this GameObject obj)
    {
    ...
    public static bool IsMonsterCategory(this GameObject obj, MonsterCategory category)
    {
    ...
    public static void AddRumor(this GameObject obj, int rumorId)
    {
    ...
    [PythonName("has_feat")]
    private static bool HasFeat(this GameObject obj, FeatId feat)
    {
    ...
    public static void DealReducedSpellDamage(this GameObject victim, GameObject attacker,
    ...
    public static void HealFromSpell(this GameObject obj, GameObject healer, Dice dice,
        D20ActionType actionType = D20ActionType.NONE, int spellId = 0)
    {
    ...
    public static void IdentifyAll(this GameObject obj)
    {
    ...
    public static void AIAddFleeFrom(this GameObject obj, GameObject fleeFrom)
    {
    ...
    public static DeityId GetDeity(this GameObject obj)
    {
    ...
    public static void AwardExperience(this GameObject obj, int xpAwarded)
    {
    ...
    public static void AtoneFallenPaladin(this GameObject obj)
    {
    ...
    public static void D20SendSignal(this GameObject obj, D20DispatcherKey signal)
    {
        GameSystems.D20.D20SendSignal(obj, signal);
    }

    public static void D20SendSignal(this GameObject obj, D20DispatcherKey signal, GameObject data)
    {
...
// TODO: This is ONLY used for produce flame ?!?!
    ...
    public static void BalorDeath(this GameObject obj)
    {
    ...
    public static void SetConcealed(this GameObject obj, bool concealed)
    {
    ...
    public static void AIAddToShitlist(this GameObject obj, GameObject target)
    {
    ...
    public static void AIRemoveFromShitlist(this GameObject obj, GameObject target)
    {
    ...
    public static bool Unconceal(this GameObject obj)
    {
    ...
    public static void PendingSpellsToMemorized(this GameObject obj)
    {
    ...
    public static void ForgetMemorizedSpells(this GameObject obj)
    {
        obj.ClearArray(obj_f.critter_spells_memorized_idx);
    }

    [PythonName("spells_cast_reset")]
    public static void ResetCastSpells(this GameObject caster, Stat? forClass = null)
    {
    ...
    public static void AIStopAttacking(this GameObject obj)
    {
    ...
    [PythonName("dominate")]
    public static void Dominate(this GameObject critter, GameObject caster)
    {
    ...
    public static bool IsUnconscious(this GameObject obj)
    {
        return GameSystems.Critter.IsDeadOrUnconscious(obj);
    }

    public static int GetMap(this GameObject obj) => GameSystems.Map.GetCurrentMapId();


    public static int GetArea(this GameObject obj) => GameSystems.Area.GetCurrentArea();

    public static Gender GetGender(this GameObject obj) => (Gender) obj.GetStat(Stat.gender);

    public static RaceId GetRace(this GameObject obj) => (RaceId) obj.GetStat(Stat.race);

    public static LootSharingType GetLootSharingType(this GameObject obj)
    {
        var type = obj.GetInt32(obj_f.npc_pad_i_3) & 0xF;
        return (LootSharingType) type;
    }

    public static void SetLootSharingType(this GameObject obj, LootSharingType type)
    {
