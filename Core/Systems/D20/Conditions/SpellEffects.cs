...
{
    private static ConditionSpec CreateSpellEffect(string name, int spellEnum, int numArgs, UniquenessType uniqueness = UniquenessType.NotUnique)
    {
        Trace.Assert(numArgs >= 1); // Arg1 is always the spell id

        return ConditionSpec.Create(name, numArgs, uniqueness)
            .Configure(builder => builder.AddQueryHandler(D20DispatcherKey.QUE_Critter_Has_Spell_Active, HasSpellEffectActive, spellEnum));
    }
    ...
    public static readonly ConditionSpec SpellHoldTouchSpell = ConditionSpec.Create("sp-Hold Touch Spell", 3, UniquenessType.NotUnique)
    ...
    public static readonly ConditionSpec SpellConcentrating = ConditionSpec.Create("sp-Concentrating", 3, UniquenessType.NotUnique)
        .Configure(builder => builder
    ...
    public static readonly ConditionSpec SpellBlindness =
        CreateSpellEffect("sp-Blindness", WellKnownSpells.BlindnessDeafness, 3, UniquenessType.Unique)
            .Configure(builder => builder
    ...
    public static readonly ConditionSpec SpellCallLightning =
        CreateSpellEffect("sp-Call Lightning", WellKnownSpells.CallLightning, 3, UniquenessType.Unique)
            .Configure(builder => builder
    ...
    public static readonly ConditionSpec SpellCallLightningStorm =
        CreateSpellEffect("sp-Call Lightning Storm", WellKnownSpells.CallLightningStorm, 3, UniquenessType.Unique)
            .Configure(builder => builder
                .AddHandler(DispatcherType.DispelCheck, DispelCheck, 19)
                .AddHandler(DispatcherType.ImmunityTrigger, D20DispatcherKey.IMMUNITY_SPELL,
                    CommonConditionCallbacks.ImmunityTriggerCallback, D20DispatcherKey.IMMUNITY_SPELL)
    ...
    public static readonly ConditionSpec SpellGoodberryTally =
        CreateSpellEffect("sp-Goodberry Tally", WellKnownSpells.Goodberry, 3, UniquenessType.Unique)
            .Configure(builder => builder
    ...
    public static readonly ConditionSpec SpellMagicCircleInward = ConditionSpec.Create("sp-Magic Circle Inward", 3, UniquenessType.NotUnique)
        .Configure(builder => builder
    ...
    public static readonly ConditionSpec SpellMagicCircleOutward = ConditionSpec.Create("sp-Magic Circle Outward", 3, UniquenessType.NotUnique)
        .Configure(builder => builder
    ...
    public static readonly ConditionSpec SpellProtectionFromAlignment = ConditionSpec.Create("sp-Protection From Alignment", 3, UniquenessType.NotUnique)
        .Configure(builder => builder
    ...
    public static readonly ConditionSpec SpellSlow = CreateSpellEffect("sp-Slow", WellKnownSpells.Slow, 3, UniquenessType.Unique)
        .Configure(builder => builder
...
// NOTE: DLL Hack removed immunity trigger for spell resistance
    ...
    public static readonly ConditionSpec SpellSummoned = ConditionSpec.Create("sp-Summoned", 3, UniquenessType.NotUnique)
        .Configure(builder => builder
    ...
    public static readonly ConditionSpec SpellPotionofprotectionfromenergy = ConditionSpec.Create("sp-Potion of protection from energy", 4, UniquenessType.NotUnique)
        .Configure(builder => builder
            .AddHandler(DispatcherType.ConditionAdd, sub_100D2A90)
    ...
    public static readonly ConditionSpec SpellProtectionFromMonster = ConditionSpec.Create("sp-Protection From Monster", 3, UniquenessType.NotUnique)
        .Configure(builder => builder
    ...
    public static readonly ConditionSpec SpellProtectionFromMagic = ConditionSpec.Create("sp-Protection From Magic", 3, UniquenessType.NotUnique)
        .Configure(builder => builder
    ...
    public static readonly ConditionSpec SpellSlipperyMind = ConditionSpec.Create("sp-Slippery Mind", 3, UniquenessType.NotUnique)
        .Configure(builder => builder
