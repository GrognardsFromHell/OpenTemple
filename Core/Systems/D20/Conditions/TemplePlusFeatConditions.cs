...
{
    public static readonly ConditionSpec DisableAoo = ConditionSpec.Create("Disable AoO", 1, UniquenessType.Unique)
    ...
    public static readonly ConditionSpec GreaterTwoWeaponFighting = ConditionSpec.Create("Greater Two Weapon Fighting", 2, UniquenessType.Unique)
        .Configure(builder => builder
    ...
    public static readonly ConditionSpec GreaterTwoWeaponFightingRanger = ConditionSpec.Create("Greater Two Weapon Fighting Ranger", 2, UniquenessType.Unique)
        .Configure(builder => builder
            .Prevents(IsGreaterTwoWeaponFightingCondition)
            // same callback as Improved TWF (it just adds an extra attack... logic is inside the action sequence / d20 / GlobalToHit functions
    ...
    public static readonly ConditionSpec DivineMight = ConditionSpec.Create("Divine Might", 2, UniquenessType.Unique)
        .Configure(builder => builder
    ...
    public static readonly ConditionSpec DivineMightBonus = ConditionSpec.Create("Divine Might Bonus", 2, UniquenessType.Unique)
        .Configure(builder => builder
    ...
    public static readonly ConditionSpec RecklessOffense = ConditionSpec.Create("Reckless Offense", 2, UniquenessType.Unique)
        .Configure(builder => builder
            .AddHandler(DispatcherType.RadialMenuEntry, (in DispatcherCallbackArgs evt) =>
            {
                var entry = evt.CreateToggleForArg(0);
    ...
    public static readonly ConditionSpec KnockDown = ConditionSpec.Create("Knock-Down", 2);

    public static readonly ConditionSpec GreaterWeaponSpecialization = ConditionSpec.Create("Greater Weapon Specialization", 2, UniquenessType.UniqueArg1)
        .Configure(builder => builder
            .AddHandler(DispatcherType.DealingDamage, (in DispatcherCallbackArgs evt) =>
            {
    ...
    // Disarm
    public static readonly ConditionSpec Disarm = ConditionSpec.Create("Disarm", 2, UniquenessType.Unique)
        .Configure(builder => builder
            .AddHandler(DispatcherType.RadialMenuEntry, (in DispatcherCallbackArgs evt) =>
            {
    ...
    // Disarm
    public static readonly ConditionSpec Disarmed = ConditionSpec.Create("Disarmed", 8, UniquenessType.Unique)
        .Configure(builder => builder
...
//                    weapon = GameSystems.Obj.GetHandleById(objId);
    ...
    public static readonly ConditionSpec PreferOneHandedWield = ConditionSpec.Create("Prefer One Handed Wield", 1, UniquenessType.NotUnique)
        .Configure(builder => builder
    ...
    public static readonly ConditionSpec AidAnother = ConditionSpec.Create("Aid Another", 0, UniquenessType.Unique)
        .Configure(builder => builder
            .AddHandler(DispatcherType.RadialMenuEntry, (in DispatcherCallbackArgs evt) =>
            {
    ...
    public static readonly ConditionSpec DiamondSoul = ConditionSpec.Create("Diamond Soul", 3, UniquenessType.Unique)
        .Configure(builder => builder
    ...
    public static readonly ConditionSpec PerfectSelf = ConditionSpec.Create("Perfect Self", 3, UniquenessType.NotUnique)
        .Configure(builder => builder
    ...
    public static readonly ConditionSpec EmptyBody = ConditionSpec.Create("Empty Body", 3, UniquenessType.Unique)
        .Configure(builder => builder
    ...
    public static readonly ConditionSpec QuiveringPalm = ConditionSpec.Create("Quivering Palm", 3, UniquenessType.Unique)
        .Configure(builder => builder
    ...
    public static readonly ConditionSpec ImprovedTrip = ConditionSpec.Create("Improved Trip", 2, UniquenessType.Unique)
        .Configure(builder => builder
    ...
    [AutoRegister]
    public static readonly ConditionSpec IronWill = ConditionSpec.Create("Iron Will", 1, UniquenessType.Unique)
        .Configure(builder => builder
