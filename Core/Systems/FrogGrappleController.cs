...
namespace SpicyTemple.Core.Systems
{
	...
	public GameObjectBody GetGrappledOpponent(GameObjectBody giantFrog)
	{
		...
		var spell = GameSystems.Spell.GetActiveSpell(spellIdx);
		if (spell == null) {
			return null;
		}

		return spell.targetListHandles[0];
	}
	private void SetGrappleState(GameObjectBody giantFrog, GrappleState state)
	{
	...
	private GrappleState GetGrappleState(GameObjectBody giantFrog)
	{
