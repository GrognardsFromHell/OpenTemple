...
namespace OpenTemple.Core.Systems
{
    public class ScrollSystem : IGameSystem, IResetAwareSystem, ITimeAwareSystem
    {
        ...
        private Size ScreenSize => GameViews.Primary?.Camera?.ScreenSize ?? Size.Empty;
        ...
        private void CalculateScrollSpeed()
        {
            ...
            var screenSize = _currentViewport.Camera.ScreenSize;
        ...
        private void ProcessMainMenuScrolling()
        {
            ...
            var screenHeight = (int) _currentViewport.Camera.GetScreenHeight();
        ...
        private void ScrollBy(int x, int y)
        {
            ...
            var screenWidth = (int) _currentViewport.Camera.GetScreenWidth();
            var screenHeight = (int) _currentViewport.Camera.GetScreenHeight();
        ...
        public void CenterOnScreenSmooth(int screenX, int screenY)
        {
            if (_currentViewport != null)
            {
                var worldPos = _currentViewport.Camera.ScreenToTile(screenX, screenY);
