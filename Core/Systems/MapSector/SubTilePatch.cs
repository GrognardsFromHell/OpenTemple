...
namespace SpicyTemple.Core.Systems.MapSector
{
    ...
    public class SubTileMeshBuilder
    {
        ...
        public SubTileMesh Build(VertexShader shader)
        {
            if (_vertexCount == 0 || _indexCount == 0)
            {
                return new SubTileMesh(null, null, 0, 0);
            }
            ...
            return new SubTileMesh(indexBuffer, bufferBinding, _vertexCount, _indexCount);
        }
    }

    public class SubTileMesh : IDisposable
    {
        ...
        public SubTileMesh(IndexBuffer indexBuffer, BufferBinding bufferBinding,
