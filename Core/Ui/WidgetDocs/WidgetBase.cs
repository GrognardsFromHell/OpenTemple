...
namespace SpicyTemple.Core.Ui.WidgetDocs
{
    public class WidgetBase : IDisposable
    {
        ...
        {
            Trace.Assert(mParent == null || mParent == parent);
            mParent = parent;
        }
    ...
    public class WidgetContainer : WidgetBase
    {
        ...
        {
            LgcyWindow window = new LgcyWindow(0, 0, width, height);
    ...
    class WidgetButtonBase : WidgetBase
    {
    ...
    class WidgetButton : WidgetButtonBase
    {
        public WidgetButton()
        {
        }
        ...
        public override void Render()
        {
            ...
            else
            {
                if (mButton.buttonState == LgcyButtonState.Down)
                {
                    ...
                    if (mStyle.pressedTextStyleId.Length > 0)
                    {
                        mLabel.SetStyleId(mStyle.pressedTextStyleId);
                    }
                    else if (mStyle.hoverTextStyleId.Length > 0)
                    {
                ...
                else if (IsActive())
                {
                    ...
                    {
                        if (mStyle.hoverTextStyleId.Length > 0)
                        {
                            mLabel.SetStyleId(mStyle.hoverTextStyleId);
                        }
                        else
