        ...
        public void ShowTutorialTopic(TutorialTopic topic)
        {
            ...
            switch ( topic )
            {
                case TutorialTopic.Room1Overview:
                    GameSystems.Help.ShowAlert(topicName, btn => ShowTutorialTopic(TutorialTopic.SelectCharacter), okTxt);
                    break;
                ...
                case TutorialTopic.CombatInitiativeBar:
                    GameSystems.Help.ShowAlert(topicName, btn => ShowTutorialTopic(TutorialTopic.CombatActionBar), okTxt);
                    break;
