...
public class KeyManagerUi : IDisposable, IResetAwareSystem
{
    ...
    private readonly Dictionary<DIK, List<InGameHotKey>> keyconfigs = new();
...
internal static class DefaultHotKeys
{
    ...
    {
        new(true, false, HotKeyModifier.Shift, InGameHotKey.TogglePartySelection1, DIK.DIK_1, false),
        new(true, false, HotKeyModifier.Shift, InGameHotKey.TogglePartySelection2, DIK.DIK_2, false),
        new(true, false, HotKeyModifier.Shift, InGameHotKey.TogglePartySelection3, DIK.DIK_3, false),
        new(true, false, HotKeyModifier.Shift, InGameHotKey.TogglePartySelection4, DIK.DIK_4, false),
        new(true, false, HotKeyModifier.Shift, InGameHotKey.TogglePartySelection5, DIK.DIK_5, false),
        new(true, false, HotKeyModifier.Shift, InGameHotKey.TogglePartySelection6, DIK.DIK_6, false),
        new(true, false, HotKeyModifier.Shift, InGameHotKey.TogglePartySelection7, DIK.DIK_7, false),
        new(true, false, HotKeyModifier.Shift, InGameHotKey.TogglePartySelection8, DIK.DIK_8, false),
        new(true, false, HotKeyModifier.Ctrl, InGameHotKey.AssignGroup1, DIK.DIK_F1, false),
        new(true, false, HotKeyModifier.Ctrl, InGameHotKey.AssignGroup2, DIK.DIK_F2, false),
        new(true, false, HotKeyModifier.Ctrl, InGameHotKey.AssignGroup3, DIK.DIK_F3, false),
        new(true, false, HotKeyModifier.Ctrl, InGameHotKey.AssignGroup4, DIK.DIK_F4, false),
        new(true, false, HotKeyModifier.Ctrl, InGameHotKey.AssignGroup5, DIK.DIK_F5, false),
        new(true, false, HotKeyModifier.Ctrl, InGameHotKey.AssignGroup6, DIK.DIK_F6, false),
        new(true, false, HotKeyModifier.Ctrl, InGameHotKey.AssignGroup7, DIK.DIK_F7, false),
        new(true, false, HotKeyModifier.Ctrl, InGameHotKey.AssignGroup8, DIK.DIK_F8, false),
        new(true, false, HotKeyModifier.None, InGameHotKey.RecallGroup1, DIK.DIK_F1, false),
        new(true, false, HotKeyModifier.None, InGameHotKey.RecallGroup2, DIK.DIK_F2, false),
        new(true, false, HotKeyModifier.None, InGameHotKey.RecallGroup3, DIK.DIK_F3, false),
        new(true, false, HotKeyModifier.None, InGameHotKey.RecallGroup4, DIK.DIK_F4, false),
        new(true, false, HotKeyModifier.None, InGameHotKey.RecallGroup5, DIK.DIK_F5, false),
        new(true, false, HotKeyModifier.None, InGameHotKey.RecallGroup6, DIK.DIK_F6, false),
        new(true, false, HotKeyModifier.None, InGameHotKey.RecallGroup7, DIK.DIK_F7, false),
        new(true, false, HotKeyModifier.None, InGameHotKey.RecallGroup8, DIK.DIK_F8, false),
        new(false, false, HotKeyModifier.None, InGameHotKey.SelectAll, DIK.DIK_GRAVE, false),
        new(false, false, HotKeyModifier.Shift, InGameHotKey.ToggleConsole, DIK.DIK_GRAVE, false),
        new(false, false, HotKeyModifier.None, InGameHotKey.CenterOnChar, DIK.DIK_HOME, false),
        new(true, false, HotKeyModifier.None, InGameHotKey.SelectChar1, DIK.DIK_1, false),
        new(true, false, HotKeyModifier.None, InGameHotKey.SelectChar2, DIK.DIK_2, false),
        new(true, false, HotKeyModifier.None, InGameHotKey.SelectChar3, DIK.DIK_3, false),
        new(true, false, HotKeyModifier.None, InGameHotKey.SelectChar4, DIK.DIK_4, false),
        new(true, false, HotKeyModifier.None, InGameHotKey.SelectChar5, DIK.DIK_5, false),
        new(true, false, HotKeyModifier.None, InGameHotKey.SelectChar6, DIK.DIK_6, false),
        new(true, false, HotKeyModifier.None, InGameHotKey.SelectChar7, DIK.DIK_7, false),
        new(true, false, HotKeyModifier.None, InGameHotKey.SelectChar8, DIK.DIK_8, false),
        new(true, false, HotKeyModifier.None, InGameHotKey.ToggleMainMenu, DIK.DIK_ESCAPE, false),
        new(false, false, HotKeyModifier.None, InGameHotKey.QuickLoad, DIK.DIK_F9, false),
        new(false, false, HotKeyModifier.None, InGameHotKey.QuickSave, DIK.DIK_F12, false, DIK.DIK_F11,
            false),
        new(false, false, HotKeyModifier.Alt, InGameHotKey.Quit, DIK.DIK_Q, false),
        new(true, false, HotKeyModifier.None, InGameHotKey.Screenshot, DIK.DIK_SYSRQ,
            false), // (print screen)
        new(true, false, HotKeyModifier.None, InGameHotKey.ScrollUp, DIK.DIK_UP, true),
        new(true, false, HotKeyModifier.None, InGameHotKey.ScrollDown, DIK.DIK_DOWN, true),
        new(true, false, HotKeyModifier.None, InGameHotKey.ScrollLeft, DIK.DIK_LEFT, true),
        new(true, false, HotKeyModifier.None, InGameHotKey.ScrollRight, DIK.DIK_RIGHT, true),
        new(true, false, HotKeyModifier.None, InGameHotKey.ScrollUpArrow, DIK.DIK_UP, true),
        new(true, false, HotKeyModifier.None, InGameHotKey.ScrollDownArrow, DIK.DIK_DOWN, true),
        new(true, false, HotKeyModifier.None, InGameHotKey.ScrollLeftArrow, DIK.DIK_LEFT, true),
        new(true, false, HotKeyModifier.None, InGameHotKey.ScrollRightArrow, DIK.DIK_RIGHT, true),
        new(true, false, HotKeyModifier.Alt, InGameHotKey.ObjectHighlight, DIK.DIK_TAB, true),
        new(false, false, HotKeyModifier.None, InGameHotKey.ShowInventory, DIK.DIK_I, false),
        new(false, false, HotKeyModifier.None, InGameHotKey.ShowLogbook, DIK.DIK_L, false),
        new(false, false, HotKeyModifier.None, InGameHotKey.ShowMap, DIK.DIK_M, false),
        new(false, false, HotKeyModifier.None, InGameHotKey.ShowFormation, DIK.DIK_F, false),
        new(false, false, HotKeyModifier.None, InGameHotKey.Rest, DIK.DIK_R, false),
        new(false, false, HotKeyModifier.None, InGameHotKey.ShowHelp, DIK.DIK_H, false),
        new(false, false, HotKeyModifier.None, InGameHotKey.ShowOptions, DIK.DIK_O, false),
        new(false, false, HotKeyModifier.None, InGameHotKey.ToggleCombat, DIK.DIK_C, false),
        new(false, false, HotKeyModifier.None, InGameHotKey.EndTurn, DIK.DIK_SPACE, false,
            DIK.DIK_RETURN, false),
        new(true, true, HotKeyModifier.Shift, InGameHotKey.EndTurnNonParty, DIK.DIK_RETURN, false),
    }.ToImmutableList();
}
