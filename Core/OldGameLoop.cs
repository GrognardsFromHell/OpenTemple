...
{
    public sealed class OldGameLoop : IDisposable
    {
            ...
            DebugUiSystem debugUiSystem)
        {
            ...
            _gameView = new OldGameView(Tig.MainWindow, size, size);
        ...
        public void Run()
        {
            ...
            while (!_quit)
            {
                ...
                // TODO NativeMainWindow.Instance.QueueUpdate();
